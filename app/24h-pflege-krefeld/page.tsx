...
export const metadata: Metadata = {
  ...
  description: 'Liebevolle Betreuung in Krefeld und Entlastung für Angehörige. Geprüfte, verfügbare Betreuungskräfte & Preis sofort sehen – mit Bestpreisgarantie.',
