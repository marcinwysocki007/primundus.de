...
export const metadata: Metadata = {
  ...
  description: 'In Weilheim-Schongau zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
