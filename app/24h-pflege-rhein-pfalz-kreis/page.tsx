...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare polnische Pflegekräfte für Rhein-Pfalz-Kreis und Preis direkt online sehen. Anreise in 3 Tagen möglich – mit Bestpreisgarantie.',
