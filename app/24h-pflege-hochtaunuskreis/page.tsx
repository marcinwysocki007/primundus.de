...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Hochtaunuskreis & Umgebung | Primundus',
  description:
      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="h-[24px] text-sm text-[#8B8B8B] mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-[#1C1C1C]">24h-Pflege Hochtaunuskreis</span>
          </nav>
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6 mb-8">
            <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
              ...
              <a href="/24h-pflege-eschborn" className="text-[#8B7355] underline underline-offset-2">Eschborn</a> und{' '}
              <a href="/24h-pflege-frankfurt" className="text-[#8B7355] underline underline-offset-2">Frankfurt</a>{' '}
              haben eigene Seiten.
            </p>
          </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6">
              <p className="text-[16px] font-bold text-[#1C1C1C] mb-2">Was kostet eine 24h-Pflegekraft im Hochtaunuskreis?</p>
              <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
            ...
            <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6">
              <p className="text-[16px] font-bold text-[#1C1C1C] mb-2">Welche Orte im Hochtaunuskreis deckt Primundus ab?</p>
              <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
            ...
            <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6">
              <p className="text-[16px] font-bold text-[#1C1C1C] mb-2">Wie schnell kann eine Betreuungskraft im Taunus starten?</p>
              <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
