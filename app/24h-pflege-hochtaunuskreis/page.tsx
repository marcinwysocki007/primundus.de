...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Hochtaunuskreis: Kräfte vorher ansehen',
  description:
    'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Hochtaunuskreis bei Ihnen ein. Sie wählen sie vorher selbst aus.',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-im-hochtaunuskreis" titel="Polnische Betreuungskräfte im Hochtaunuskreis">
            <Text>Wer im Hochtaunuskreis nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind im gesamten Kreisgebiet im Einsatz.</Text>
