...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bergisch Gladbach ab 2.150 € im Monat',
  description: 'Zu Hause bleiben statt ins Heim: In Bergisch Gladbach zieht eine Betreuungskraft ein, hilft im Alltag und ist bei Bedarf auch nachts da. Ab 2.150 € im Monat.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Bergisch Gladbach Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Bergisch Gladbach hat im Schnitt 98,5 m², 18,2 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 80,2 % der Wohnungen in Bergisch Gladbach liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-bergisch" titel="Polnische Betreuungskräfte in Bergisch Gladbach">
            <Text>Wer in Bergisch Gladbach nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Bergisch Gladbach und im gesamten Umland im Einsatz.</Text>
