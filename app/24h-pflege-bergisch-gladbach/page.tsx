...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare polnische Pflegekräfte und Preis direkt online sehen. Anreise in Bergisch Gladbach in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Bergisch Gladbach', item: 'https://primundus.de/24h-pflege-bergisch-gladbach' },
    ],
  },
  {
    '@context': 'https://schema.org',
