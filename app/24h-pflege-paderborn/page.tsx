...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Paderborn bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Paderborn 2026" },
  { id: 'polnische-betreuungskraefte-in-paderborn', title: "Polnische Betreuungskräfte in Paderborn" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Kreis Paderborn" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Paderborn ausmacht" },
  { id: 'einzugsgebiet-paderborn', title: "Einzugsgebiet Paderborn" },
  { id: 'werkzeuge', title: "Was es für Ihre Eltern in Paderborn kostet" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Paderborn" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Paderborn: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Paderborn: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-paderborn#service',
  ...
  },
  {
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Paderborn rechtssicher?',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Paderborn?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Paderborn starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
  ...
  { q: 'Ist in einer Wohnung in Paderborn Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Paderborn hat im Schnitt 92,1 m², 22,6 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 74,0 % der Wohnungen in Paderborn liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Paderborn"
          titel="24-Stunden-Pflege und Betreuung in Paderborn"
          einleitung={<>Elsen, Schloß Neuhaus oder Wewer: Paderborner halten an ihrem Zuhause fest — am Garten, an der Nachbarschaft, an den kurzen Wegen zur Pader. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Paderborn auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Paderborn bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Paderborn bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Paderborn 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Paderborn"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-paderborn" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-paderborn" titel="Polnische Betreuungskräfte in Paderborn">
            <Text>Wer in Paderborn nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Paderborn und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Kreis Paderborn">
            <Text>Unsere Betreuungskräfte ziehen in Paderborn und im Kreis Paderborn ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Paderborn ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-paderborn" titel="Einzugsgebiet Paderborn">
            <Text>Paderborn und Kreis Paderborn: Bad Lippspringe, Salzkotten, Delbrück, Büren und alle Gemeinden im Kreis Paderborn</Text>
            <NearbyCities current="paderborn" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Paderborn'} land={'Nordrhein-Westfalen'} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Paderborn">
