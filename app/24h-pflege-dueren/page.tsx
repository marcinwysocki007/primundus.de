    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wie in Düren gebaut wurde, merkt man spätestens auf der Treppe. 49,1 Prozent der Gebäude in Düren sind Reihenhäuser, in Nordrhein-Westfalen 27,2 Prozent. Schmaler Grundriss, steile Treppe, Schlafzimmer und Bad oben — das ist der Alltag, um den es geht. Nur 31,0 Prozent der Gebäude stehen frei, in Nordrhein-Westfalen sind es 50,2 Prozent.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 9.564 Menschen in Düren sind 75 Jahre oder älter, und der Ort zählt 45.587 Wohnungen in 21.656 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
