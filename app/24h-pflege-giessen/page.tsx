...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Giessen bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Gießen 2026" },
  { id: 'polnische-betreuungskraefte-in-giessen', title: "Polnische Betreuungskräfte in Giessen" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Gießen" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Giessen ausmacht" },
  { id: 'einzugsgebiet-giessen', title: "Einzugsgebiet Gießen" },
  { id: 'werkzeuge', title: "Was es in Giessen kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus der Region über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Gießen" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Giessen: Preis und Kräfte sofort sehen',
  description: 'In Giessen zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Linden, Lich und Grünberg. Keine Vermittlungsgebühr, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Gießen?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Hessen (Eigenanteil rund 3.230 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Giessen Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Giessen hat im Schnitt 77,9 m², 38,2 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 61,6 % der Wohnungen in Giessen liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Gießen"
          ...
          blickTitel="Gießen auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Giessen bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Giessen bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Gießen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Gießen"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-giessen" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-giessen" titel="Polnische Betreuungskräfte in Giessen">
            <Text>Wer in Giessen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Giessen und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Gießen">
            <Text>Unsere Betreuungskräfte ziehen in Giessen und im Landkreis Gießen ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Giessen ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-giessen" titel="Einzugsgebiet Gießen">
            <Text>Gießen und Landkreis Gießen: Linden, Lich, Grünberg, Pohlheim und alle Gemeinden im Landkreis Gießen</Text>
            <NearbyCities current="giessen" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Giessen'} land={'Hessen'} altbau={56.7} miete={8.18} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Gießen">
