    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <h2 id="kriterien" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Die wichtigsten Kriterien beim Anbietervergleich</h2>
          ...
          </div>          <h2 id="rechtssicherheit" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Rechtssicherheit zuerst</h2>
