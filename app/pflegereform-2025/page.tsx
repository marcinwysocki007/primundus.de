    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">Juli 2025: Die größte Pflegereform seit Jahren tritt in Kraft. Das neue Entlastungsbudget fasst Verhinderungspflege und Kurzzeitpflege zusammen. Leistungsbeträge steigen. Was das für Familien bedeutet.</p>
          <div className="bg-pm-mint border-[rgba(61,122,92,0.2)] border rounded-2xl p-5 mb-6">
            <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-pm-green-deep mb-3">Die wichtigsten Änderungen ab Juli 2025</p>
              <div className="flex gap-2 text-[13px] text-pm-green-deep py-1.5 border-b border-[rgba(0,0,0,0.06)] last:border-0"><span>→</span>Entlastungsbudget: Verhinderungspflege + Kurzzeitpflege zu einem Budget zusammengefasst</div>
              <div className="flex gap-2 text-[13px] text-pm-green-deep py-1.5 border-b border-[rgba(0,0,0,0.06)] last:border-0"><span>→</span>Entlastungsbudget 2026: 3.539 €/Jahr für PG 2–5</div>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was hat sich durch die Pflegereform 2025 geändert?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Verhinderungspflege und Kurzzeitpflege wurden zum Entlastungsbudget (3.539 €/Jahr) zusammengefasst. Leistungsbeträge für Pflegegeld und Sachleistungen stiegen.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was ist das Entlastungsbudget 2026?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">3.539 €/Jahr für PG 2–5 — umfasst Verhinderungspflege und Kurzzeitpflege flexibel und ohne starre Aufteilung.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Wann trat die Pflegereform in Kraft?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Juli 2025. 2026 ist das erste volle Kalenderjahr ohne Übergangsregelungen.</p></div>
            </details>
          </div>
          <Weiterlesen aktuell="pflegereform-2025" />
          <ArticleCTA />
        </div>
      </div>
    </>
