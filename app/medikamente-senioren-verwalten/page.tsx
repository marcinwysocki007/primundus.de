      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          <nav className="h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-pm-ink">Medikamente Senioren verwalten</span>
          </nav>
          <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">Alltag · 5 Min</p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">Medikamente für Senioren sicher verwalten</h1>

          <AuthorByline updated="30. April 2026" />
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">Falsche Dosierung, vergessene Einnahme, gefährliche Wechselwirkungen — Medikamentenfehler sind bei Senioren ein ernstes Risiko. Eine gute Betreuungskraft schafft Ordnung und Sicherheit.</p>
          <h2 id="risiken" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Risiken</h2>
          ...
          <h2 id="organisation" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Wie organisieren</h2>
          ...
          <h2 id="betreuungskraft" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Was die Kraft darf</h2>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was darf eine Betreuungskraft bei Medikamenten tun?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Medikamentenerinnerung geben, Wochendosierer befüllen, Einnahme beobachten. Injektionen und Infusionen darf nur Fachpersonal.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Wie wird die Medikamentengabe sicher organisiert?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Wochendosierer, klare Medikamentenliste mit Uhrzeiten, Fotos der Packungen, regelmäßige Kontrolle durch Hausarzt.</p></div>
            </details>
          </div>
          <ArticleCTA />
        </div>
