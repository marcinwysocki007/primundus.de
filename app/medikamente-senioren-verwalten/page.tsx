...
const AKTUALISIERT = aktualisiertAm('medikamente-senioren-verwalten', '30. April 2026')
    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <h2 id="organisation" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Wie organisieren</h2>
          ...
          <h2 id="betreuungskraft" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Was die Kraft darf</h2>
          ...
          <Weiterlesen aktuell="medikamente-senioren-verwalten" />
          <ArticleCTA />
        </div>
      </div>
    </>
