...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Ravensburg bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Ravensburg 2026" },
  { id: 'polnische-betreuungskraefte-in-ravensburg', title: "Polnische Betreuungskräfte in Ravensburg" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Ravensburg" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Ravensburg ausmacht" },
  { id: 'einzugsgebiet-ravensburg', title: "Einzugsgebiet Ravensburg" },
  { id: 'werkzeuge', title: "Was es in Ravensburg kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus der Region über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Ravensburg" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Ravensburg: zu Hause bleiben statt Heim',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Ravensburg"
          titel="24-Stunden-Pflege und Betreuung in Ravensburg"
          einleitung={<>In der Türme-Stadt, der Weststadt oder Weißenau: Ravensburger wohnen im Schussental verwurzelt — und möchten genau dort alt werden. Eine Betreuungskraft von Primundus zieht mit ein und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Ravensburg auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Ravensburg bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Ravensburg bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Ravensburg 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Ravensburg"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-ravensburg" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-ravensburg" titel="Polnische Betreuungskräfte in Ravensburg">
            <Text>Wer in Ravensburg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Ravensburg und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Ravensburg">
            <Text>Unsere Betreuungskräfte ziehen in Ravensburg und im Landkreis Ravensburg ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Ravensburg ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-ravensburg" titel="Einzugsgebiet Ravensburg">
            <Text>Ravensburg und Landkreis Ravensburg: Weingarten, Leutkirch, Wangen im Allgäu, Aulendorf und alle Gemeinden im Landkreis Ravensburg</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Ravensburg">
