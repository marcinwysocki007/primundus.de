...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare polnische Pflegekräfte und Preis direkt online sehen. Anreise in Schleswig-Holstein in 3 Tagen möglich – mit Bestpreisgarantie.',
