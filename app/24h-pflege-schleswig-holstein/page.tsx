...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Schleswig-Holstein in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Schleswig-Holstein', item: 'https://primundus.de/24h-pflege-schleswig-holstein' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Schleswig-Holstein"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-schleswig-holstein', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Schleswig-Holstein" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Schleswig-Holstein" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Schleswig-Holstein 2026">
            <Tabelle
              ...
              betont={1}
              fuss="Eine Person, Pflegegrad 3, Werte aus unserem Kostenrechner · Pflegeheim Schleswig-Holstein: Eigenanteil Ø 2300–2800 €/Monat — was bei Ihnen bleibt, zeigt der Kostenrechner in 2 Minuten"
            />
            <Tabelle
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-schleswig" titel="Polnische Betreuungskräfte in Schleswig-Holstein">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet,</strong> hängt von der Pflegesituation und den Deutschkenntnissen ab — Ihren Preis zeigt der Kostenrechner in 2 Minuten. Pflegegeld und Entlastungsbudget zahlen bei Pflegegrad 3 zusammen bis zu ca. 894 Euro im Monat, dazu kommen bis zu 333 Euro Steuerermäßigung; ein Heimplatz kostet in Schleswig-Holstein im ersten Jahr im Schnitt rund 3.040 Euro Eigenanteil.</Text>
          ...
          <OrtWerkzeuge slug="schleswig-holstein" ort={'Schleswig-Holstein'} land={'Deutschland insgesamt'} altbau={48.9} miete={7.41} />
