...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Schleswig-Holstein Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Schleswig-Holstein hat im Schnitt 95,1 m², 23,2 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 87,6 % der Gebäude in Schleswig-Holstein sind Ein- oder Zweifamilienhäuser; dort bietet sich oft eine ganze Etage an.' },
