...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Recklinghausen | Primundus',
  description: '24-Stunden-Pflege in Recklinghausen: Eigenanteil ab ca. 1300 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
...
export default function RecklinghausenPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Recklinghausen</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Recklinghausen · Aktualisiert am 28. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Recklinghausen
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Ob in Süd, Suderwich oder Hillerheide: Recklinghäuser bleiben, wo sie verwurzelt sind. Eine Betreuungskraft von Primundus sorgt dafür, dass das eigene Zuhause auch mit Pflegebedarf der Mittelpunkt bleibt — sie zieht mit ein und ist rund um die Uhr da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Recklinghausen 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Recklinghausen</p>
            </div>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">Unsere Betreuungskräfte ziehen in Recklinghausen und im Kreis Recklinghausen ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</p>
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Recklinghausen</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Recklinghausen und Kreis Recklinghausen: Castrop-Rauxel, Gladbeck, Herten, Marl, Dorsten und alle Gemeinden im Kreis Recklinghausen</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Recklinghausen ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Nur 30,6 Prozent der Gebäude stehen frei, in Nordrhein-Westfalen sind es 50,2 Prozent. Die durchschnittliche Wohnung misst 85,3 Quadratmeter gegenüber 92,7 in Nordrhein-Westfalen — rund 7 Quadratmeter weniger.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Recklinghausen wohnen nur 33,2 Prozent der Haushalte im Eigentum, in Nordrhein-Westfalen 40,6 Prozent. In eine größere Wohnung zu ziehen ist für die meisten keine Option — es muss also in der vorhandenen gehen.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 12.584 Menschen in Recklinghausen sind 75 Jahre oder älter, und es gibt 61.208 Wohnungen in 23.576 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Recklinghausen</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Recklinghausen?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1300–2400 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-recklinghausen" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Recklinghausen die richtige Lösung?"
