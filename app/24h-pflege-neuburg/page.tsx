...
export const metadata: Metadata = {
  ...
  description: '24-Stunden-Pflege in Neuburg an der Donau: Eigenanteil ab ca. 1100 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
