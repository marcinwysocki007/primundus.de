...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Neuburg an der Donau',
  description: '24-Stunden-Pflege in Neuburg an der Donau: Eigenanteil ab ca. 1100 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
  alternates: { canonical: 'https://primundus.de/24h-pflege-neuburg' },
  openGraph: {
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630 }],
    title: '24h-Pflege Neuburg an der Donau — Betreuungskraft zuhause | Primundus',
    description: 'Geprüfte 24h-Betreuungskraft in Neuburg an der Donau. Täglich kündbar, rechtssicher, startklar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'LocalBusiness',
    name: 'Primundus — 24h-Pflege Neuburg an der Donau',
    description: '24h-Betreuungskräfte in Neuburg an der Donau. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-neuburg',
    telephone: '+4989200000830',
    email: 'info@primundus.de',
    areaServed: { '@type': 'City', name: 'Neuburg an der Donau' },
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Neuburg an der Donau', item: 'https://primundus.de/24h-pflege-neuburg' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Neuburg an der Donau?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Neuburg an der Donau starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Neuburg an der Donau rechtssicher?',
        acceptedAnswer: { '@type': 'Answer', text: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Neuburg an der Donau?',
        acceptedAnswer: { '@type': 'Answer', text: 'Das hängt am Grundriss, und die Ausgangslage in Neuburg an der Donau ist bekannt: Die durchschnittliche Wohnung misst 96,3 Quadratmeter, 21,4 Prozent liegen unter 60 Quadratmetern (Bayern: 20,7 Prozent), und 46,5 Prozent der Haushalte wohnen im Eigentum (Bayern: 49,3 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
      },
      {
        '@type': 'Question',
        name: 'Wie viele ältere Menschen leben in Neuburg an der Donau?',
        acceptedAnswer: { '@type': 'Answer', text: '3.146 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 10,6 Prozent — in Bayern 10,4 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 22,9 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Bayern: 23,0 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
      },
      {
        '@type': 'Question',
        name: 'Wie wohnt man in Neuburg an der Donau — Haus oder Geschosswohnung?',
        acceptedAnswer: { '@type': 'Answer', text: 'Auf ein Gebäude kommen in Neuburg an der Donau im Schnitt 2,1 Wohnungen, in Bayern 2,1. 62,8 Prozent der Gebäude stehen frei, 15,6 Prozent sind Reihenhäuser. 41,8 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Neuburg an der Donau ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
      },
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Neuburg an der Donau bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Neuburg und Landkreis Neuburg-Schrobenhausen: Schrobenhausen, Karlshuld, Burgheim und alle Gemeinden im Landkreis Neuburg-Schrobenhausen' },
      },
    ],
  },
]
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Neuburg an der Donau</span>
          </nav>

          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Neuburg an der Donau · Aktualisiert August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Neuburg an der Donau
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Die Ottheinrich-Stadt an der Donau — Obere Stadt, Untere Stadt oder das Umland — ist zum Bleiben gebaut. Eine Betreuungskraft von Primundus macht das Altwerden im eigenen Zuhause möglich: Sie zieht mit ein und ist Tag und Nacht da. Täglich kündbar, rechtssicher, startklar in 4–7 Tagen.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Neuburg an der Donau 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Neuburg an der Donau</p>
            </div>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-neuburg" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Neuburg an der Donau ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Neuburg an der Donau</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Neuburg an der Donau nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Neuburg an der Donau und im gesamten Umland im Einsatz.
          </p>
          ...
          {/* ⑤ EINZUGSGEBIET */}
          {/* ⑤ KREIS-H2 */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">24-Stunden-Pflege im Landkreis Neuburg-Schrobenhausen</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">Unsere Betreuungskräfte ziehen in Neuburg an der Donau und im Landkreis Neuburg-Schrobenhausen ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</p>
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Neuburg an der Donau</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Neuburg und Landkreis Neuburg-Schrobenhausen: Schrobenhausen, Karlshuld, Burgheim und alle Gemeinden im Landkreis Neuburg-Schrobenhausen</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Neuburg an der Donau ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Der Wohnungsbestand von Neuburg an der Donau erzählt etwas über den Pflegealltag. Altbau vor 1950 macht in Neuburg an der Donau 9,0 Prozent des Bestands aus, in Bayern 15,1 Prozent. 32,8 Prozent aller Wohnungen stammen aus den Jahren 1950 bis 1969, in Bayern sind es 26,0 Prozent. Das ist der Wiederaufbau — und der baute Treppenhäuser, die niemand für Rollatoren geplant hat.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 3.146 Menschen in Neuburg an der Donau sind 75 Jahre oder älter, und der Ort zählt 14.631 Wohnungen in 7.048 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Neuburg an der Donau</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Neuburg an der Donau?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1100–2200 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
            {
              ...
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Neuburg an der Donau starten?', a: 'In der Regel in 4–7 Tagen. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
              { q: 'Was ist der Unterschied zu einem ambulanten Pflegedienst?', a: 'Ein ambulanter Dienst kommt 1–3 Mal täglich und geht wieder. Eine 24h-Betreuungskraft lebt im Haushalt — ist nachts da, führt den gesamten Haushalt und bietet bei Demenz oder hohem Pflegebedarf die einzige wirklich durchgehende Lösung.' },
              { q: 'Ist 24h-Pflege über Primundus in Neuburg an der Donau rechtssicher?', a: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Neuburg an der Donau?', a: 'Das hängt am Grundriss, und die Ausgangslage in Neuburg an der Donau ist bekannt: Die durchschnittliche Wohnung misst 96,3 Quadratmeter, 21,4 Prozent liegen unter 60 Quadratmetern (Bayern: 20,7 Prozent), und 46,5 Prozent der Haushalte wohnen im Eigentum (Bayern: 49,3 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-neuburg" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
              Betreuung anfragen
            </a>
          </div>
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Neuburg an der Donau die richtige Lösung?"
