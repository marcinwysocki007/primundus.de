...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Sachsen-Anhalt | 6× Testsieger',
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Sachsen-Anhalt in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Sachsen-Anhalt', item: 'https://primundus.de/24h-pflege-sachsen-anhalt' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Sachsen-Anhalt"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Sachsen-Anhalt" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Sachsen-Anhalt" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Sachsen-Anhalt 2026">
            <Tabelle
              ...
              betont={1}
              fuss="Eine Person, Pflegegrad 3, Werte aus unserem Kostenrechner · Pflegeheim Sachsen-Anhalt: Eigenanteil Ø 2000–2500 €/Monat — was bei Ihnen bleibt, zeigt der Kostenrechner in 2 Minuten"
            />
            <Tabelle
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-sachsen" titel="Polnische Betreuungskräfte in Sachsen-Anhalt">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet,</strong> hängt von der Pflegesituation und den Deutschkenntnissen ab — Ihren Preis zeigt der Kostenrechner in 2 Minuten. Pflegegeld und Entlastungsbudget zahlen bei Pflegegrad 3 zusammen bis zu ca. 894 Euro im Monat, dazu kommen bis zu 333 Euro Steuerermäßigung; ein Heimplatz kostet in Sachsen-Anhalt im ersten Jahr im Schnitt rund 2.890 Euro Eigenanteil.</Text>
          ...
          <OrtWerkzeuge slug="sachsen-anhalt" ort={'Sachsen-Anhalt'} land={'Deutschland insgesamt'} altbau={59.1} miete={5.38} />
