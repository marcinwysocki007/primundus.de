...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Sachsen-Anhalt 2026" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Sachsen-Anhalt ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung zu Hause statt Heimplatz: Eine Betreuungskraft zieht in Sachsen-Anhalt ein und entlastet die Angehörigen. Ab 2.150 € im Monat, täglich kündbar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-sachsen-anhalt#service',
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Sachsen-Anhalt?',
        acceptedAnswer: { '@type': 'Answer', text: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — oft günstiger als ein Heimplatz in Sachsen-Anhalt (Eigenanteil rund 2.890 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Sachsen-Anhalt starten?',
        acceptedAnswer: { '@type': 'Answer', text: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller. Primundus ist mit eigenen Betreuungskräften in ganz Sachsen-Anhalt — auch in ländlichen Regionen.' },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Sachsen-Anhalt rechtssicher?',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Sachsen-Anhalt?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — oft günstiger als ein Heimplatz in Sachsen-Anhalt (Eigenanteil rund 2.890 €/Monat, vdek 07/2026).' },
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Sachsen-Anhalt starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller. Primundus ist mit eigenen Betreuungskräften in ganz Sachsen-Anhalt — auch in ländlichen Regionen.' },
  ...
  { q: 'Ist in einer Wohnung in Sachsen-Anhalt Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Sachsen-Anhalt hat im Schnitt 84,0 m², 31,3 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 82,9 % der Wohnungen in Sachsen-Anhalt liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Sachsen-Anhalt"
          titel="24h-Pflege Sachsen-Anhalt — Betreuungskraft zuhause"
          ...
          blick={[
            ...
            'Pflegeheim Sachsen-Anhalt: Eigenanteil Ø 2000–2500 €/Monat',
            'Täglich kündbar, keine Vermittlungsgebühr',
            'Anreise in 3 Tagen möglich',
          ]}
          blickTitel="Sachsen-Anhalt auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Sachsen-Anhalt 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Sachsen-Anhalt"
              zeilen={[
              ...
              betont={1}
              fuss="Eine Person, Werte aus unserem Kostenrechner, zzgl. An- und Abreise 125 € je Strecke · Pflegeheim Sachsen-Anhalt: Eigenanteil Ø 2000–2500 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause"
            />
            <Tabelle
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-sachsen" titel="Polnische Betreuungskräfte in Sachsen-Anhalt">
            <Text>Wer in Sachsen-Anhalt nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in ganz Sachsen-Anhalt im Einsatz, in der Großstadt wie im kleinsten Dorf.</Text>
            <Kasten titel="Angestellt statt vermittelt">
              <Text>Das ist der Unterschied, der im Alltag zählt: Bei Primundus sind die Betreuungskräfte fest angestellt. Wir reichen sie nicht an Sie weiter, und Sie werden nicht zum Arbeitgeber. Die Kraft arbeitet mit A1-Bescheinigung im Entsendemodell in Deutschland, Ihr Vertrag läuft mit uns. Für Sie heißt das: keine Lohnabrechnung, keine Sozialabgaben, keine Arbeitgeberhaftung. Und wenn eine Kraft ausfällt, organisieren wir den Ersatz — ohne Zusatzkosten, es fallen lediglich die An- und Abreisekosten an.</Text>
            </Kasten>
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> ab 2.150 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbudget und Steuerermäßigung ab ca. 923 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der in Sachsen-Anhalt im ersten Jahr im Schnitt rund 2.890 Euro im Monat kostet.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Sachsen-Anhalt ausmacht">
            <Text>In Sachsen-Anhalt sind 204.236 Menschen pflegebedürftig, das entspricht 9,37 Prozent der Bevölkerung. Bundesweit sind es 6,72 Prozent. Das ist die höchste Pflegequote aller 16 Bundesländer. Diese Unterschiede sind groß — zwischen dem niedrigsten und dem höchsten Landeswert liegt fast das Doppelte —, weshalb ein Vergleich mit dem Bundesschnitt allein wenig aussagt.</Text>
            <Text>Gut jeder zweite Pflegebedürftige wird allein von Angehörigen versorgt — bundesweit sind es 54,5 Prozent, hier also weniger. 104.853 Menschen sind das in Sachsen-Anhalt, ohne jeden Pflegedienst. Ambulante Dienste übernehmen 23,0 Prozent (Bund 19,3), im Heim leben 13,8 Prozent (Bund 14,1).</Text>
            <Text>Bemerkenswert ist der hohe Anteil ambulanter Versorgung. Familien in Sachsen-Anhalt kaufen professionelle Hilfe eher ein, als alles allein zu tragen. Eine Betreuungskraft im Haushalt ist die konsequente Fortsetzung dieses Wegs: nicht ein Besuch zwei- oder dreimal am Tag, sondern jemand, der auch nachts da ist.</Text>
            <Text>Ob eine Betreuungskraft einziehen kann, entscheidet am Ende der Grundriss. Gut vier von fünf Gebäuden sind ein Ein- oder Zweifamilienhaus (bundesweit 81,8 Prozent), die durchschnittliche Wohnung misst 84,0 Quadratmeter gegenüber 94,4 im Bund. Notwendig ist ein eigenes, abschließbares Zimmer — was Ihre Wohnung hergibt, klären wir vorab am Telefon, nicht hinterher.</Text>
          ...
          <Abschnitt id="einzugsgebiet-sachsen-anhalt" titel="Einzugsgebiet Sachsen-Anhalt">
            <Text>Halle, Magdeburg, Dessau-Roßlau, Wittenberg, Merseburg, Halberstadt, Stendal, Bernburg und alle weiteren Städte und Gemeinden in Sachsen-Anhalt</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Sachsen-Anhalt">
