...
export default function SachsenAnhaltPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Sachsen-Anhalt</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Sachsen-Anhalt · Aktualisiert am 28. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24h-Pflege Sachsen-Anhalt — Betreuungskraft zuhause
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Ob Altbau in Halle, Einfamilienhaus in Magdeburg oder Hof in der Altmark: In Sachsen-Anhalt sind die Wege zu Kindern und Heimen oft weit — das Zuhause aber ist nah. Eine Betreuungskraft von Primundus zieht mit ein und ist rund um die Uhr da, damit niemand es verlassen muss. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Sachsen-Anhalt 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Sachsen-Anhalt</p>
            </div>
            ...
            <div className="bg-pm-paper border-t border-pm-line px-5 py-3">
              <p className="text-[12px] text-pm-mute">Pflegeheim Sachsen-Anhalt: Eigenanteil Ø 2000–2500 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=land-sachsen-anhalt" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte in Sachsen-Anhalt ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Sachsen-Anhalt</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Sachsen-Anhalt nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in ganz Sachsen-Anhalt im Einsatz, in der Großstadt wie im kleinsten Dorf.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            ...
            als ein Heimplatz, der in Sachsen-Anhalt im ersten Jahr im Schnitt rund 2.890 Euro im Monat
            kostet.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Sachsen-Anhalt</p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Sachsen-Anhalt sind 204.236 Menschen pflegebedürftig, das entspricht 9,37 Prozent der Bevölkerung. Bundesweit sind es 6,72 Prozent. Das ist die höchste Pflegequote aller 16 Bundesländer. Diese Unterschiede sind groß — zwischen dem niedrigsten und dem höchsten Landeswert liegt fast das Doppelte —, weshalb ein Vergleich mit dem Bundesschnitt allein wenig aussagt.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Gut jeder zweite Pflegebedürftige wird allein von Angehörigen versorgt — bundesweit sind es 54,5 Prozent, hier also weniger. 104.853 Menschen sind das in Sachsen-Anhalt, ohne jeden Pflegedienst. Ambulante Dienste übernehmen 23,0 Prozent (Bund 19,3), im Heim leben 13,8 Prozent (Bund 14,1).
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-sachsen-anhalt" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200">
