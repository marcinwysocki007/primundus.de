...
export const metadata: Metadata = {
  title: '24h-Pflege Hessen — Betreuungskraft | Primundus',
  description: '24h-Pflege in Hessen: Geprüfte Betreuungskraft zuhause. Rechtssicher, täglich kündbar, startklar. Ab ca. 1000 €/Monat Eigenanteil (PG 3).',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2040 €/Monat — oft günstiger als ein Heimplatz in Hessen (Eigenanteil rund 3.230 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Hessen?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2040 €/Monat — oft günstiger als ein Heimplatz in Hessen (Eigenanteil rund 3.230 €/Monat, vdek 07/2026).' },
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          blick={[
            ...
            'Ihr Eigenanteil bei Pflegegrad 3: ca. 1000–2040 €/Monat',
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Hessen 2026">
            <Tabelle
              ...
              zeilen={[
                ...
                [<strong key="e">Ihr Eigenanteil</strong>, <strong key="w">ca. 1000–2040 €/Monat</strong>],
              ]}
              betont={1}
              fuss="Pflegeheim Hessen: Eigenanteil Ø 2600–3400 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause"
            />
            <Tabelle
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=land-hessen', text: 'Preis und Betreuungskräfte in Hessen ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-hessen" titel="Polnische Betreuungskräfte in Hessen">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> zwischen 2.200 und 3.500 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbetrag und Entlastungsbudget meist rund 1000 bis 2040 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der in Hessen im ersten Jahr im Schnitt rund 3.230 Euro im Monat kostet.</Text>
