...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Hessen: zu Hause bleiben statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-hessen" titel="Polnische Betreuungskräfte in Hessen">
            <Text>Wer in Hessen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in ganz Hessen im Einsatz, in der Großstadt wie im kleinsten Dorf.</Text>
