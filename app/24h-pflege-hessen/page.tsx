...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Hessen Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Hessen hat im Schnitt 98,3 m², 20,4 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 81,1 % der Gebäude in Hessen sind Ein- oder Zweifamilienhäuser; dort bietet sich oft eine ganze Etage an.' },
