      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Dormagen · Aktualisiert am 27. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Dormagen
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Viele Dormagener Familien kennen das: Die Kinder arbeiten in Köln oder Düsseldorf, die Eltern wohnen in Nievenheim, Hackenbroich oder bei der alten Zollfeste in Zons — und brauchen plötzlich mehr Hilfe, als sich mit Besuchen am Wochenende leisten lässt. Eine Betreuungskraft von Primundus zieht mit ein und ist rund um die Uhr da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-dormagen" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Dormagen ansehen — in 2 Minuten
              </a>
            </div>
          </div>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Dormagen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Dormagen und im gesamten Umland im Einsatz.
          </p>
