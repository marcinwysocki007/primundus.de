...
export const metadata: Metadata = {
  ...
  description: 'In Dormagen zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Neuss-Nord und Umgebung. Keine Vermittlungsgebühr, täglich kündbar.',
