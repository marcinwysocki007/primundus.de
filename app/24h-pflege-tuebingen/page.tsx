      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            In Tübingen leben viele Eltern, deren Kinder längst in München, Hamburg oder im Ausland arbeiten — und die trotzdem in ihrer Wohnung an der Neckarfront, in Lustnau oder Derendingen bleiben möchten. Eine Betreuungskraft von Primundus macht das möglich: Sie wohnt mit im Haushalt und ist rund um die Uhr da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
