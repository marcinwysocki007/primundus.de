...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Was es in Tübingen kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Tübingen über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Tübingen" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Tübingen | 6× Testsieger | Primundus',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Tübingen', item: 'https://primundus.de/24h-pflege-tuebingen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Tübingen"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Tübingen" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Tübingen" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Tübingen 2026">
            ...
            />
            <RechnerKasten src="ort-tuebingen" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-tuebingen" titel="Polnische Betreuungskräfte in Tübingen">
            <Text>Wer in Tübingen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Tübingen und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20260429-ulrike'].includes(b.id))}
