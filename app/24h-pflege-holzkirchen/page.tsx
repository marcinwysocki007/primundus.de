...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Holzkirchen 2026" },
  { id: 'polnische-betreuungskraefte-in-holzkirchen', title: "Polnische Betreuungskräfte in Holzkirchen" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Miesbach Nord" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Holzkirchen ausmacht" },
  { id: 'einzugsgebiet-holzkirchen', title: "Einzugsgebiet Holzkirchen" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Holzkirchen" },
]
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Holzkirchen"
          titel="24-Stunden-Pflege und Betreuung in Holzkirchen"
          einleitung={<>Holzkirchen, Föching oder Hartpenning: Im Oberland wohnt man mit Bergblick und bleibt — auch wenn die Kinder in München arbeiten. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Holzkirchen auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Holzkirchen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Holzkirchen"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-holzkirchen', text: 'Preis und Betreuungskräfte für Holzkirchen ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-holzkirchen" titel="Polnische Betreuungskräfte in Holzkirchen">
            <Text>Wer in Holzkirchen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Holzkirchen und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Miesbach Nord">
            <Text>Unsere Betreuungskräfte ziehen in Holzkirchen und im Landkreis Miesbach Nord ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Holzkirchen ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-holzkirchen" titel="Einzugsgebiet Holzkirchen">
            <Text>Holzkirchen und Landkreis Miesbach Nord: Otterfing, Weyarn, Valley, Gmund am Tegernsee und alle Gemeinden im nördlichen Landkreis Miesbach</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Holzkirchen">
