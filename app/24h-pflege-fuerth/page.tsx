...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Fürth bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Fürth 2026" },
  { id: 'polnische-betreuungskraefte-in-fuerth', title: "Polnische Betreuungskräfte in Fürth" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Fürth" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Fürth ausmacht" },
  { id: 'einzugsgebiet-fuerth', title: "Einzugsgebiet Fürth" },
  { id: 'werkzeuge', title: "Was es in Fürth kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus der Region über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Fürth" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Fürth: Kräfte ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Fürth bei Ihnen ein. Foto, Erfahrung und Deutsch sehen Sie vorher.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Fürth?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Fürth Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Fürth hat im Schnitt 84,2 m², 26,2 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 68,2 % der Wohnungen in Fürth liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Fürth"
          titel="24-Stunden-Pflege und Betreuung in Fürth"
          ...
          blickTitel="Fürth auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Fürth bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Fürth bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Fürth 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Fürth"
              zeilen={[
            ...
            <RechnerKasten src="ort-fuerth" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-fuerth" titel="Polnische Betreuungskräfte in Fürth">
            <Text>Wer in Fürth nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Fürth und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Fürth">
            <Text>Unsere Betreuungskräfte ziehen in Fürth und im Landkreis Fürth ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Fürth ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-fuerth" titel="Einzugsgebiet Fürth">
            <Text>Fürth und Landkreis Fürth: Zirndorf, Oberasbach, Langenzenn, Cadolzburg und alle Gemeinden im Landkreis Fürth</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Fürth">
