...
export const metadata: Metadata = {
  ...
  description: 'Liebevolle Betreuung in Mönchengladbach-Rheydt und Entlastung für Angehörige. Geprüfte Kräfte & Preis sofort sehen – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Rheydt', item: 'https://primundus.de/24h-pflege/mönchengladbach-rheydt/' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Mönchengladbach-Rheydt" />}
        />
