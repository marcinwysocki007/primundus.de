...
export const metadata: Metadata = {
  ...
  description: 'In Mönchengladbach-Rheydt zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
