...
const AKTUALISIERT = aktualisiertAm('wohnraumanpassung-planen', '30. April 2026')
    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <h2 id="erstberatung" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Erstberatung</h2>
          ...
          <h2 id="massnahmen" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Wichtige Maßnahmen</h2>
          ...
          <h2 id="foerderung" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Förderung beantragen</h2>
          ...
          <Weiterlesen aktuell="wohnraumanpassung-planen" />
          <ArticleCTA />
        </div>
      </div>
    </>
