        ...
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <div className="space-y-4 mb-12">
            ...
            <details className="bg-white rounded-xl border border-[#E5E3DF] group">
              ...
              <div className="px-5 pb-4"><p className="text-[15px] text-[#2E2E2E] leading-relaxed">Oft ja — mit Kassenzuschüssen sinkt der Eigenanteil bei PG 3 auf 1.500–2.000 €/Monat. Der durchschnittliche Pflegeheim-Eigenanteil liegt 2026 bei 3.364 €/Monat.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-[#E5E3DF] group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
