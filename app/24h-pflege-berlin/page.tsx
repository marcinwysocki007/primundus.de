...
export const metadata: Metadata = {
  title: '24h-Pflege Berlin — Betreuungskraft | Primundus',
  description: '24h-Pflege in Berlin: Geprüfte Betreuungskraft zuhause. Rechtssicher, täglich kündbar, startklar. Ab ca. 1000 €/Monat Eigenanteil (PG 3).',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Kassenzuschüssen sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Pflegeheim in Berlin (Ø 2.200–2.600 €/Monat Eigenanteil).'.replace(',', '.') },
      },
    ],
  },
]
        ...
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
            ...
            <div className="bg-[#F8F7F5] border-t border-[#E5E3DF] px-5 py-3">
              <p className="text-[12px] text-[#8B8B8B]">Pflegeheim Berlin: Eigenanteil Ø 2200–2600 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
          ...
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Berlin?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Pflegeheim in Berlin (Ø 2200–2600 €/Monat Eigenanteil).' },
              { q: 'Wie schnell kann eine Pflegekraft in Berlin starten?', a: 'In 4–7 Tagen nach dem ersten Beratungsgespräch. Primundus ist mit eigenen Betreuungskräften in ganz Berlin — auch in ländlichen Regionen.' },
