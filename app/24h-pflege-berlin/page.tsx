...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Berlin: erst ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Berlin bei Ihnen ein. Foto, Erfahrung und Deutsch sehen Sie vorher.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Berlin Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Berlin hat im Schnitt 73,2 m², 39,3 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 56,1 % der Wohnungen in Berlin liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
