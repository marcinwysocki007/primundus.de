...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Mannheim | Primundus',
  description: '24-Stunden-Pflege in Mannheim: Eigenanteil ab ca. 1200 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
  alternates: { canonical: 'https://primundus.de/24h-pflege-mannheim' },
  openGraph: {
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630 }],
    title: '24h-Pflege Mannheim — Betreuungskraft zuhause | Primundus',
    description: 'Geprüfte 24h-Betreuungskraft in Mannheim. Täglich kündbar, rechtssicher, startklar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-mannheim#service',
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Mannheim', item: 'https://primundus.de/24h-pflege-mannheim' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Mannheim?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Mannheim starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Mannheim rechtssicher?',
        acceptedAnswer: { '@type': 'Answer', text: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Mannheim?',
        acceptedAnswer: { '@type': 'Answer', text: 'Das hängt am Grundriss, und die Ausgangslage in Mannheim ist bekannt: Die durchschnittliche Wohnung misst 79,5 Quadratmeter, 32,7 Prozent liegen unter 60 Quadratmetern (Baden-Württemberg: 18,1 Prozent), und 27,5 Prozent der Haushalte wohnen im Eigentum (Baden-Württemberg: 51,6 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
      },
      {
        '@type': 'Question',
        name: 'Wie viele ältere Menschen leben in Mannheim?',
        acceptedAnswer: { '@type': 'Answer', text: '29.932 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 9,5 Prozent — in Baden-Württemberg 10,5 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 20,6 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Baden-Württemberg: 23,6 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
      },
      {
        '@type': 'Question',
        name: 'Wie wohnt man in Mannheim — Haus oder Geschosswohnung?',
        acceptedAnswer: { '@type': 'Answer', text: 'Auf ein Gebäude kommen in Mannheim im Schnitt 4,0 Wohnungen, in Baden-Württemberg 2,1. 26,5 Prozent der Gebäude stehen frei, 49,9 Prozent sind Reihenhäuser. 63,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Mannheim ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Mannheim?',
      ...
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Mannheim bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Mannheim und Metropolregion Rhein-Neckar: Heidelberg, Ludwigshafen, Weinheim, Schwetzingen, Viernheim und alle Gemeinden im Rhein-Neckar-Kreis' },
      },
    ],
  },
]
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Mannheim</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Mannheim · Aktualisiert am 28. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Mannheim
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Zwischen Quadraten, Lindenhof und Feudenheim: Mannheimer wohnen praktisch — und bleiben, wo alles vertraut ist. Wenn allein leben nicht mehr geht, zieht eine Betreuungskraft von Primundus mit ein, übernimmt den Alltag und ist auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Mannheim 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Mannheim</p>
            </div>
            ...
            <div className="bg-pm-paper border-t border-pm-line px-5 py-3">
              <p className="text-[12px] text-pm-mute">Pflegeheim in Baden-Württemberg: Eigenanteil rund 3.660 €/Monat (vdek, 07/2026) — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-mannheim" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Mannheim ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Mannheim</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Mannheim nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Mannheim und im gesamten Umland im Einsatz.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            ...
            Entlastungsbudget in Baden-Württemberg meist rund 1200 bis 2300 Euro Eigenanteil —
            deutlich weniger als ein Heimplatz, der hier im Schnitt rund 3.660 Euro im Monat kostet.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          {/* ⑤ EINZUGSGEBIET */}
          {/* ⑤ KREIS-H2 */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">24-Stunden-Pflege in der Metropolregion Rhein-Neckar</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">Unsere Betreuungskräfte ziehen in Mannheim und in der Metropolregion Rhein-Neckar ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</p>
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Mannheim</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Mannheim und Metropolregion Rhein-Neckar: Heidelberg, Ludwigshafen, Weinheim, Schwetzingen, Viernheim und alle Gemeinden im Rhein-Neckar-Kreis</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Mannheim ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Jedes zweite Gebäude in Mannheim ist ein Reihenhaus — in Baden-Württemberg 15,4 Prozent. Schmaler Grundriss, steile Treppe, Schlafzimmer und Bad im Obergeschoss: Wenn das Treppensteigen zur täglichen Hürde wird, ist jemand im Haus oft die Alternative zum Umzug. In Mannheim wohnen nur 27,5 Prozent der Haushalte im Eigentum, in Baden-Württemberg 51,6 Prozent. In eine größere Wohnung zu ziehen ist für die meisten keine Option — es muss also in der vorhandenen gehen.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Nur 26,5 Prozent der Gebäude stehen frei, in Baden-Württemberg sind es 65,9 Prozent. Mannheim ist städtischer gebaut, als der Landesschnitt vermuten lässt: Auf ein Gebäude kommen hier 4,0 Wohnungen, in Baden-Württemberg 2,1. Mehr Geschosswohnung, weniger Haus mit Garten — und damit häufiger die Frage nach dem Stockwerk und der Treppe.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Die durchschnittliche Wohnung misst 79,5 Quadratmeter gegenüber 99,1 in Baden-Württemberg — rund 20 Quadratmeter weniger. Eine Betreuungskraft braucht ein eigenes Zimmer, und genau daran hakt es in Mannheim häufiger als anderswo. Jede dritte Wohnung ist kleiner als 60 Quadratmeter — in Baden-Württemberg sind es 18,1 Prozent. Deshalb klären wir vorab am Telefon, was Ihre Wohnung hergibt, statt es später herauszufinden. 51,6 Prozent aller Haushalte in Mannheim bestehen aus einer einzigen Person, in Baden-Württemberg sind es 39,5 Prozent. Alleinlebend heißt im Pflegefall: Es ist niemand da, der es mitbekommt.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 29.932 Menschen in Mannheim sind 75 Jahre oder älter, und es gibt 172.570 Wohnungen in 43.095 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Mannheim</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Mannheim?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1200–2300 €/Monat — deutlich günstiger als ein Heimplatz in Baden-Württemberg (Eigenanteil rund 3.660 €/Monat, vdek 07/2026).' },
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Mannheim starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
              { q: 'Was ist der Unterschied zu einem ambulanten Pflegedienst?', a: 'Ein ambulanter Dienst kommt 1–3 Mal täglich und geht wieder. Eine 24h-Betreuungskraft lebt im Haushalt — ist nachts da, führt den gesamten Haushalt und bietet bei Demenz oder hohem Pflegebedarf die einzige wirklich durchgehende Lösung.' },
              { q: 'Ist 24h-Pflege über Primundus in Mannheim rechtssicher?', a: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Mannheim?', a: 'Das hängt am Grundriss, und die Ausgangslage in Mannheim ist bekannt: Die durchschnittliche Wohnung misst 79,5 Quadratmeter, 32,7 Prozent liegen unter 60 Quadratmetern (Baden-Württemberg: 18,1 Prozent), und 27,5 Prozent der Haushalte wohnen im Eigentum (Baden-Württemberg: 51,6 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Mannheim?', a: '29.932 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 9,5 Prozent — in Baden-Württemberg 10,5 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 20,6 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Baden-Württemberg: 23,6 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Mannheim — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Mannheim im Schnitt 4,0 Wohnungen, in Baden-Württemberg 2,1. 26,5 Prozent der Gebäude stehen frei, 49,9 Prozent sind Reihenhäuser. 63,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Mannheim ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Mannheim?', a: 'Das hängt am Grundriss, und die Ausgangslage in Mannheim ist bekannt: Die durchschnittliche Wohnung misst 79,5 Quadratmeter, 32,7 Prozent liegen unter 60 Quadratmetern (Baden-Württemberg: 18,1 Prozent), und 27,5 Prozent der Haushalte wohnen im Eigentum (Baden-Württemberg: 51,6 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Mannheim?', a: '29.932 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 9,5 Prozent — in Baden-Württemberg 10,5 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 20,6 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Baden-Württemberg: 23,6 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Mannheim — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Mannheim im Schnitt 4,0 Wohnungen, in Baden-Württemberg 2,1. 26,5 Prozent der Gebäude stehen frei, 49,9 Prozent sind Reihenhäuser. 63,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Mannheim ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Mannheim?', a: 'Das hängt am Grundriss, und die Ausgangslage in Mannheim ist bekannt: Die durchschnittliche Wohnung misst 79,5 Quadratmeter, 32,7 Prozent liegen unter 60 Quadratmetern (Baden-Württemberg: 18,1 Prozent), und 27,5 Prozent der Haushalte wohnen im Eigentum (Baden-Württemberg: 51,6 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Mannheim?', a: '29.932 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 9,5 Prozent — in Baden-Württemberg 10,5 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 20,6 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Baden-Württemberg: 23,6 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Mannheim — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Mannheim im Schnitt 4,0 Wohnungen, in Baden-Württemberg 2,1. 26,5 Prozent der Gebäude stehen frei, 49,9 Prozent sind Reihenhäuser. 63,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Mannheim ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Welches Einzugsgebiet wird in Mannheim bedient?', a: 'Mannheim und Metropolregion Rhein-Neckar: Heidelberg, Ludwigshafen, Weinheim, Schwetzingen, Viernheim und alle Gemeinden im Rhein-Neckar-Kreis' },
            ].map((item, i) => (
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-mannheim" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Mannheim die richtige Lösung?"
