...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Nürnberg', item: 'https://primundus.de/24h-pflege-nuernberg' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Nürnberg"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-nuernberg', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Nürnberg" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Nürnberg" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-nuernberg" titel="Polnische Betreuungskräfte in Nürnberg">
            <Text>Wer in Nürnberg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Nürnberg und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge slug="nuernberg" ort={'Nürnberg'} land={'Bayern'} altbau={61.3} miete={8.21} />
