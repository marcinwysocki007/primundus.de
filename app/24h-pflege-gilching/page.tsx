...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Gilching 2026" },
  { id: 'polnische-betreuungskraefte-in-gilching', title: "Polnische Betreuungskräfte in Gilching" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im westlichen Landkreis Starnberg" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Gilching ausmacht" },
  { id: 'einzugsgebiet-gilching', title: "Einzugsgebiet Gilching" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Gilching" },
]
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Gilching"
          titel="24-Stunden-Pflege und Betreuung in Gilching"
          einleitung={<>Gilching, Argelsried oder Geisenbrunn: Am Rand des Fünfseenlands wohnt man ruhig — und möchte genau dort alt werden. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Gilching auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Gilching 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Gilching"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-gilching', text: 'Preis und Betreuungskräfte für Gilching ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-gilching" titel="Polnische Betreuungskräfte in Gilching">
            <Text>Wer in Gilching nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Gilching und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im westlichen Landkreis Starnberg">
            <Text>Unsere Betreuungskräfte ziehen in Gilching und im westlichen Landkreis Starnberg ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Gilching ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-gilching" titel="Einzugsgebiet Gilching">
            <Text>Gilching und westlicher Landkreis Starnberg: Weßling, Seefeld, Herrsching am Ammersee und alle Gemeinden im westlichen Landkreis Starnberg</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Gilching">
