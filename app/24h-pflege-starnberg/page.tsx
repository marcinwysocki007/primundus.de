...
// Seit 23.09.2026 traegt diese Datei nur noch, was in Starnberg anders ist; der feste Text steht
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Starnberg starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung.' },
...
const ORT: OrtDaten = {
  ...
  einzugsgebiet: 'Starnberg und Landkreis Starnberg: Gauting, Gilching, Herrsching, Tutzing, Feldafing und alle Gemeinden im Landkreis Starnberg',
