    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1200–2300 €/Monat — deutlich günstiger als ein Pflegeheim in Bad Nauheim (Ø 3.300 €/Monat Eigenanteil).'.replace(',', '.') },
      },
      {
        '@type': 'Question',
        ...
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
            ...
            <div className="bg-[#F8F7F5] border-t border-[#E5E3DF] px-5 py-3">
              <p className="text-[12px] text-[#8B8B8B]">Pflegeheim Bad Nauheim: Eigenanteil Ø 3.300 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
          ...
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Bad Nauheim?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1200–2300 €/Monat — deutlich günstiger als ein Pflegeheim in Bad Nauheim (Ø 3.300 €/Monat Eigenanteil).' },
