...
export const metadata: Metadata = {
  ...
  description: 'In Jena zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Kahla und Stadtroda. Keine Vermittlungsgebühr, täglich kündbar.',
