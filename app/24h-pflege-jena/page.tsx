...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Jena', item: 'https://primundus.de/24h-pflege-jena' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Jena"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Jena" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Jena" />}
        />
