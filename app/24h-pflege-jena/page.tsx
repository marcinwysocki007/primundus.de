...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Was es für Ihre Eltern in Jena kostet" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Jena" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Jena: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Jena: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Jena Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Jena hat im Schnitt 73,0 m², 40,5 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 64,9 % der Wohnungen in Jena liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-jena" titel="Polnische Betreuungskräfte in Jena">
            <Text>Wer in Jena nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Jena und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge ort={'Jena'} land={'Thüringen'} />
