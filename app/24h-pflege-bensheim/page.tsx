      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Bensheim · Aktualisiert August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Bensheim
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Auerbach mit dem Fürstenlager, Schönberg oder die Innenstadt: An der Bergstraße blüht es früh — und man bleibt lang. Eine Betreuungskraft von Primundus macht das Altwerden im eigenen Zuhause möglich: Sie zieht mit ein und ist rund um die Uhr da. Täglich kündbar, rechtssicher, startklar in 4–7 Tagen.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 4.514 Menschen in Bensheim sind 75 Jahre oder älter, und der Ort zählt 19.591 Wohnungen in 9.924 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
