...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege im Rheinisch-Bergischen Kreis | 6× Testsieger',
  description: 'Geprüfte polnische Pflegekräfte und Preis direkt online sehen. Anreise in Rheinisch-Bergischer Kreis in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Rheinisch-Bergischer Kreis', item: 'https://primundus.de/24h-pflege-rheinisch-bergischer-kreis' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Rheinisch-Bergischer Kreis" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-im-rheinisch" titel="Polnische Betreuungskräfte im Rheinisch-Bergischen Kreis">
            <Text>Wer im Rheinisch-Bergischen Kreis nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind im gesamten Kreisgebiet im Einsatz.</Text>
