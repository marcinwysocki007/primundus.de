...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Heidelberg bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Heidelberg 2026" },
  { id: 'polnische-betreuungskraefte-in-heidelberg', title: "Polnische Betreuungskräfte in Heidelberg" },
  ...
  { id: 'werkzeuge', title: "Rechnen Sie Ihren Fall für Heidelberg durch" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Heidelberg" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Heidelberg: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Heidelberg: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Heidelberg?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Baden-Württemberg (Eigenanteil rund 3.660 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Heidelberg Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Heidelberg hat im Schnitt 83,2 m², 36,3 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 57,7 % der Wohnungen in Heidelberg liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Heidelberg"
          titel="24-Stunden-Pflege und Betreuung in Heidelberg"
          ...
          blickTitel="Heidelberg auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Heidelberg bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Heidelberg bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Heidelberg 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Heidelberg"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-heidelberg" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-heidelberg" titel="Polnische Betreuungskräfte in Heidelberg">
            <Text>Wer in Heidelberg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Heidelberg und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Rhein-Neckar-Kreis">
            <Text>Unsere Betreuungskräfte ziehen in Heidelberg und im Rhein-Neckar-Kreis ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Heidelberg ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-heidelberg" titel="Einzugsgebiet Heidelberg">
            <Text>Heidelberg und Rhein-Neckar-Kreis: Schwetzingen, Sinsheim, Eberbach, Wiesloch, Leimen, Sandhausen, Weinheim und alle Gemeinden im Rhein-Neckar-Kreis</Text>
