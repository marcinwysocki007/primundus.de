...
const AKTUALISIERT = aktualisiertAm('pflegeverantwortung-unter-geschwistern', '30. April 2026')
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Pflegeverantwortung unter Geschwistern</span>
          </nav>
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">Alltag · 5 Min</p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">Pflegeverantwortung unter Geschwistern — fair aufteilen ohne Streit</h1>

          <AuthorByline updated={AKTUALISIERT.sichtbar} />
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">Wenn Eltern Pflege brauchen, werden alte Geschwisterdynamiken aktiviert. Wer wohnt näher? Wer hat weniger gearbeitet? Dieser Ratgeber hilft faire Lösungen zu finden.</p>
          <h2 id="konflikte" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Typische Konflikte</h2>
          ...
          <h2 id="aufteilen" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Wie aufteilen?</h2>
          ...
          <h2 id="externe-hilfe" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Wann externe Hilfe?</h2>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Wie teilt man Pflegeverantwortung fair auf?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Klare Aufgabenverteilung: wer übernimmt was (Arztbegleitung, Finanzen, Organisation, Besuche). Regelmäßige Gespräche. Schriftliche Vereinbarung empfehlenswert.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was wenn Geschwister sich nicht einigen können?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Mediator einschalten (Sozialdienste, Pflegestützpunkt). Im Extremfall: Gericht kann Betreuung regeln.</p></div>
            </details>
          </div>
          <Weiterlesen aktuell="pflegeverantwortung-unter-geschwistern" />
          <ArticleCTA />
        </div>
      </div>
    </>
