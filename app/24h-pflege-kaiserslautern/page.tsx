...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Kaiserslautern | 6× Testsieger',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<Ansprechpartnerin karte ort="Kaiserslautern" titel="Ihre Ansprechpartnerin für Kaiserslautern" />}
        />
