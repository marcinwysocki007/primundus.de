...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Dresden & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Dresden: Eigenanteil ab ca. 1400 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
