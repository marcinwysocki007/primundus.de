...
const AKTUALISIERT = aktualisiertAm('pflegehilfsmittel-organisieren', '30. April 2026')
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Pflegehilfsmittel organisieren</span>
          </nav>
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">Ratgeber · 4 Min</p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">Pflegehilfsmittel organisieren — was braucht man wirklich?</h1>

          <AuthorByline updated={AKTUALISIERT.sichtbar} />
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">Von Rollator bis Bettschutzeinlage: Wer den Überblick über Pflegehilfsmittel hat, spart Zeit, Geld und Nerven. Diese Liste hilft.</p>
          <h2 id="uebersicht" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Übersicht Hilfsmittel</h2>
          ...
          <h2 id="technisch" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Technische Hilfsmittel</h2>
          ...
          <h2 id="verbrauch" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Verbrauchsprodukte</h2>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Welche Pflegehilfsmittel sind am wichtigsten?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Rollator/Rollstuhl, Pflegebett, Badewannenlift, Haltegriffe — für Mobilität und Sicherheit. Dazu Verbrauchsprodukte (Einmalhandschuhe, Bettschutz) monatlich bis 42 €.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was zahlt die Kasse, was muss selbst gezahlt werden?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Technische Hilfsmittel (Rollator, Rollstuhl): Kasse zahlt als Leihgabe oder Kauf. Verbrauchsprodukte: 42 €/Monat Pauschale. Wohnraumanpassung: bis 4.000 €/Maßnahme.</p></div>
            </details>
          </div>
          <Weiterlesen aktuell="pflegehilfsmittel-organisieren" />
          <ArticleCTA />
        </div>
      </div>
    </>
