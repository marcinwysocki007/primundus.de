...
export const metadata: Metadata = {
  ...
  description: 'Zu Hause bleiben statt ins Heim: In Villingen-Schwenningen zieht eine Betreuungskraft ein und hilft im Alltag, bei Bedarf auch nachts. Ab 2.150 € im Monat.',
