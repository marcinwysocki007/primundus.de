...
export const metadata: Metadata = {
  ...
  description: 'In Villingen-Schwenningen zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
