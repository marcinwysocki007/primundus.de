...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Osnabrück 2026" },
  { id: 'polnische-betreuungskraefte-in-osnabrueck', title: "Polnische Betreuungskräfte in Osnabrück" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Osnabrück" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Osnabrück ausmacht" },
  { id: 'einzugsgebiet-osnabrueck', title: "Einzugsgebiet Osnabrück" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Osnabrück" },
]
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Osnabrück"
          titel="24-Stunden-Pflege und Betreuung in Osnabrück"
          ...
          blickTitel="Osnabrück auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Osnabrück 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Osnabrück"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-osnabrueck', text: 'Preis und Betreuungskräfte für Osnabrück ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-osnabrueck" titel="Polnische Betreuungskräfte in Osnabrück">
            <Text>Wer in Osnabrück nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Osnabrück und im gesamten Umland im Einsatz.</Text>
            <Kasten titel="Angestellt statt vermittelt">
              <Text>Das ist der Unterschied, der im Alltag zählt: Bei Primundus sind die Betreuungskräfte fest angestellt. Wir reichen sie nicht an Sie weiter, und Sie werden nicht zum Arbeitgeber. Die Kraft arbeitet mit A1-Bescheinigung im Entsendemodell in Deutschland, Ihr Vertrag läuft mit uns. Für Sie heißt das: keine Lohnabrechnung, keine Sozialabgaben, keine Arbeitgeberhaftung. Und wenn eine Kraft ausfällt, organisieren wir den Ersatz — ohne Zusatzkosten, es fallen lediglich die An- und Abreisekosten an.</Text>
            </Kasten>
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> zwischen 2.200 und 3.500 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbetrag und Entlastungsbudget in Niedersachsen meist rund 1300 bis 2400 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der hier im Schnitt rund 3.010 Euro im Monat kostet.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Osnabrück">
            <Text>Unsere Betreuungskräfte ziehen in Osnabrück und im Landkreis Osnabrück ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Osnabrück ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-osnabrueck" titel="Einzugsgebiet Osnabrück">
            <Text>Osnabrück und Landkreis Osnabrück: Bad Iburg, Georgsmarienhütte, Bramsche, Melle und alle Gemeinden im Landkreis Osnabrück</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Osnabrück">
