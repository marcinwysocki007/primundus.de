...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Baden-Württemberg in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Baden-Württemberg', item: 'https://primundus.de/24h-pflege-baden-wuerttemberg' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Baden-Württemberg"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Baden-Württemberg" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Baden-Württemberg" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Baden-Württemberg 2026">
            <Tabelle
              ...
              betont={1}
              fuss="Eine Person, Pflegegrad 3, Werte aus unserem Kostenrechner · Pflegeheim Baden-Württemberg: Eigenanteil Ø 2700–3500 €/Monat — was bei Ihnen bleibt, zeigt der Kostenrechner in 2 Minuten"
            />
            <Tabelle
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-baden" titel="Polnische Betreuungskräfte in Baden-Württemberg">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet,</strong> hängt von der Pflegesituation und den Deutschkenntnissen ab — Ihren Preis zeigt der Kostenrechner in 2 Minuten. Pflegegeld und Entlastungsbudget zahlen bei Pflegegrad 3 zusammen bis zu ca. 894 Euro im Monat, dazu kommen bis zu 333 Euro Steuerermäßigung; ein Heimplatz kostet in Baden-Württemberg im ersten Jahr im Schnitt rund 3.660 Euro Eigenanteil.</Text>
          ...
          <OrtWerkzeuge slug="baden-wuerttemberg" ort={'Baden-Württemberg'} land={'Deutschland insgesamt'} altbau={43.7} miete={8.13} />
          ...
          <OrtStimmen ort={'Baden-Württemberg'} />
