      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Pflegekraft legal beschäftigen</span>
          </nav>
          ...
          <div className="bg-white rounded-2xl border border-pm-line overflow-hidden mb-8 shadow-sm">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={modell} className={i === 0 ? 'bg-pm-shell' : i % 2 === 0 ? 'bg-white' : 'bg-pm-paper'}>
                      ...
                      <td className={`px-4 py-3 text-[14px] border-b border-pm-line ${recht.startsWith('✓') ? 'text-pm-green' : 'text-pm-coral'}`}>{recht}</td>
                      <td className="px-4 py-3 text-[14px] text-pm-body border-b border-pm-line">{aufwand}</td>
                      <td className={`px-4 py-3 text-[14px] font-semibold border-b border-pm-line ${i === 0 ? 'text-pm-taupe' : i === 2 ? 'text-pm-coral' : 'text-pm-body'}`}>{empf}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <p className="text-[15px] text-pm-body mb-10">
            ...
            <a href="/pflegekraft-aus-polen" className="text-pm-taupe underline hover:text-pm-taupe-deep">Pflegekraft aus Polen — legal & sicher</a>
          </p>
          ...
          <p className="text-[15px] text-pm-body mb-10">
            → Mehr zum Thema:{' '}
            <a href="/scheinselbststaendigkeit-pflege-vermeiden" className="text-pm-taupe underline hover:text-pm-taupe-deep">Scheinselbstständigkeit vermeiden — alle Risiken</a>
          </p>
          ...
          <p className="text-[15px] text-pm-body mb-10">
            → Vertragsgestaltung:{' '}
            <a href="/pflegevertrag-aufsetzen" className="text-pm-taupe underline hover:text-pm-taupe-deep">Pflegevertrag aufsetzen — was muss rein?</a>
          </p>
          ...
          <Weiterlesen aktuell="pflegekraft-legal-beschaeftigen" />
          <ArticleCTA />
        </div>
      </div>
    </>
