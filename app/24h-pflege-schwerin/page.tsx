    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-[24px] md:text-[28px] font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Schwerin</h2>
          ...
          <div className="bg-white border border-pm-line rounded-2xl p-5 mb-8">
            ...
            <div className="flex items-center gap-3 pt-4 mt-1 border-t border-pm-line">
              ...
              <div>
                <p className="text-[14px] font-bold text-pm-ink">Testsieger bei DIE WELT</p>
