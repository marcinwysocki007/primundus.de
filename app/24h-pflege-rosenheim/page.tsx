...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Rechnen Sie Ihren Fall für Rosenheim durch" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Rosenheim" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Rosenheim: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Rosenheim: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Rosenheim Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Rosenheim hat im Schnitt 83,1 m², 30,4 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 69,7 % der Wohnungen in Rosenheim liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
