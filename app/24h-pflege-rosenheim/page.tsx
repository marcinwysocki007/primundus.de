    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Nur 47,2 Prozent der Gebäude stehen frei, in Bayern sind es 67,3 Prozent. Auf ein Gebäude kommen in Rosenheim im Schnitt 3,1 Wohnungen, in Bayern sind es 2,1. Hier wird also dichter gebaut — mehr Geschosswohnungen, weniger Haus mit Garten.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
