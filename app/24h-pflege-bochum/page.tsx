...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bochum: zu Hause bleiben statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-bochum" titel="Polnische Betreuungskräfte in Bochum">
            <Text>Wer in Bochum nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Bochum und im gesamten Umland im Einsatz.</Text>
