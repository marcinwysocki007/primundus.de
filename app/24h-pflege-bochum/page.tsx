...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Bochum bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Bochum 2026" },
  { id: 'polnische-betreuungskraefte-in-bochum', title: "Polnische Betreuungskräfte in Bochum" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Bochum ausmacht" },
  { id: 'einzugsgebiet-bochum', title: "Einzugsgebiet Bochum" },
  { id: 'werkzeuge', title: "Was es in Bochum kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Bochum über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Bochum" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bochum: Preis und Kräfte sofort sehen',
  description: 'In Bochum zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Herne, Witten und Dortmund. Keine Vermittlungsgebühr, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Bochum?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Bochum Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Bochum hat im Schnitt 80,4 m², 31,4 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 57,9 % der Wohnungen in Bochum liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Bochum"
          titel="24-Stunden-Pflege und Betreuung in Bochum"
          ...
          blickTitel="Bochum auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Bochum bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Bochum bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Bochum 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Bochum"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-bochum" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-bochum" titel="Polnische Betreuungskräfte in Bochum">
            <Text>Wer in Bochum nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Bochum und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Bochum ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-bochum" titel="Einzugsgebiet Bochum">
            <Text>Bochum und Umland: Herne, Witten, Dortmund, Essen und alle Gemeinden im mittleren Ruhrgebiet</Text>
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20251122-volker'].includes(b.id))}

          />


          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Bochum">
