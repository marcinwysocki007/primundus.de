      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          <nav className="h-[24px] text-sm text-[#8B8B8B] mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-[#1C1C1C]">Pflegegrad ohne Diagnose</span>
          </nav>
          <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[#A89279] mb-4">Ratgeber · 4 Min</p>
          <h1 className="text-[32px] md:text-[42px] font-bold text-[#1C1C1C] leading-tight mb-6">Pflegegrad ohne Diagnose — was Sie wissen sollten</h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-[#2E2E2E] mb-10 font-medium">Viele fragen sich: Brauche ich eine Diagnose für einen Pflegegrad? Die kurze Antwort: Nein — der MD bewertet Alltagsbeeinträchtigungen, nicht Diagnosen. Aber eine Diagnose kann helfen.</p>
          <h2 id="grundsatz" className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mt-10 mb-4 leading-snug">Was bewertet der MD?</h2>
          ...
          <h2 id="diagnose" className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mt-10 mb-4 leading-snug">Wann hilft eine Diagnose?</h2>
          ...
          <h2 id="vorgehen" className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mt-10 mb-4 leading-snug">Wie vorgehen</h2>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-[#E5E3DF] group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-[#1C1C1C] pr-4">Brauche ich eine Diagnose für einen Pflegegrad?</h3>
                <span className="text-[#8B7355] font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-[#2E2E2E] leading-relaxed">Nein — der MD bewertet konkrete Alltagsbeeinträchtigungen in 6 Modulen. Keine Diagnose nötig, aber ärztliche Berichte stützen die Begutachtung.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-[#E5E3DF] group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-[#1C1C1C] pr-4">Was wenn der Arzt keine Diagnose stellt?</h3>
                <span className="text-[#8B7355] font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-[#2E2E2E] leading-relaxed">Trotzdem Antrag stellen. Der MD bewertet was die Person wirklich nicht mehr kann — unabhängig von der ärztlichen Diagnose.</p></div>
            </details>
          </div>
          <ArticleCTA />
        </div>
