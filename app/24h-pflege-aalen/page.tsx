...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Aalen & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Aalen: Eigenanteil ab ca. 1200 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
