...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Pfaffenhofen an der Ilm', item: 'https://primundus.de/24h-pflege-pfaffenhofen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Pfaffenhofen an der Ilm"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-pfaffenhofen', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Pfaffenhofen an der Ilm" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Pfaffenhofen" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-pfaffenhofen" titel="Polnische Betreuungskräfte in Pfaffenhofen">
            <Text>Wer in Pfaffenhofen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Pfaffenhofen und im gesamten Umland im Einsatz.</Text>
