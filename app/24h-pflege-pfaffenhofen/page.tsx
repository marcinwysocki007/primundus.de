...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Rechnen Sie Ihren Fall für Pfaffenhofen durch" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Pfaffenhofen an der Ilm" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Pfaffenhofen: ab 2.150 € im Monat',
  description: '24-Stunden-Pflege in Pfaffenhofen: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <OrtWerkzeuge ort={'Pfaffenhofen'} land={'Bayern'} />
