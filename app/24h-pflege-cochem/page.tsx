...
// Seit 23.09.2026 traegt diese Datei nur noch, was in Cochem anders ist; der feste Text steht
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Cochem starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung.' },
...
const ORT: OrtDaten = {
  ...
  einzugsgebiet: 'Cochem und Landkreis Cochem-Zell: Zell an der Mosel, Kaisersesch, Treis-Karden und alle Gemeinden im Landkreis Cochem-Zell',
