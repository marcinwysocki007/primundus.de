    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Cochem"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Cochem" />}
          blick={[
