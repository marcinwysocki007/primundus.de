...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Stuttgart bedeutet" },
  ...
  { id: 'werkzeuge', title: "Was es in Stuttgart kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Stuttgart über uns" },
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Stuttgart', item: 'https://primundus.de/24h-pflege-stuttgart' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Stuttgart"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-stuttgart', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Stuttgart" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Stuttgart" />}
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Stuttgart bedeutet">
            <Text>
              ...
              Heim, wo der Umzug ansteht. Das Zuhause in Stuttgart bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-stuttgart" titel="Polnische Betreuungskräfte in Stuttgart">
            <Text>Wer in Stuttgart nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Stuttgart und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge slug="stuttgart" ort={'Stuttgart'} land={'Baden-Württemberg'} altbau={62.0} miete={10.39} />
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20260829-sabine', 'k-20260318-thomas', 'k-20251123-margret', 'k-20241108-manfred'].includes(b.id))}
