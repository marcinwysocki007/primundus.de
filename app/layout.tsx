...
export const metadata: Metadata = {
  ...
  description:
    'Rechtssichere 24h-Pflege zu Hause mit angestellten Betreuungskräften. 6× Preis-Leistungssieger. Täglich kündbar. Start in 4–7 Tagen. Beratung: 089 200 000 830.',
  openGraph: {
    siteName: 'Primundus',
    locale: 'de_DE',
    type: 'website',
