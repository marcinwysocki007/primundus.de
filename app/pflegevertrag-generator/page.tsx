...
const relatedTools = [
  ...
  { href: 'https://kostenrechner.primundus.de/?start=1&src=apex-pflegevertrag-generator', label: '24h-Kosten berechnen', desc: 'Eigenanteil für 24h-Pflege sofort sehen', external: true },
