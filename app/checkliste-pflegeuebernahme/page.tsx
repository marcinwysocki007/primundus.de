        ...
        <div className="max-w-[720px] mx-auto px-5 pb-16">
          ...
          <section className="mb-12">
            ...
            <div className="flex flex-col gap-3">
              {phasen.map((p) => (
                <div key={p.nr} className="bg-white border border-pm-line rounded-xl px-5 py-4 flex items-start gap-4">
                  <span className="w-8 h-8 rounded-full bg-pm-shell text-pm-taupe font-bold text-[14px] flex items-center justify-center flex-shrink-0">
                    {p.nr}
                  </span>
