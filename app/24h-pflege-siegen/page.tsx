      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Siegen · Aktualisiert August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Siegen
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Weidenau, Geisweid oder Eiserfeld: Siegener Häuser stehen am Hang — mit Treppen, Garten und Aussicht, die man nicht eintauscht. Eine Betreuungskraft von Primundus zieht mit ein, begleitet jeden Weg und ist Tag und Nacht da. Täglich kündbar, rechtssicher, startklar in 4–7 Tagen.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wie in Siegen gebaut wurde, merkt man spätestens auf der Treppe. 69,6 Prozent der Gebäude stehen frei, in Nordrhein-Westfalen 50,2 Prozent — mehr Haus, mehr Platz, mehr Möglichkeiten. Reihenhäuser sind in Siegen mit 13,7 Prozent seltener als in Nordrhein-Westfalen (27,2 Prozent).
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 10.213 Menschen in Siegen sind 75 Jahre oder älter, und der Ort zählt 54.759 Wohnungen in 24.602 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          <div className="space-y-3 mb-12">
            {[
              ...
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Siegen starten?', a: 'In der Regel in 4–7 Tagen. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
