...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Hagen bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Hagen 2026" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Hagen: Kräfte ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Hagen bei Ihnen ein. Foto, Erfahrung und Deutsch sehen Sie vorher.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Hagen?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Hagen Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Hagen hat im Schnitt 82,8 m², 26,1 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 59,9 % der Wohnungen in Hagen liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Hagen"
          titel="24-Stunden-Pflege und Betreuung in Hagen"
          ...
          blickTitel="Hagen auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Hagen bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Hagen bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Hagen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Hagen"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-hagen" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-hagen" titel="Polnische Betreuungskräfte in Hagen">
            <Text>Wer in Hagen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Hagen und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Hagen ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-hagen" titel="Einzugsgebiet Hagen">
            <Text>Hagen und Umland: Iserlohn, Märkisches Sauerland, Dortmund-Süd und alle Gemeinden im Märkischen Kreis</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Hagen">
