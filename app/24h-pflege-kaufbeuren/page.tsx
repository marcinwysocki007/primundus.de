    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Kaufbeuren"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Kaufbeuren" />}
          blick={[
