...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Freiburg & Umland',
  description: '24-Stunden-Pflege in Freiburg & Umland: Eigenanteil ab ca. 1200 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
...
const schemaMarkup = [
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Breisach am Rhein?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Breisach am Rhein starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Breisach am Rhein rechtssicher?',
        acceptedAnswer: { '@type': 'Answer', text: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
      },
      {
        '@type': 'Question',
        name: 'Ist unsere Wohnung in Freiburg überhaupt groß genug für eine Betreuungskraft?',
        acceptedAnswer: { '@type': 'Answer', text: 'Das ist in Freiburg tatsächlich die erste Frage. Die Stadt hat mit rund 81 Quadratmetern die kleinsten Wohnungen der Region — im Land sind es 99 —, und gut ein Drittel misst weniger als 60 Quadratmeter. Eine Betreuungskraft braucht ein eigenes Zimmer, das ist die Voraussetzung. In vielen Freiburger Wohnungen lässt sich das einrichten, in einer kleinen Zwei-Zimmer-Wohnung nicht. Wir klären das vorab mit Ihnen, bevor irgendetwas entschieden wird — und sagen es offen, wenn es nicht passt.' },
      },
      {
        '@type': 'Question',
        name: 'Wäre ein Umzug in eine altersgerechte Wohnung nicht einfacher?',
        acceptedAnswer: { '@type': 'Answer', text: 'In Freiburg leider selten. Die Stadt hat mit gut zwei Prozent die niedrigste Leerstandsquote aller 44 Stadt- und Landkreise Baden-Württembergs und gehört zu den vier teuersten Großstädten Deutschlands. Wer hier eine bezahlbare, barrierearme Wohnung sucht, sucht lange — und muss meist das gewohnte Viertel verlassen. Deshalb ist die praktikablere Frage in der Regel, wie das Leben in der vorhandenen Wohnung weitergehen kann.' },
      },
      {
        '@type': 'Question',
        name: 'Kommt eine Betreuungskraft auch in die Gemeinden im Schwarzwald?',
        acceptedAnswer: { '@type': 'Answer', text: 'Ja, und dort ist der Unterschied besonders groß. Zwischen der Rheinebene und dem Hochschwarzwald liegen über 1.300 Höhenmeter. Ein ambulanter Dienst, der Gemeinden am Berg anfährt, plant im Winter anders als im Sommer, und die Termine richten sich nach der Tour. Eine Betreuungskraft, die im Haus wohnt, ist davon unabhängig. Anfahrtskosten berechnen wir nicht, der Preis ist im Umland derselbe wie in der Stadt.' },
      },
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Breisach am Rhein bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Breisach und westlicher Breisgau-Hochschwarzwald: Freiburg-Umland, Vogtsburg, Ihringen, Kaiserstuhl und alle Gemeinden im westlichen Landkreis Breisgau-Hochschwarzwald' },
      },
    ],
  },
]

export default function BreisachamRheinPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Breisach am Rhein</span>
          </nav>

          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Breisach am Rhein · Aktualisiert am 27. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Freiburg & Umland
          </h1>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Breisach am Rhein 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Breisach am Rhein</p>
            </div>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-freiburg-umland" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Freiburg & Umland ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Freiburg & Umland</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Freiburg & Umland nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Freiburg & Umland und im gesamten Umland im Einsatz.
          </p>
          ...
          {/* ⑤ EINZUGSGEBIET */}
          {/* ⑤ KREIS-H2 */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">24-Stunden-Pflege im westlichen Breisgau-Hochschwarzwald</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">Unsere Betreuungskräfte ziehen in Freiburg & Umland und im westlichen Breisgau-Hochschwarzwald ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</p>
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Breisach am Rhein</p>
          ...
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Breisach am Rhein?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1200–2300 €/Monat — deutlich günstiger als ein Heimplatz in Baden-Württemberg (Eigenanteil rund 3.660 €/Monat, vdek 07/2026).' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-freiburg-umland" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
              Betreuung anfragen
            </a>
          </div>
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Breisach am Rhein die richtige Lösung?"
