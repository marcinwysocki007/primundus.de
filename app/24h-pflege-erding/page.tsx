...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Erding 2026" },
  { id: 'polnische-betreuungskraefte-in-erding', title: "Polnische Betreuungskräfte in Erding" },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Erding"
          titel="24-Stunden-Pflege und Betreuung in Erding"
          einleitung={<>Altstadt, Klettham oder das Umland zwischen Therme und Flughafen: Erdinger bleiben ihrem Zuhause treu. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Erding auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Erding 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Erding"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-erding', text: 'Preis und Betreuungskräfte für Erding ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-erding" titel="Polnische Betreuungskräfte in Erding">
            <Text>Wer in Erding nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Erding und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Erding">
            <Text>Unsere Betreuungskräfte ziehen in Erding und im Landkreis Erding ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Erding ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-erding" titel="Einzugsgebiet Erding">
            <Text>Erding und Landkreis Erding: Dorfen, Taufkirchen, Ebersberg, Grafing und alle Gemeinden im Landkreis Erding und Ebersberg</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Erding">
