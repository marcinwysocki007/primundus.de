...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Rechnen Sie Ihren Fall für Saarland durch" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Saarland" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Saarland: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Saarland: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Saarland Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Saarland hat im Schnitt 107,1 m², 13,7 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 88,3 % der Wohnungen in Saarland liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
