...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte polnische Pflegekräfte und Preis direkt online sehen. Anreise in Neustadt an der Weinstraße in 3 Tagen möglich – mit Bestpreisgarantie.',
