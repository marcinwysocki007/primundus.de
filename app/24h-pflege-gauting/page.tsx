...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Gauting: erst ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Gauting bei Ihnen ein. Sie wählen sie vorher selbst aus.',
