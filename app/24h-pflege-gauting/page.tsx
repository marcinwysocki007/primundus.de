...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Gauting 2026" },
  { id: 'polnische-betreuungskraefte-in-gauting', title: "Polnische Betreuungskräfte in Gauting" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im südwestlichen Landkreis Starnberg" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Gauting ausmacht" },
  { id: 'einzugsgebiet-gauting', title: "Einzugsgebiet Gauting" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Gauting" },
]
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Gauting"
          titel="24-Stunden-Pflege und Betreuung in Gauting"
          einleitung={<>Im Würmtal — in Gauting, Stockdorf oder Königswiesen — wohnen viele, deren Kinder täglich nach München pendeln. Eine Betreuungskraft von Primundus schließt die Lücke: Sie zieht mit ein und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Gauting auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Gauting 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Gauting"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-gauting', text: 'Preis und Betreuungskräfte für Gauting ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-gauting" titel="Polnische Betreuungskräfte in Gauting">
            <Text>Wer in Gauting nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Gauting und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im südwestlichen Landkreis Starnberg">
            <Text>Unsere Betreuungskräfte ziehen in Gauting und im südwestlichen Landkreis Starnberg ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Gauting ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-gauting" titel="Einzugsgebiet Gauting">
            <Text>Gauting und südwestlicher Landkreis Starnberg: Stockdorf, Gilching, Weßling, Seefeld und alle Gemeinden im südwestlichen Landkreis Starnberg</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Gauting">
