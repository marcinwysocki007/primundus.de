...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Münster ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung in den eigenen vier Wänden statt Heimplatz: Eine Betreuungskraft zieht in Münster ein und entlastet die Familie. Ab 2.150 €, täglich kündbar.',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <OrtWerkzeuge ort={'Münster'} land={'Nordrhein-Westfalen'} altbau={45.1} miete={8.71} />
