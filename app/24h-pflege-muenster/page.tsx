...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Münster | Primundus',
  description: '24-Stunden-Pflege in Münster: Eigenanteil ab ca. 1300 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-muenster#service',
    name: 'Primundus — 24h-Pflege Münster',
    serviceType: '24-Stunden-Betreuung zu Hause',
    description: '24h-Betreuungskräfte in Münster. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-muenster',
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Münster', item: 'https://primundus.de/24h-pflege-muenster' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Münster?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Münster starten?',
      ...
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Münster bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Münster und Umland: Warendorf, Coesfeld, Steinfurt, Greven, Telgte und alle Gemeinden im Kreis Warendorf und Coesfeld' },
      },
    ],
  },
]
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Münster</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Münster · Aktualisiert am 28. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Münster
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Kreuzviertel, Mauritz oder draußen in Hiltrup: Münsteraner wohnen mit dem Rad vor der Tür und dem Aasee um die Ecke — und möchten genau dort alt werden. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist Tag und Nacht da. Täglich kündbar, rechtssicher, meist startklar in 4–7 Tagen.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Münster 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Münster</p>
            </div>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-muenster" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Münster ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Münster</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Münster nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Münster und im gesamten Umland im Einsatz.
          </p>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Münster</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Münster und Umland: Warendorf, Coesfeld, Steinfurt, Greven, Telgte und alle Gemeinden im Kreis Warendorf und Coesfeld</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Münster ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            11,6 Prozent der Wohnungen wurden nach 2010 gebaut, in Nordrhein-Westfalen 5,8 Prozent — ein vergleichsweise junger Bestand. Eine Betreuungskraft braucht ein eigenes Zimmer, und genau daran hakt es in Münster häufiger als anderswo. Knapp jede dritte Wohnung ist kleiner als 60 Quadratmeter — in Nordrhein-Westfalen sind es 22,4 Prozent. Deshalb klären wir vorab am Telefon, was Ihre Wohnung hergibt, statt es später herauszufinden.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Münster wohnen nur 29,2 Prozent der Haushalte im Eigentum, in Nordrhein-Westfalen 40,6 Prozent. In eine größere Wohnung zu ziehen ist für die meisten keine Option — es muss also in der vorhandenen gehen. Mit 8,71 Euro Nettokaltmiete je Quadratmeter wohnt es sich in Münster teurer als im Schnitt von Nordrhein-Westfalen (6,82 Euro) — ein Umzug in eine größere Wohnung ist für die meisten keine Option.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In 19,5 Prozent der Haushalte leben ausschließlich Menschen ab 65, etwas seltener als in Nordrhein-Westfalen mit 24,2 Prozent. 52,5 Prozent aller Haushalte in Münster bestehen aus einer einzigen Person, in Nordrhein-Westfalen sind es 43,7 Prozent. Alleinlebend heißt im Pflegefall: Es ist niemand da, der es mitbekommt. Altbau vor 1950 macht in Münster 12,0 Prozent des Bestands aus, in Nordrhein-Westfalen 19,7 Prozent.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 28.143 Menschen in Münster sind 75 Jahre oder älter, und es gibt 166.045 Wohnungen in 57.451 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Münster</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Münster?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1300–2400 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Münster starten?', a: 'In der Regel in 4–7 Tagen. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
              ...
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Münster?', a: 'Das hängt am Grundriss, und die Ausgangslage in Münster ist bekannt: Die durchschnittliche Wohnung misst 85,7 Quadratmeter, 32,0 Prozent liegen unter 60 Quadratmetern (Nordrhein-Westfalen: 22,4 Prozent), und 29,2 Prozent der Haushalte wohnen im Eigentum (Nordrhein-Westfalen: 40,6 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-muenster" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
              Kosten & Pflegekräfte ansehen
            </a>
          </div>

          {/* ⑩ CTA */}
          <NearbyCities current="muenster" />

          <ArticleCTA
            headline="Ist 24h-Pflege in Münster die richtige Lösung?"
