...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Münster: zu Hause bleiben statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-muenster" titel="Polnische Betreuungskräfte in Münster">
            <Text>Wer in Münster nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Münster und im gesamten Umland im Einsatz.</Text>
