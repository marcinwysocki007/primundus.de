...
// Seit 23.09.2026 traegt diese Datei nur noch, was in Münster anders ist; der feste Text steht
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Münster starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung.' },
...
const ORT: OrtDaten = {
  ...
  lesezeit: '6 Min.',
  einleitung: <>Kreuzviertel, Mauritz oder draußen in Hiltrup: Münsteraner wohnen mit dem Rad vor der Tür und dem Aasee um die Ecke — und möchten genau dort alt werden. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist bei Bedarf auch nachts da.</>,
  vorOrt: {
    inhalt: (
      <>
  ...
  einzugsgebiet: 'Münster und Umland: Warendorf, Coesfeld, Steinfurt, Greven, Telgte und alle Gemeinden im Kreis Warendorf und Coesfeld',
  stimmen: ['k-20260716-nicole', 'k-20260407-joachim', 'k-20251125-thomas', 'k-20241125-axel'],
  fragen: FRAGEN,
}
