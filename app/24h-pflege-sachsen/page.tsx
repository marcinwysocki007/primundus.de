...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Sachsen 2026" },
  ...
  { id: 'werkzeuge', title: "Was es in Sachsen kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Sachsen" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Sachsen: Preis und Kräfte sofort sehen',
  description: '24-Stunden-Pflege in Sachsen: Ihren Preis und die passenden Betreuungskräfte sehen Sie in 2 Minuten — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-sachsen#service',
    name: 'Primundus — 24h-Pflege Sachsen',
    serviceType: '24-Stunden-Betreuung zu Hause',
    description: '24h-Betreuungskräfte in Sachsen. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-sachsen',
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Sachsen', item: 'https://primundus.de/24h-pflege-sachsen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Sachsen?',
        acceptedAnswer: { '@type': 'Answer', text: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — oft günstiger als ein Heimplatz in Sachsen (Eigenanteil rund 2.990 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Sachsen starten?',
        acceptedAnswer: { '@type': 'Answer', text: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller. Primundus ist mit eigenen Betreuungskräften in ganz Sachsen — auch in ländlichen Regionen.' },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Sachsen rechtssicher?',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Sachsen?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — oft günstiger als ein Heimplatz in Sachsen (Eigenanteil rund 2.990 €/Monat, vdek 07/2026).' },
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Sachsen starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller. Primundus ist mit eigenen Betreuungskräften in ganz Sachsen — auch in ländlichen Regionen.' },
  { q: 'Was ist der Unterschied zu einem ambulanten Pflegedienst?', a: 'Ein ambulanter Dienst kommt 1–3 Mal täglich und geht wieder. Eine 24h-Betreuungskraft lebt im Haushalt — ist bei Bedarf auch nachts da, führt den gesamten Haushalt und bietet bei Demenz oder hohem Pflegebedarf die einzige wirklich durchgehende Lösung.' },
  { q: 'Ist 24h-Pflege über Primundus in Sachsen rechtssicher?', a: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
  { q: 'Ist in einer Wohnung in Sachsen Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Sachsen hat im Schnitt 79,1 m², 34,1 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 76,2 % der Wohnungen in Sachsen liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Sachsen"
          titel="24h-Pflege Sachsen — Betreuungskraft zuhause"
          ...
          blick={[
            ...
            'Pflegeheim Sachsen: Eigenanteil Ø 2100–2500 €/Monat',
            'Täglich kündbar, keine Vermittlungsgebühr',
            'Anreise in 3 Tagen möglich',
          ]}
          blickTitel="Sachsen auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Sachsen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Sachsen"
              zeilen={[
              ...
              betont={1}
              fuss="Eine Person, Werte aus unserem Kostenrechner, zzgl. An- und Abreise 125 € je Strecke · Pflegeheim Sachsen: Eigenanteil Ø 2100–2500 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause"
            />
            <Tabelle
            ...
            />
            <RechnerKasten src="land-sachsen" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-sachsen" titel="Polnische Betreuungskräfte in Sachsen">
            <Text>Wer in Sachsen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in ganz Sachsen im Einsatz, in der Großstadt wie im kleinsten Dorf.</Text>
            <Kasten titel="Angestellt statt vermittelt">
              <Text>Das ist der Unterschied, der im Alltag zählt: Bei Primundus sind die Betreuungskräfte fest angestellt. Wir reichen sie nicht an Sie weiter, und Sie werden nicht zum Arbeitgeber. Die Kraft arbeitet mit A1-Bescheinigung im Entsendemodell in Deutschland, Ihr Vertrag läuft mit uns. Für Sie heißt das: keine Lohnabrechnung, keine Sozialabgaben, keine Arbeitgeberhaftung. Und wenn eine Kraft ausfällt, organisieren wir den Ersatz — ohne Zusatzkosten, es fallen lediglich die An- und Abreisekosten an.</Text>
            </Kasten>
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> ab 2.150 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbudget und Steuerermäßigung ab ca. 923 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der in Sachsen im ersten Jahr im Schnitt rund 2.990 Euro im Monat kostet.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Sachsen ausmacht">
            <Text>In Sachsen sind 363.243 Menschen pflegebedürftig, das entspricht 8,88 Prozent der Bevölkerung. Bundesweit sind es 6,72 Prozent. Das ist die dritthöchste Pflegequote aller 16 Bundesländer. Diese Unterschiede sind groß — zwischen dem niedrigsten und dem höchsten Landeswert liegt fast das Doppelte —, weshalb ein Vergleich mit dem Bundesschnitt allein wenig aussagt.</Text>
            <Text>Knapp jeder zweite Pflegebedürftige wird allein von Angehörigen versorgt — bundesweit sind es 54,5 Prozent, hier also weniger. 176.116 Menschen sind das in Sachsen, ohne jeden Pflegedienst. Ambulante Dienste übernehmen 24,4 Prozent (Bund 19,3), im Heim leben 13,7 Prozent (Bund 14,1).</Text>
            <Text>Bemerkenswert ist der hohe Anteil ambulanter Versorgung. Familien in Sachsen kaufen professionelle Hilfe eher ein, als alles allein zu tragen. Eine Betreuungskraft im Haushalt ist die konsequente Fortsetzung dieses Wegs: nicht ein Besuch zwei- oder dreimal am Tag, sondern jemand, der auch nachts da ist.</Text>
            <Text>Ob eine Betreuungskraft einziehen kann, entscheidet am Ende der Grundriss. Gut drei von vier Gebäuden sind ein Ein- oder Zweifamilienhaus (bundesweit 81,8 Prozent), die durchschnittliche Wohnung misst 79,1 Quadratmeter gegenüber 94,4 im Bund. Notwendig ist ein eigenes, abschließbares Zimmer — was Ihre Wohnung hergibt, klären wir vorab am Telefon, nicht hinterher.</Text>
          ...
          <Abschnitt id="einzugsgebiet-sachsen" titel="Einzugsgebiet Sachsen">
            <Text>Dresden, Leipzig, Chemnitz, Zwickau, Plauen, Görlitz, Bautzen, Freital, Pirna, Meißen und alle weiteren Städte und Gemeinden in Sachsen</Text>
            <CitiesOfRegion region="sachsen" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Sachsen'} land={'Deutschland insgesamt'} altbau={59.3} miete={5.72} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Sachsen">
