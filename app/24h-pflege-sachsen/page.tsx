...
export const metadata: Metadata = {
  title: '24h-Pflege Sachsen — Betreuungskraft | Primundus',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Heimplatz in Sachsen (Eigenanteil rund 2.990 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Sachsen</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Sachsen · Aktualisiert am 28. August 2026
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Sachsen 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Sachsen</p>
            </div>
            ...
            <div className="bg-pm-paper border-t border-pm-line px-5 py-3">
              <p className="text-[12px] text-pm-mute">Pflegeheim Sachsen: Eigenanteil Ø 2100–2500 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=land-sachsen" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte in Sachsen ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Sachsen</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Sachsen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in ganz Sachsen im Einsatz, in der Großstadt wie im kleinsten Dorf.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            ...
            als ein Heimplatz, der in Sachsen im ersten Jahr im Schnitt rund 2.990 Euro im Monat
            kostet.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Sachsen</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Dresden, Leipzig, Chemnitz, Zwickau, Plauen, Görlitz, Bautzen, Freital, Pirna, Meißen und alle weiteren Städte und Gemeinden in Sachsen</p>
          </div>

          {/* ⑤c VOR ORT — Bundesland, aus Pflegestatistik 2023 und Zensus 2022 */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Sachsen ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Sachsen sind 363.243 Menschen pflegebedürftig, das entspricht 8,88 Prozent der Bevölkerung. Bundesweit sind es 6,72 Prozent. Das ist die dritthöchste Pflegequote aller 16 Bundesländer. Diese Unterschiede sind groß — zwischen dem niedrigsten und dem höchsten Landeswert liegt fast das Doppelte —, weshalb ein Vergleich mit dem Bundesschnitt allein wenig aussagt.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Knapp jeder zweite Pflegebedürftige wird allein von Angehörigen versorgt — bundesweit sind es 54,5 Prozent, hier also weniger. 176.116 Menschen sind das in Sachsen, ohne jeden Pflegedienst. Ambulante Dienste übernehmen 24,4 Prozent (Bund 19,3), im Heim leben 13,7 Prozent (Bund 14,1).
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Bemerkenswert ist der hohe Anteil ambulanter Versorgung. Familien in Sachsen kaufen professionelle Hilfe eher ein, als alles allein zu tragen. Eine Betreuungskraft im Haushalt ist die konsequente Fortsetzung dieses Wegs: nicht ein Besuch zwei- oder dreimal am Tag, sondern jemand, der auch nachts da ist.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Sachsen</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Sachsen?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Heimplatz in Sachsen (Eigenanteil rund 2.990 €/Monat, vdek 07/2026).' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-sachsen" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200">
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Sachsen die richtige Lösung?"
