...
const SECTIONS = [
  ...
  { id: 'stimmen-vor-ort', title: "Familien aus Bayreuth über uns" },
...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare polnische Pflegekräfte für Bayreuth und Preis direkt online sehen. Anreise in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Bayreuth', item: 'https://primundus.de/24h-pflege-bayreuth' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Bayreuth" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-bayreuth" titel="Polnische Betreuungskräfte in Bayreuth">
            <Text>Wer in Bayreuth nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Bayreuth und im gesamten Umland im Einsatz.</Text>
