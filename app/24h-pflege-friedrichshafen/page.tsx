...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Friedrichshafen | 6× Testsieger',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<Ansprechpartnerin karte ort="Friedrichshafen" titel="Ihre Ansprechpartnerin für Friedrichshafen" />}
        />
