...
export const metadata: Metadata = {
  ...
  description: 'In Bad Reichenhall zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
