...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Waldshut-Tiengen: zu Hause statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-waldshut" titel="Polnische Betreuungskräfte in Waldshut-Tiengen">
            <Text>Wer in Waldshut-Tiengen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Waldshut-Tiengen und im gesamten Umland im Einsatz.</Text>
