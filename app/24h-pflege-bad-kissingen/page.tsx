...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Rechnen Sie Ihren Fall für Bad Kissingen durch" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Bad Kissingen" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bad Kissingen: ab 2.150 € im Monat',
  description: '24-Stunden-Pflege in Bad Kissingen: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
