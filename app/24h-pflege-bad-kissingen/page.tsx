...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bad Kissingen | 6× Testsieger | Primundus',
  description: 'Geprüfte, verfügbare polnische Pflegekräfte für Bad Kissingen und Preis direkt online sehen. Anreise in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Bad Kissingen', item: 'https://primundus.de/24h-pflege-bad-kissingen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Bad Kissingen" />}
        />
