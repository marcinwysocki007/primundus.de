...
const AKTUALISIERT = aktualisiertAm('intensivpflege-zuhause', '30. April 2026')
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Intensivpflege zuhause</span>
          </nav>
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">Krankheiten · 5 Min</p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">Intensivpflege zuhause — was möglich ist und was nicht</h1>

          <AuthorByline updated={AKTUALISIERT.sichtbar} />
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">Auch bei sehr hohem Pflegebedarf wünschen viele Menschen das eigene Zuhause. Intensivpflege zuhause ist möglich — aber sie erfordert spezialisiertes Personal und eine gute Organisation.</p>
          <h2 id="was-ist" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Was ist Intensivpflege?</h2>
          ...
          <h2 id="moeglich" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Was ist zuhause möglich?</h2>
          ...
          <h2 id="grenzen" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Wo sind die Grenzen?</h2>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was versteht man unter Intensivpflege zuhause?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Häusliche Krankenpflege für Patienten mit besonders hohem medizinischen Bedarf: Beatmung, Tracheostoma, komplexe Wundversorgung. Durch spezialisierte Pflegedienste.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Kann eine 24h-Betreuungskraft Intensivpflege übernehmen?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Nein — Intensivpflege erfordert Fachpflegepersonal. Eine 24h-Kraft ergänzt aber: Haushalt, Grundpflege, Gesellschaft — in Kombination mit einem Intensivpflegedienst.</p></div>
            </details>
          </div>
          <Weiterlesen aktuell="intensivpflege-zuhause" />
          <ArticleCTA />
        </div>
      </div>
    </>
