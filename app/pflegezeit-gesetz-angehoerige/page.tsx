    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">Rechtliches · 5 Min</p>
          ...
          <h2 id="pflegezeit" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Pflegezeit</h2>
          ...
          <h2 id="familienpflegezeit" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Familienpflegezeit</h2>
          ...
          <h2 id="notfall" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Kurzfristige Freistellung</h2>
