...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Singen: Preis und Kräfte sofort sehen',
  description: 'In Singen zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Radolfzell und Stockach. Keine Vermittlungsgebühr, täglich kündbar.',
