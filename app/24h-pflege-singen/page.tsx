...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Singen am Hohentwiel', item: 'https://primundus.de/24h-pflege-singen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Singen am Hohentwiel"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Singen am Hohentwiel" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Singen" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-singen" titel="Polnische Betreuungskräfte in Singen">
            <Text>Wer in Singen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Singen und im gesamten Umland im Einsatz.</Text>
