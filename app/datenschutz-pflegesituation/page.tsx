...
const AKTUALISIERT = aktualisiertAm('datenschutz-pflegesituation', '30. April 2026')
    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <h2 id="grundsatz" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Was gilt?</h2>
          ...
          <h2 id="praxis" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Praktische Regeln</h2>
          ...
          <h2 id="rechte" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Rechte der Betreuten</h2>
          ...
          <Weiterlesen aktuell="datenschutz-pflegesituation" />
          <ArticleCTA />
        </div>
      </div>
    </>
