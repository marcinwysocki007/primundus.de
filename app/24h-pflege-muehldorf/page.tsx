...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Mühldorf am Inn: zu Hause statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-muehldorf" titel="Polnische Betreuungskräfte in Mühldorf am Inn">
            <Text>Wer in Mühldorf am Inn nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Mühldorf am Inn und im gesamten Umland im Einsatz.</Text>
