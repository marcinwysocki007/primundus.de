...
export const metadata: Metadata = {
  ...
  description: 'Liebevolle Betreuung in Mühldorf am Inn und Entlastung für Angehörige. Geprüfte Betreuungskräfte & Preis sofort sehen – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Mühldorf am Inn', item: 'https://primundus.de/24h-pflege-muehldorf' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Mühldorf am Inn" />}
        />
