...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Reutlingen & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Reutlingen: Eigenanteil ab ca. 1200 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
