...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Landau bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Landau in der Pfalz 2026" },
  { id: 'polnische-betreuungskraefte-in-landau', title: "Polnische Betreuungskräfte in Landau" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Landau: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Landau: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Landau in der Pfalz?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Rheinland-Pfalz (Eigenanteil rund 3.220 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Landau Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Landau hat im Schnitt 96,1 m², 21,3 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 77,9 % der Wohnungen in Landau liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Landau in der Pfalz"
          titel="24-Stunden-Pflege und Betreuung in Landau"
          einleitung={<>Queichheim, Arzheim oder mitten in der Stadt an der Weinstraße: Landauer bleiben in der Südpfalz — beim Wein, beim Markt, im eigenen Zuhause. Eine Betreuungskraft von Primundus zieht mit ein und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Landau in der Pfalz auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Landau bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Landau bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Landau in der Pfalz 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Landau in der Pfalz"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-landau" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-landau" titel="Polnische Betreuungskräfte in Landau">
            <Text>Wer in Landau nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Landau und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-in" titel="24-Stunden-Pflege in der Südlichen Weinstraße">
            <Text>Unsere Betreuungskräfte ziehen in Landau und in der Südlichen Weinstraße ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Landau ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-landau-in-der" titel="Einzugsgebiet Landau in der Pfalz">
            <Text>Landau und Südliche Weinstraße: Neustadt an der Weinstraße, Edenkoben, Herxheim und alle Gemeinden im Landkreis Südliche Weinstraße</Text>
            <NearbyCities current="landau" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Landau'} land={'Rheinland-Pfalz'} />
