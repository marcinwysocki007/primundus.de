        ...
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <div className="bg-pm-mint border-[rgba(61,122,92,0.2)] border rounded-2xl p-5 mb-6">
            <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-pm-green-deep mb-3">Entlastungsbudget 2026 — Überblick</p>
              <div className="flex gap-2 text-[13px] text-pm-green-deep py-1.5 border-b border-[rgba(0,0,0,0.06)] last:border-0"><span>→</span>3.539 €/Jahr für PG 2–5</div>
              <div className="flex gap-2 text-[13px] text-pm-green-deep py-1.5 border-b border-[rgba(0,0,0,0.06)] last:border-0"><span>→</span>Umfasst Verhinderungspflege + Kurzzeitpflege</div>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Wie viel zahlt die Kasse für Kurzzeitpflege 2026?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Seit Juli 2025 ist Kurzzeitpflege Teil des Entlastungsbudgets: 3.539 €/Jahr für PG 2–5, kombinierbar mit Verhinderungspflege.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Wie lange kann Kurzzeitpflege in Anspruch genommen werden?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Bis zur Ausschöpfung des Entlastungsbudgets (3.539 €/Jahr). Tagessätze in Einrichtungen: typisch 80–130 €/Tag.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was ist der Unterschied zwischen Kurzzeitpflege und Verhinderungspflege?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Seit Juli 2025 sind beide im gemeinsamen Entlastungsbudget zusammengefasst. Kurzzeitpflege: stationär. Verhinderungspflege: ambulant oder durch nahestehende Person.</p></div>
            </details>
          </div>
          <ArticleCTA />
        </div>
