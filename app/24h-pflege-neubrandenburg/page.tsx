      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-neubrandenburg', text: 'Preis und Betreuungskräfte für Neubrandenburg ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-neubrandenburg" titel="Polnische Betreuungskräfte in Neubrandenburg">
            <Text>Wer in Neubrandenburg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Neubrandenburg und im gesamten Umland im Einsatz.</Text>
