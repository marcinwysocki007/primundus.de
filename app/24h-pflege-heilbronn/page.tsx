...
export const metadata: Metadata = {
  ...
  description: 'Eine Betreuungskraft zieht in Heilbronn — Stadt- und Landkreis bei Ihnen ein, statt Heimplatz. Sie wählen sie vorher selbst aus, mit Foto und Erfahrung.',
