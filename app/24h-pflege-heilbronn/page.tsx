...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Was es in Heilbronn kostet, und was die Pflegekasse dazugibt" },
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Heilbronn', item: 'https://primundus.de/24h-pflege-heilbronn' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Heilbronn"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-heilbronn', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Heilbronn" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Heilbronn" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-heilbronn" titel="Polnische Betreuungskräfte in Heilbronn">
            <Text>Wer in Heilbronn nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Heilbronn und im gesamten Umland im Einsatz.</Text>
