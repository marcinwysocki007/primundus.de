...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Wolfsburg 2026" },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Wolfsburg"
          titel="24-Stunden-Pflege und Betreuung in Wolfsburg"
          einleitung={<>Fallersleben, Vorsfelde oder Detmerode: Ein Arbeitsleben bei VW, ein Haus mit Garten — und der Wunsch, genau dort alt zu werden. Eine Betreuungskraft von Primundus macht es möglich: Sie zieht mit ein, wenn Hilfe nötig wird, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Wolfsburg auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Wolfsburg 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Wolfsburg"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-wolfsburg', text: 'Preis und Betreuungskräfte für Wolfsburg ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-wolfsburg" titel="Polnische Betreuungskräfte in Wolfsburg">
            <Text>Wer in Wolfsburg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Wolfsburg und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Wolfsburg ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-wolfsburg" titel="Einzugsgebiet Wolfsburg">
            <Text>Wolfsburg und Umland: Gifhorn, Helmstedt, Königslutter und alle Gemeinden im Landkreis Gifhorn und Helmstedt</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Wolfsburg">
