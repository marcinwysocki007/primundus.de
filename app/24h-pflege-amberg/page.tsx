...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Amberg bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Amberg 2026" },
  { id: 'polnische-betreuungskraefte-in-amberg', title: "Polnische Betreuungskräfte in Amberg" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Amberg-Sulzbach" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Amberg ausmacht" },
  { id: 'einzugsgebiet-amberg', title: "Einzugsgebiet Amberg" },
  { id: 'werkzeuge', title: "Was es in Amberg kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus der Region über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Amberg" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Amberg: erst ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Amberg bei Ihnen ein. Foto, Erfahrung und Deutsch sehen Sie vorher.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Amberg?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Amberg"
          titel="24-Stunden-Pflege und Betreuung in Amberg"
          einleitung={<>In der Altstadt an der Vils oder draußen vor den Toren: Amberger halten an ihrem Zuhause fest — oft seit Generationen. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Amberg auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Amberg bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Amberg bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Amberg 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Amberg"
              zeilen={[
            ...
            <RechnerKasten src="ort-amberg" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-amberg" titel="Polnische Betreuungskräfte in Amberg">
            <Text>Wer in Amberg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Amberg und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Amberg-Sulzbach">
            <Text>Unsere Betreuungskräfte ziehen in Amberg und im Landkreis Amberg-Sulzbach ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Amberg ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-amberg" titel="Einzugsgebiet Amberg">
            <Text>Amberg und Landkreis Amberg-Sulzbach: Sulzbach-Rosenberg, Auerbach, Hirschau und alle Gemeinden im Landkreis Amberg-Sulzbach</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Amberg">
