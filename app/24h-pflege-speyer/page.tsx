...
export const metadata: Metadata = {
  ...
  description: '24-Stunden-Pflege in Speyer & Rhein-Pfalz-Kreis: ab 2.150 € im Monat, bei Pflegegrad 3 ab ca. 923 € Eigenanteil. Kräfte vorher ansehen, täglich kündbar.',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-speyer" titel="Polnische Betreuungskräfte in Speyer">
            <Text>Wer in Speyer nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Speyer und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge ort={'Speyer'} land={'Rheinland-Pfalz'} />
