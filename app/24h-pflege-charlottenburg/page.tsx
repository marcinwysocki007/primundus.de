...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Berlin-Charlottenburg',
  description: '24-Stunden-Pflege in Berlin-Charlottenburg: Preis und passende Betreuungskräfte in 2 Minuten sehen — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — oft günstiger als ein Heimplatz in Brandenburg (Eigenanteil rund 3.020 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Berlin-Charlottenburg Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Berlin-Charlottenburg hat im Schnitt 73,2 m², 39,3 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 56,1 % der Wohnungen in Berlin-Charlottenburg liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Berlin-Charlottenburg 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Berlin-Charlottenburg"
              zeilen={[
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-berlin" titel="Polnische Betreuungskräfte in Berlin-Charlottenburg">
            <Text>Wer in Berlin-Charlottenburg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Berlin-Charlottenburg und im gesamten Umland im Einsatz.</Text>
