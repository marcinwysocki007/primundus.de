...
const AKTUALISIERT = aktualisiertAm('pflegegrad-aenderung-melden', '30. April 2026')
    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <h2 id="wann" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Wann melden?</h2>
          ...
          <h2 id="vorbereitung" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">Begutachtung vorbereiten</h2>
          ...
          <Weiterlesen aktuell="pflegegrad-aenderung-melden" />
          <ArticleCTA />
        </div>
      </div>
    </>
