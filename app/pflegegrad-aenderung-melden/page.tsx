      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          <nav className="h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-pm-ink">Pflegegrad-Änderung melden</span>
          </nav>
          <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">Ratgeber · 4 Min</p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">Pflegegrad-Änderung melden — Höherstufung beantragen</h1>

          <AuthorByline updated="30. April 2026" />
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">Wenn der Pflegebedarf steigt, sollte der Pflegegrad angepasst werden. Jedes Jahr ohne Antrag bedeutet entgangene Zuschüsse. Hier wie man vorgeht.</p>
          <h2 id="wann" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Wann melden?</h2>
          ...
          <h2 id="antrag" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Antrag stellen</h2>
          ...
          <h2 id="vorbereitung" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Begutachtung vorbereiten</h2>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Wann sollte ich eine Höherstufung beantragen?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Sobald der Pflegebedarf spürbar gestiegen ist — nach Sturz, nach Krankenhausaufenthalt, bei fortschreitender Demenz. Lieber zu früh als zu spät beantragen.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Wie beantrage ich eine Höherstufung?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Schriftlicher Antrag bei der Pflegekasse mit Begründung. Anschließend erneute Begutachtung durch den MD.</p></div>
            </details>
          </div>
          <ArticleCTA />
        </div>
