        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Bad Vilbel 2026">
            <Tabelle
              ...
              betont={1}
              fuss="Pflegeheim in Hessen: Eigenanteil rund 3.230 €/Monat (vdek, 07/2026) — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause"
            />
            <Tabelle
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-bad-vilbel', text: 'Preis und Betreuungskräfte für Bad Vilbel ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-bad" titel="Polnische Betreuungskräfte in Bad Vilbel">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> zwischen 2.200 und 3.500 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbetrag und Entlastungsbudget in Hessen meist rund 1200 bis 2300 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der hier im Schnitt rund 3.230 Euro im Monat kostet.</Text>
