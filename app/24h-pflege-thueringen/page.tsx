...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Thüringen | 6× Testsieger | Primundus',
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Thüringen in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Thüringen', item: 'https://primundus.de/24h-pflege-thueringen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Thüringen"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Thüringen" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Thüringen" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Thüringen 2026">
            <Tabelle
              ...
              betont={1}
              fuss="Eine Person, Pflegegrad 3, Werte aus unserem Kostenrechner · Pflegeheim Thüringen: Eigenanteil Ø 2000–2500 €/Monat — was bei Ihnen bleibt, zeigt der Kostenrechner in 2 Minuten"
            />
            <Tabelle
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-thueringen" titel="Polnische Betreuungskräfte in Thüringen">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet,</strong> hängt von der Pflegesituation und den Deutschkenntnissen ab — Ihren Preis zeigt der Kostenrechner in 2 Minuten. Pflegegeld und Entlastungsbudget zahlen bei Pflegegrad 3 zusammen bis zu ca. 894 Euro im Monat, dazu kommen bis zu 333 Euro Steuerermäßigung; ein Heimplatz kostet in Thüringen im ersten Jahr im Schnitt rund 3.000 Euro Eigenanteil.</Text>
