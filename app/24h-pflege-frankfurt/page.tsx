...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Frankfurt am Main', item: 'https://primundus.de/24h-pflege-frankfurt' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Frankfurt am Main"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Frankfurt am Main" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Frankfurt" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-frankfurt" titel="Polnische Betreuungskräfte in Frankfurt">
            <Text>Wer in Frankfurt nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Frankfurt und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge slug="frankfurt" ort={'Frankfurt'} land={'Hessen'} altbau={64.1} miete={10.58} />
