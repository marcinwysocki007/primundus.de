...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Neumarkt i.d.OPf.',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Neumarkt i.d.OPf. bei Ihnen ein. Sie wählen sie vorher selbst aus.',
