      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Neumarkt in der Oberpfalz</span>
          </nav>
          ...
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Neumarkt in der Oberpfalz</p>
            </div>
          ...
          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Neumarkt i.d.OPf.</h2>
          ...
          {/* ⑤ EINZUGSGEBIET */}
          {/* ⑤ KREIS-H2 */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">24-Stunden-Pflege im Landkreis Neumarkt in der Oberpfalz</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">Unsere Betreuungskräfte ziehen in Neumarkt i.d.OPf. und im Landkreis Neumarkt in der Oberpfalz ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</p>
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Neumarkt in der Oberpfalz</p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-[24px] md:text-[28px] font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Neumarkt in der Oberpfalz</h2>
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-neumarkt" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
              Betreuung anfragen
            </a>
          </div>
