...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte polnische Pflegekräfte und Preis direkt online sehen. Anreise in Neumarkt in der Oberpfalz in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Neumarkt in der Oberpfalz', item: 'https://primundus.de/24h-pflege-neumarkt' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Neumarkt i.d.OPf." />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-neumarkt" titel="Polnische Betreuungskräfte in Neumarkt i.d.OPf.">
            <Text>Wer in Neumarkt i.d.OPf. nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Neumarkt i.d.OPf. und im gesamten Umland im Einsatz.</Text>
