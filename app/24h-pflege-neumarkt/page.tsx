...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Neumarkt i.d.OPf. & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Neumarkt i.d.OPf.: Eigenanteil ab ca. 1100 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
