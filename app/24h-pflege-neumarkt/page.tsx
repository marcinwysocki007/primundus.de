...
export const metadata: Metadata = {
  ...
  description: 'In Neumarkt i.d.OPf. zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
