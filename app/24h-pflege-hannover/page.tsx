...
const SECTIONS = [
  ...
  { id: 'stimmen-vor-ort', title: "Familien aus Hannover über uns" },
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Hannover', item: 'https://primundus.de/24h-pflege-hannover' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Hannover"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-hannover', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Hannover" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Hannover" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-hannover" titel="Polnische Betreuungskräfte in Hannover">
            <Text>Wer in Hannover nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Hannover und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge slug="hannover" ort={'Hannover'} land={'Niedersachsen'} altbau={67.9} miete={7.61} />
