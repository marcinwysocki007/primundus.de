...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Hannover: Preis und Kräfte sofort sehen',
  description: 'In Hannover zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Garbsen und Langenhagen. Keine Vermittlungsgebühr, täglich kündbar.',
