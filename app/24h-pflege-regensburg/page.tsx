...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Regensburg: Preis sofort sehen',
  description: '24-Stunden-Pflege in Regensburg: Preis und passende Betreuungskräfte in 2 Minuten sehen — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
