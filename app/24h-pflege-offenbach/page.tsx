...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte polnische Pflegekräfte und Preis direkt online sehen. Anreise in Offenbach am Main in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Offenbach am Main', item: 'https://primundus.de/24h-pflege-offenbach' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Offenbach" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-offenbach" titel="Polnische Betreuungskräfte in Offenbach">
            <Text>Wer in Offenbach nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Offenbach und im gesamten Umland im Einsatz.</Text>
