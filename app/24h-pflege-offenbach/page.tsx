...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Offenbach bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Offenbach am Main 2026" },
  { id: 'polnische-betreuungskraefte-in-offenbach', title: "Polnische Betreuungskräfte in Offenbach" },
  ...
  { id: 'werkzeuge', title: "Was es in Offenbach kostet, und was die Pflegekasse dazugibt" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Offenbach ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung in den eigenen vier Wänden statt Heimplatz: Eine Betreuungskraft zieht in Offenbach ein und entlastet die Familie. Ab 2.150 €, täglich kündbar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-offenbach#service',
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Offenbach am Main?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Offenbach am Main starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Offenbach am Main rechtssicher?',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Offenbach am Main?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Hessen (Eigenanteil rund 3.230 €/Monat, vdek 07/2026).' },
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Offenbach am Main starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Offenbach am Main"
          ...
          blickTitel="Offenbach am Main auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Offenbach bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Offenbach bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Offenbach am Main 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Offenbach am Main"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-offenbach" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-offenbach" titel="Polnische Betreuungskräfte in Offenbach">
            <Text>Wer in Offenbach nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Offenbach und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Offenbach">
            <Text>Unsere Betreuungskräfte ziehen in Offenbach und im Landkreis Offenbach ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Offenbach ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-offenbach-am-main" titel="Einzugsgebiet Offenbach am Main">
            <Text>Offenbach und Landkreis Offenbach: Dreieich, Neu-Isenburg, Mühlheim, Seligenstadt, Langen und alle Gemeinden im Landkreis Offenbach</Text>
            <NearbyCities current="offenbach" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Offenbach'} land={'Hessen'} altbau={60.5} miete={8.76} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Offenbach am Main">
