...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Wolfratshausen | Primundus',
  description: '24-Stunden-Pflege in Wolfratshausen: Eigenanteil ab ca. 1100 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
...
const schemaMarkup = [
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Wolfratshausen?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Wolfratshausen starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Wolfratshausen rechtssicher?',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Wolfratshausen?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1100–2100 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-wolfratshausen', text: 'Preis und Betreuungskräfte für Wolfratshausen ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-wolfratshausen" titel="Polnische Betreuungskräfte in Wolfratshausen">
            <Text>Wer in Wolfratshausen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Wolfratshausen und im gesamten Umland im Einsatz.</Text>
