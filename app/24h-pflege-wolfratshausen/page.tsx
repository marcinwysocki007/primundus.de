      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Wolfratshausen · Aktualisiert August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Wolfratshausen
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Die alte Flößerstadt an Loisach und Isar — Waldram, Farchet oder die Altstadt — ist für viele seit Jahrzehnten Zuhause. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist Tag und Nacht da. Täglich kündbar, rechtssicher, startklar in 4–7 Tagen.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 2.398 Menschen in Wolfratshausen sind 75 Jahre oder älter, und der Ort zählt 9.546 Wohnungen in 4.141 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
