...
// Seit 23.09.2026 traegt diese Datei nur noch, was in Wolfratshausen anders ist; der feste Text steht
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Wolfratshausen starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung.' },
...
const ORT: OrtDaten = {
  ...
  einzugsgebiet: 'Wolfratshausen und südlicher Landkreis Bad Tölz-Wolfratshausen: Geretsried, Icking, Münsing, Egling und alle Gemeinden im südlichen Landkreis Bad Tölz-Wolfratshausen',
