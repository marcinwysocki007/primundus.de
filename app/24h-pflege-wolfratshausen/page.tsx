    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Wolfratshausen"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Wolfratshausen" />}
          blick={[
