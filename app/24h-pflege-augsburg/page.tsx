...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Augsburg', item: 'https://primundus.de/24h-pflege-augsburg' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Augsburg"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Augsburg" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Augsburg" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-augsburg" titel="Polnische Betreuungskräfte in Augsburg">
            <Text>Wer in Augsburg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Augsburg und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge slug="augsburg" ort={'Augsburg'} land={'Bayern'} altbau={51.1} miete={8.48} />
