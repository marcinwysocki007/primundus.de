...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bruchsal ab 2.150 € im Monat',
  description: 'Zu Hause bleiben statt ins Pflegeheim: In Bruchsal zieht eine Betreuungskraft ein, hilft im Alltag und ist bei Bedarf auch nachts da. Ab 2.150 € im Monat.',
