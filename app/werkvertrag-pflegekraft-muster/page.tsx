    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <h2 id="scheinselbstaendigkeit" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Scheinselbstständigkeit</h2>
          ...
          <h2 id="alternativen" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Rechtssichere Alternativen</h2>
