...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Konstanz bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Konstanz 2026" },
  { id: 'polnische-betreuungskraefte-in-konstanz', title: "Polnische Betreuungskräfte in Konstanz" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Bodenseeraum" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Konstanz ausmacht" },
  { id: 'einzugsgebiet-konstanz', title: "Einzugsgebiet Konstanz" },
  { id: 'werkzeuge', title: "Was es für Ihre Eltern in Konstanz kostet" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Konstanz" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Konstanz: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Konstanz: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Konstanz?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Baden-Württemberg (Eigenanteil rund 3.660 €/Monat, vdek 07/2026).' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Konstanz"
          titel="24-Stunden-Pflege und Betreuung in Konstanz"
          einleitung={<>Petershausen, Allmannsdorf oder Wollmatingen: Mit dem Bodensee vor der Tür wird man in Konstanz gern alt — im eigenen Zuhause, nicht hinter Heimtüren. Eine Betreuungskraft von Primundus zieht mit ein und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Konstanz auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Konstanz bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Konstanz bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Konstanz 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Konstanz"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-konstanz" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-konstanz" titel="Polnische Betreuungskräfte in Konstanz">
            <Text>Wer in Konstanz nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Konstanz und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Bodenseeraum">
            <Text>Unsere Betreuungskräfte ziehen in Konstanz und im Bodenseeraum ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Konstanz ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-konstanz" titel="Einzugsgebiet Konstanz">
            <Text>Konstanz und Bodenseeraum: Singen, Radolfzell, Reichenau, Allensbach und alle Gemeinden im Landkreis Konstanz</Text>
            <NearbyCities current="konstanz" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Konstanz'} land={'Baden-Württemberg'} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Konstanz">
