...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Wiesbaden | Primundus',
  description: '24-Stunden-Pflege in Wiesbaden: Eigenanteil ab ca. 1200 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
  alternates: { canonical: 'https://primundus.de/24h-pflege-wiesbaden' },
  openGraph: {
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630 }],
    title: '24h-Pflege Wiesbaden — Betreuungskraft zuhause | Primundus',
    description: 'Geprüfte 24h-Betreuungskraft in Wiesbaden. Täglich kündbar, rechtssicher, startklar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'LocalBusiness',
    name: 'Primundus — 24h-Pflege Wiesbaden',
    description: '24h-Betreuungskräfte in Wiesbaden. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-wiesbaden',
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Wiesbaden', item: 'https://primundus.de/24h-pflege-wiesbaden' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Wiesbaden?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Wiesbaden starten?',
      ...
      {
        '@type': 'Question',
        name: 'Wie wohnt man in Wiesbaden — Haus oder Geschosswohnung?',
      ...
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Wiesbaden bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Wiesbaden und Umland: Mainz, Biebertal, Taunusstein, Idstein, Eltville und alle Gemeinden im Rheingau-Taunus-Kreis' },
      },
    ],
  },
]
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Wiesbaden</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Wiesbaden · Aktualisiert August 2026
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Wiesbaden 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Wiesbaden</p>
            </div>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-wiesbaden" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Wiesbaden ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Wiesbaden</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Wiesbaden nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Wiesbaden und im gesamten Umland im Einsatz.
          </p>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Wiesbaden</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Wiesbaden und Umland: Mainz, Biebertal, Taunusstein, Idstein, Eltville und alle Gemeinden im Rheingau-Taunus-Kreis</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Wiesbaden ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Ob jemand zur Miete oder im Eigentum wohnt, ändert in Wiesbaden die Möglichkeiten. Nur 27,3 Prozent der Haushalte wohnen im Eigentum — in Hessen sind es 46,6 Prozent. Der Umzug in etwas Größeres ist damit für die meisten keine realistische Option. Auf ein Gebäude kommen in Wiesbaden im Schnitt 3,8 Wohnungen, in Hessen sind es 2,2. Hier wird also dichter gebaut — mehr Geschosswohnungen, weniger Haus mit Garten.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Nur 42,7 Prozent der Gebäude stehen frei, in Hessen sind es 69,9 Prozent. 36,7 Prozent der Gebäude in Wiesbaden sind Reihenhäuser, in Hessen 15,0 Prozent. Schmaler Grundriss, steile Treppe, Schlafzimmer und Bad oben — das ist der Alltag, um den es geht.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Die durchschnittliche Wohnung misst 82,9 Quadratmeter gegenüber 98,3 in Hessen — rund 15 Quadratmeter weniger. 30,1 Prozent der Wohnungen in Wiesbaden haben weniger als 60 Quadratmeter, in Hessen sind es 20,4 Prozent. Ein eigenes Zimmer für die Betreuungskraft ist hier also die Frage, die vorab geklärt gehört. 29,5 Prozent der Wohnungen stammen aus der Zeit vor 1950, in Hessen 20,4 Prozent — schöner Altbau, aber mit Treppenhäusern, die für einen Rollator nie gedacht waren.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 29.170 Menschen in Wiesbaden sind 75 Jahre oder älter, und es gibt 150.388 Wohnungen in 40.114 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Wiesbaden</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Wiesbaden?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1200–2300 €/Monat — deutlich günstiger als ein Heimplatz in Hessen (Eigenanteil rund 3.230 €/Monat, vdek 07/2026).' },
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Wiesbaden starten?', a: 'In der Regel in 4–7 Tagen. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
              { q: 'Was ist der Unterschied zu einem ambulanten Pflegedienst?', a: 'Ein ambulanter Dienst kommt 1–3 Mal täglich und geht wieder. Eine 24h-Betreuungskraft lebt im Haushalt — ist nachts da, führt den gesamten Haushalt und bietet bei Demenz oder hohem Pflegebedarf die einzige wirklich durchgehende Lösung.' },
              { q: 'Ist 24h-Pflege über Primundus in Wiesbaden rechtssicher?', a: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Wiesbaden?', a: 'Das hängt am Grundriss, und die Ausgangslage in Wiesbaden ist bekannt: Die durchschnittliche Wohnung misst 82,9 Quadratmeter, 30,1 Prozent liegen unter 60 Quadratmetern (Hessen: 20,4 Prozent), und 27,3 Prozent der Haushalte wohnen im Eigentum (Hessen: 46,6 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-wiesbaden" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Wiesbaden die richtige Lösung?"
