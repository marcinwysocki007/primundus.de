...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Wiesbaden: zu Hause bleiben statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-wiesbaden" titel="Polnische Betreuungskräfte in Wiesbaden">
            <Text>Wer in Wiesbaden nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Wiesbaden und im gesamten Umland im Einsatz.</Text>
