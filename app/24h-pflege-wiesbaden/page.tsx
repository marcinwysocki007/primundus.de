...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Wiesbaden bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Wiesbaden 2026" },
  ...
  { id: 'stimmen-vor-ort', title: "Familien aus Wiesbaden über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Wiesbaden" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Wiesbaden ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung in den eigenen vier Wänden statt Heimplatz: Eine Betreuungskraft zieht in Wiesbaden ein und entlastet die Familie. Ab 2.150 €, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Wiesbaden?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Hessen (Eigenanteil rund 3.230 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Wiesbaden Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Wiesbaden hat im Schnitt 82,9 m², 30,1 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 61,4 % der Wohnungen in Wiesbaden liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Wiesbaden"
          titel="24-Stunden-Pflege und Betreuung in Wiesbaden"
          einleitung={<>Die Altbauwohnung im Dichterviertel, das Haus in Sonnenberg oder Bierstadt: Wiesbadener geben ihre Kurstadt nicht her — schon gar nicht fürs Heim. Eine Betreuungskraft von Primundus zieht mit ein und ist bei Bedarf auch nachts da, damit das Zuhause Zuhause bleibt. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Wiesbaden auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Wiesbaden bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Wiesbaden bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Wiesbaden 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Wiesbaden"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-wiesbaden" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-wiesbaden" titel="Polnische Betreuungskräfte in Wiesbaden">
            <Text>Wer in Wiesbaden nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Wiesbaden und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Wiesbaden ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-wiesbaden" titel="Einzugsgebiet Wiesbaden">
            <Text>Wiesbaden und Umland: Mainz, Biebertal, Taunusstein, Idstein, Eltville und alle Gemeinden im Rheingau-Taunus-Kreis</Text>
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20260503-renate', 'k-20241030-gerd'].includes(b.id))}

          />


          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Wiesbaden">
