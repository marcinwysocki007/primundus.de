      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Garmisch-Partenkirchen · Aktualisiert August 2026
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wie viel Platz eine Wohnung in Garmisch-Partenkirchen hat, ist keine Nebenfrage. Die durchschnittliche Wohnung misst 80,2 Quadratmeter gegenüber 100,5 in Bayern — rund 20 Quadratmeter weniger. Garmisch-Partenkirchen ist älter als das Land: 15,0 Prozent der Einwohner sind 75 Jahre oder älter — das sind 4.218 Menschen, in Bayern sind es 10,4 Prozent.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In 30,4 Prozent der Haushalte leben ausschließlich Menschen ab 65 — in Bayern sind es 23,0 Prozent. Dort ist niemand im Haus, der nachts einspringen könnte. Nur 34,5 Prozent der Haushalte wohnen im Eigentum — in Bayern sind es 49,3 Prozent. Der Umzug in etwas Größeres ist damit für die meisten keine realistische Option.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            32,4 Prozent der Wohnungen in Garmisch-Partenkirchen haben weniger als 60 Quadratmeter, in Bayern sind es 20,7 Prozent. Ein eigenes Zimmer für die Betreuungskraft ist hier also die Frage, die vorab geklärt gehört. Auf ein Gebäude kommen in Garmisch-Partenkirchen im Schnitt 3,2 Wohnungen, in Bayern sind es 2,1. Garmisch-Partenkirchen ist also deutlich städtischer gebaut, als der Landesdurchschnitt vermuten lässt — mehr Geschosswohnungen, weniger Haus mit Garten. 50,8 Prozent aller Haushalte in Garmisch-Partenkirchen bestehen aus einer einzigen Person, in Bayern sind es 41,9 Prozent. Alleinlebend heißt im Pflegefall: Es ist niemand da, der es mitbekommt.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 4.218 Menschen in Garmisch-Partenkirchen sind 75 Jahre oder älter, und der Ort zählt 17.235 Wohnungen in 5.410 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          <div className="space-y-3 mb-12">
              ...
              { q: 'Was kostet eine 24h-Pflegekraft in Garmisch-Partenkirchen?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1100–2200 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
            {
              ...
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Garmisch-Partenkirchen starten?', a: 'In der Regel in 4–7 Tagen. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
