...
export const metadata: Metadata = {
  ...
  description: '24-Stunden-Pflege in Garmisch-Partenkirchen: ab 2.150 € im Monat, bei Pflegegrad 3 ab ca. 923 € Eigenanteil. Kräfte vorher ansehen, täglich kündbar.',
