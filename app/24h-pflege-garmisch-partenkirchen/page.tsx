...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte polnische Pflegekräfte und Preis direkt online sehen. Anreise in Garmisch-Partenkirchen in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Garmisch-Partenkirchen', item: 'https://primundus.de/24h-pflege-garmisch-partenkirchen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Garmisch-Partenkirchen" />}
        />
