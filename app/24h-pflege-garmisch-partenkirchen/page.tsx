...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Garmisch-Partenkirchen bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Garmisch-Partenkirchen 2026" },
  { id: 'polnische-betreuungskraefte-in-garmisch', title: "Polnische Betreuungskräfte in Garmisch-Partenkirchen" },
  ...
  { id: 'werkzeuge', title: "Was es in Garmisch-Partenkirchen kostet, und was die Pflegekasse dazugibt" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Garmisch-Partenkirchen ab 2.150 €',
  description: '1:1-Betreuung zu Hause statt Heim: Betreuungskraft zieht in Garmisch-Partenkirchen ein, entlastet die Familie. Ab 2.150 €, Bestpreisgarantie, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Garmisch-Partenkirchen?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Garmisch-Partenkirchen"
          titel="24-Stunden-Pflege und Betreuung in Garmisch-Partenkirchen"
          einleitung={<>Ob auf der Garmischer oder der Partenkirchner Seite, mit der Zugspitze im Blick: Wer hier zuhause ist, bleibt. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist bei Bedarf auch nachts da — im ganzen Werdenfelser Land. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Garmisch-Partenkirchen auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Garmisch-Partenkirchen bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Garmisch-Partenkirchen bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Garmisch-Partenkirchen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Garmisch-Partenkirchen"
              zeilen={[
            ...
            <RechnerKasten src="ort-garmisch-partenkirchen" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-garmisch" titel="Polnische Betreuungskräfte in Garmisch-Partenkirchen">
            <Text>Wer in Garmisch-Partenkirchen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Garmisch-Partenkirchen und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Garmisch-Partenkirchen">
            <Text>Unsere Betreuungskräfte ziehen in Garmisch-Partenkirchen und im Landkreis Garmisch-Partenkirchen ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Garmisch-Partenkirchen ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-garmisch-partenkirchen" titel="Einzugsgebiet Garmisch-Partenkirchen">
            <Text>Garmisch-Partenkirchen und Landkreis Garmisch-Partenkirchen: Mittenwald, Murnau, Oberammergau, Werdenfels und alle Gemeinden im Landkreis Garmisch-Partenkirchen</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Garmisch-Partenkirchen">
