...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Köln: Preis und Kräfte sofort sehen',
  description: '24-Stunden-Pflege in Köln: Ihren Preis und die passenden Betreuungskräfte sehen Sie in 2 Minuten — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
