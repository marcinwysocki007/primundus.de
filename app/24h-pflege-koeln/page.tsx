...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Köln bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Köln 2026" },
  ...
  { id: 'werkzeuge', title: "Was es in Köln kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Köln über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Köln" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Köln: Kräfte ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Köln bei Ihnen ein. Foto, Erfahrung und Deutsch sehen Sie vorher.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Köln?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Köln Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Köln hat im Schnitt 77,6 m², 34,9 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 58,0 % der Wohnungen in Köln liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Köln"
          titel="24-Stunden-Pflege und Betreuung in Köln"
          ...
          blickTitel="Köln auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Köln bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Köln bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Köln 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Köln"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-koeln" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-koeln" titel="Polnische Betreuungskräfte in Köln">
            <Text>Wer in Köln nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Köln und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Köln ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-koeln" titel="Einzugsgebiet Köln">
            <Text>Alle Kölner Stadtbezirke sowie Leverkusen, Bonn, Bergisch Gladbach, Frechen, Pulheim, Brühl, Kerpen und weiterer Großraum Köln/Bonn</Text>
            <NearbyCities current="koeln" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Köln'} land={'Nordrhein-Westfalen'} altbau={58.0} miete={9.39} />
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20260905-thomas', 'k-20260427-andreas', 'k-20260109-petra', 'k-20241118-bjorn'].includes(b.id))}

          />


          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Köln">
