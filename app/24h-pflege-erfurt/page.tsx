...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Was es in Erfurt kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Erfurt über uns" },
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Erfurt', item: 'https://primundus.de/24h-pflege-erfurt' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Erfurt"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-erfurt', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Erfurt" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Erfurt" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-erfurt" titel="Polnische Betreuungskräfte in Erfurt">
            <Text>Wer in Erfurt nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Erfurt und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge slug="erfurt" ort={'Erfurt'} land={'Thüringen'} altbau={49.1} miete={6.48} />
