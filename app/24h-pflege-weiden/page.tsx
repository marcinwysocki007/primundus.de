...
export const metadata: Metadata = {
  ...
  description: '1:1-Betreuung zu Hause statt Heim: Betreuungskraft zieht in Weiden i.d. Oberpfalz ein, entlastet die Familie. Ab 2.150 €, Bestpreisgarantie, täglich kündbar.',
