...
export const metadata: Metadata = {
  ...
  description: 'In Weiden i.d. Oberpfalz zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
