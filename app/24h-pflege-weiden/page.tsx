...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Weiden i.d. Oberpfalz & Umgebung',
  description: '24-Stunden-Pflege in Weiden i.d. Oberpfalz: Eigenanteil ab ca. 1100 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
