      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Pflegegrad nach Schlaganfall</span>
          </nav>
          ...
          <div className="bg-pm-coral-tint border border-[rgba(231,111,99,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[14px] font-bold text-pm-coral-ink mb-2">Wichtig: Antrag sofort stellen</p>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={folge} className={i % 2 === 0 ? 'bg-white' : 'bg-pm-paper'}>
                      <td className="px-4 py-3 text-[13px] text-pm-body border-b border-pm-line">{folge}</td>
                      <td className="px-4 py-3 text-[14px] font-semibold text-pm-ink border-b border-pm-line">{pg}</td>
                      <td className={`px-4 py-3 text-[14px] font-bold border-b border-pm-line ${pgeld === '—' ? 'text-[#C8C3BA]' : 'text-pm-green'}`}>{pgeld}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <p className="text-[15px] text-pm-body mb-10">
            ...
            <a href="/pflegegrad-begutachtung-vorbereiten" className="text-pm-taupe underline hover:text-pm-taupe-deep">MD-Begutachtung vorbereiten — 7 Tipps</a>
          </p>
          ...
          <h2 id="rehabilitation" className="text-h2 md:text-h2-lg font-bold text-pm-ink mt-10 mb-4 leading-snug">
          ...
          <p className="text-[15px] text-pm-body mb-10">
            ...
            <a href="/schlaganfall-pflege-zuhause" className="text-pm-taupe underline hover:text-pm-taupe-deep">Schlaganfall Pflege zuhause</a>
          </p>
          ...
          <Weiterlesen aktuell="pflegegrad-nach-schlaganfall" />
          <ArticleCTA />
        </div>
      </div>
    </>
