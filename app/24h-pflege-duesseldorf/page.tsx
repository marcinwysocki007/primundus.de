...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Düsseldorf: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Düsseldorf: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <OrtWerkzeuge ort={'Düsseldorf'} land={'Nordrhein-Westfalen'} />
