...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Was es in Cottbus kostet, und was die Pflegekasse dazugibt" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Cottbus: erst ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Cottbus bei Ihnen ein. Sie wählen sie vorher selbst aus.',
