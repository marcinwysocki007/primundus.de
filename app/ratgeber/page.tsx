          ...
          <Abschnitt id="themen" titel="Alle Themen">
            <Gruppen
              gruppen={[
                ...
                { title: l('/krankheiten', 'Pflege bei Krankheiten'), zusatz: 'Demenz, Alzheimer, Parkinson, Schlaganfall & mehr', punkte: [l('/demenz-pflege-zuhause', 'Demenz'), l('/parkinson-pflege-zuhause', 'Parkinson'), l('/krankheiten', 'Alle Artikel zum Thema')] },
