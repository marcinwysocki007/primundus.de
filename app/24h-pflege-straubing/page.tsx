...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Straubing | Primundus',
  description: '24-Stunden-Pflege in Straubing: Eigenanteil ab ca. 1100 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
  alternates: { canonical: 'https://primundus.de/24h-pflege-straubing' },
  openGraph: {
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630 }],
    title: '24h-Pflege Straubing — Betreuungskraft zuhause | Primundus',
    description: 'Geprüfte 24h-Betreuungskraft in Straubing. Täglich kündbar, rechtssicher, startklar.',
    url: 'https://primundus.de/24h-pflege-straubing',
    siteName: 'Primundus',
    locale: 'de_DE',
    type: 'website',
  },
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-straubing#service',
    name: 'Primundus — 24h-Pflege Straubing',
    serviceType: '24-Stunden-Betreuung zu Hause',
    description: '24h-Betreuungskräfte in Straubing. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-straubing',
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Straubing', item: 'https://primundus.de/24h-pflege-straubing' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Straubing?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Straubing starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Straubing rechtssicher?',
        acceptedAnswer: { '@type': 'Answer', text: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Straubing?',
        acceptedAnswer: { '@type': 'Answer', text: 'Das hängt am Grundriss, und die Ausgangslage in Straubing ist bekannt: Die durchschnittliche Wohnung misst 89,4 Quadratmeter, 27,5 Prozent liegen unter 60 Quadratmetern (Bayern: 20,7 Prozent), und 33,5 Prozent der Haushalte wohnen im Eigentum (Bayern: 49,3 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
      },
      {
        '@type': 'Question',
        name: 'Wie viele ältere Menschen leben in Straubing?',
        acceptedAnswer: { '@type': 'Answer', text: '5.013 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 10,9 Prozent — in Bayern 10,4 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 24,2 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Bayern: 23,0 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
      },
      {
        '@type': 'Question',
        name: 'Wie wohnt man in Straubing — Haus oder Geschosswohnung?',
        acceptedAnswer: { '@type': 'Answer', text: 'Auf ein Gebäude kommen in Straubing im Schnitt 2,4 Wohnungen, in Bayern 2,1. 53,9 Prozent der Gebäude stehen frei, 22,4 Prozent sind Reihenhäuser. 44,1 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Straubing ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Straubing?',
      ...
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Straubing bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Straubing und Straubing-Bogen: Bogen, Mallersdorf-Pfaffenberg, Geiselhöring und alle Gemeinden im Landkreis Straubing-Bogen' },
      },
    ],
  },
]

export default function StraubingPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Straubing</span>
          </nav>

          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Straubing · Aktualisiert am 28. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Straubing
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Im Herzen des Gäubodens — in Ittling, Alburg oder stadtnah an der Donau — hält man an Haus und Hof fest. Eine Betreuungskraft von Primundus sorgt dafür, dass das auch mit Pflegebedarf so bleibt: Sie zieht mit ein und ist Tag und Nacht da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Straubing 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Straubing</p>
            </div>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-straubing" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Straubing ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Straubing</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Straubing nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Straubing und im gesamten Umland im Einsatz.
          </p>
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Straubing</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Straubing und Straubing-Bogen: Bogen, Mallersdorf-Pfaffenberg, Geiselhöring und alle Gemeinden im Landkreis Straubing-Bogen</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Straubing ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Straubing wohnen nur 33,5 Prozent der Haushalte im Eigentum, in Bayern 49,3 Prozent. In eine größere Wohnung zu ziehen ist für die meisten keine Option — es muss also in der vorhandenen gehen. Die Nettokaltmiete liegt bei 6,64 Euro je Quadratmeter, in Bayern bei 8,74 Euro. Wo ein Zimmer fehlt, ist etwas Größeres hier eher erreichbar als anderswo.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Die durchschnittliche Wohnung misst 89,4 Quadratmeter gegenüber 100,5 in Bayern — rund 11 Quadratmeter weniger. 49,9 Prozent aller Haushalte in Straubing bestehen aus einer einzigen Person, in Bayern sind es 41,9 Prozent. Alleinlebend heißt im Pflegefall: Es ist niemand da, der es mitbekommt.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Eine Betreuungskraft braucht ein eigenes Zimmer, und genau daran hakt es in Straubing häufiger als anderswo. Gut jede vierte Wohnung ist kleiner als 60 Quadratmeter — in Bayern sind es 20,7 Prozent. Deshalb klären wir vorab am Telefon, was Ihre Wohnung hergibt, statt es später herauszufinden. Nur 53,9 Prozent der Gebäude stehen frei, in Bayern sind es 67,3 Prozent.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 5.013 Menschen in Straubing sind 75 Jahre oder älter, und es gibt 25.395 Wohnungen in 10.812 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Straubing</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Straubing?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1100–2200 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
            {
              ...
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Straubing starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
              { q: 'Was ist der Unterschied zu einem ambulanten Pflegedienst?', a: 'Ein ambulanter Dienst kommt 1–3 Mal täglich und geht wieder. Eine 24h-Betreuungskraft lebt im Haushalt — ist nachts da, führt den gesamten Haushalt und bietet bei Demenz oder hohem Pflegebedarf die einzige wirklich durchgehende Lösung.' },
              { q: 'Ist 24h-Pflege über Primundus in Straubing rechtssicher?', a: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Straubing?', a: 'Das hängt am Grundriss, und die Ausgangslage in Straubing ist bekannt: Die durchschnittliche Wohnung misst 89,4 Quadratmeter, 27,5 Prozent liegen unter 60 Quadratmetern (Bayern: 20,7 Prozent), und 33,5 Prozent der Haushalte wohnen im Eigentum (Bayern: 49,3 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Straubing?', a: '5.013 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 10,9 Prozent — in Bayern 10,4 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 24,2 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Bayern: 23,0 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Straubing — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Straubing im Schnitt 2,4 Wohnungen, in Bayern 2,1. 53,9 Prozent der Gebäude stehen frei, 22,4 Prozent sind Reihenhäuser. 44,1 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Straubing ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Straubing?', a: 'Das hängt am Grundriss, und die Ausgangslage in Straubing ist bekannt: Die durchschnittliche Wohnung misst 89,4 Quadratmeter, 27,5 Prozent liegen unter 60 Quadratmetern (Bayern: 20,7 Prozent), und 33,5 Prozent der Haushalte wohnen im Eigentum (Bayern: 49,3 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Straubing?', a: '5.013 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 10,9 Prozent — in Bayern 10,4 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 24,2 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Bayern: 23,0 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Straubing — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Straubing im Schnitt 2,4 Wohnungen, in Bayern 2,1. 53,9 Prozent der Gebäude stehen frei, 22,4 Prozent sind Reihenhäuser. 44,1 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Straubing ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Straubing?', a: 'Das hängt am Grundriss, und die Ausgangslage in Straubing ist bekannt: Die durchschnittliche Wohnung misst 89,4 Quadratmeter, 27,5 Prozent liegen unter 60 Quadratmetern (Bayern: 20,7 Prozent), und 33,5 Prozent der Haushalte wohnen im Eigentum (Bayern: 49,3 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Straubing?', a: '5.013 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 10,9 Prozent — in Bayern 10,4 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 24,2 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Bayern: 23,0 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Straubing — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Straubing im Schnitt 2,4 Wohnungen, in Bayern 2,1. 53,9 Prozent der Gebäude stehen frei, 22,4 Prozent sind Reihenhäuser. 44,1 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Straubing ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Welches Einzugsgebiet wird in Straubing bedient?', a: 'Straubing und Straubing-Bogen: Bogen, Mallersdorf-Pfaffenberg, Geiselhöring und alle Gemeinden im Landkreis Straubing-Bogen' },
            ].map((item, i) => (
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-straubing" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
              Betreuung anfragen
            </a>
          </div>
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Straubing die richtige Lösung?"
