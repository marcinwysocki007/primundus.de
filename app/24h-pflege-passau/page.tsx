...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Passau: zu Hause bleiben statt Heim',
...
const schemaMarkup = [
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Passau?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Passau starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Passau rechtssicher?',
