...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Leipzig & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Leipzig: Eigenanteil ab ca. 1400 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
