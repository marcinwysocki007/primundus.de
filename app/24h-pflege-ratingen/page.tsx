...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Ratingen: zu Hause bleiben statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-ratingen" titel="Polnische Betreuungskräfte in Ratingen">
            <Text>Wer in Ratingen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Ratingen und im gesamten Umland im Einsatz.</Text>
