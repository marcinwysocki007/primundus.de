...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Ratingen bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Ratingen 2026" },
  { id: 'polnische-betreuungskraefte-in-ratingen', title: "Polnische Betreuungskräfte in Ratingen" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im nördlichen Kreis Mettmann" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Ratingen ausmacht" },
  { id: 'einzugsgebiet-ratingen', title: "Einzugsgebiet Ratingen" },
  { id: 'werkzeuge', title: "Was es für Ihre Eltern in Ratingen kostet" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Ratingen" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Ratingen: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Ratingen: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
  alternates: { canonical: 'https://primundus.de/24h-pflege-ratingen' },
  openGraph: {
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630 }],
    title: '24h-Pflege Ratingen — Betreuungskraft zuhause | Primundus',
    description: 'Geprüfte 24h-Betreuungskraft in Ratingen. Täglich kündbar, rechtssicher, startklar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-ratingen#service',
    name: 'Primundus — 24h-Pflege Ratingen',
    serviceType: '24-Stunden-Betreuung zu Hause',
    description: '24h-Betreuungskräfte in Ratingen. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-ratingen',
    provider: { '@id': 'https://primundus.de/#organization' },
    areaServed: { '@type': 'City', name: 'Ratingen' },
    },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Ratingen', item: 'https://primundus.de/24h-pflege-ratingen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Ratingen starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Ratingen rechtssicher?',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Ratingen?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Ratingen starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
  ...
  { q: 'Ist in einer Wohnung in Ratingen Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Ratingen hat im Schnitt 95,1 m², 17,6 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 77,5 % der Wohnungen in Ratingen liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Ratingen"
          titel="24-Stunden-Pflege und Betreuung in Ratingen"
          einleitung={<>Lintorf, Hösel oder Ratingen-West: Wer hier wohnt, hat oft in Düsseldorf gearbeitet und im Grünen gelebt — und will genau das behalten. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Ratingen auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Ratingen bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Ratingen bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Ratingen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Ratingen"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-ratingen" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-ratingen" titel="Polnische Betreuungskräfte in Ratingen">
            <Text>Wer in Ratingen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Ratingen und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im nördlichen Kreis Mettmann">
            <Text>Unsere Betreuungskräfte ziehen in Ratingen und im nördlichen Kreis Mettmann ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Ratingen ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-ratingen" titel="Einzugsgebiet Ratingen">
            <Text>Ratingen und nördlicher Kreis Mettmann: Erkrath, Mettmann, Heiligenhaus und alle Gemeinden im nördlichen Kreis Mettmann</Text>
            <NearbyCities current="ratingen" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Ratingen'} land={'Nordrhein-Westfalen'} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Ratingen">
