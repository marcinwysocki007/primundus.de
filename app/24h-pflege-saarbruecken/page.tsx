...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Rechnen Sie Ihren Fall für Saarbrücken durch" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Saarbrücken" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Saarbrücken: ab 2.150 € im Monat',
  description: '24-Stunden-Pflege in Saarbrücken: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Saarbrücken Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Saarbrücken hat im Schnitt 85,7 m², 28,9 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 69,7 % der Wohnungen in Saarbrücken liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
