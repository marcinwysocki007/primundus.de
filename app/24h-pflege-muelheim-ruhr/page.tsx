...
export const metadata: Metadata = {
  title: '24h-Pflege Mülheim an der Ruhr — Betreuungskraft zuhause',
  description: '24h-Pflege in Mülheim an der Ruhr: Geprüfte Betreuungskraft zuhause. Rechtssicher, täglich kündbar, startklar. Eigenanteil ab ca. 1200 €/Monat (PG 3).',
        ...
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
            ...
            <div className="bg-[#F8F7F5] border-t border-[#E5E3DF] px-5 py-3">
              <p className="text-[12px] text-[#8B8B8B]">Pflegeheim Mülheim an der Ruhr: Eigenanteil Ø 3.364 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
          ...
          <div className="space-y-3 mb-12">
            {[
              ...
              { q: 'Wie schnell kann eine Pflegekraft in Mülheim an der Ruhr starten?', a: 'In 4–7 Tagen nach dem ersten Beratungsgespräch. In dringenden Situationen oft schneller möglich.' },
