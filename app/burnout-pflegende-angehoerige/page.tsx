...
const schemaMarkup = [
  ...
  },
  {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Wie viele pflegende Angehörige leiden unter Burnout?', acceptedAnswer: { '@type': 'Answer', text: 'Etwa jede vierte pflegende Person fühlt sich hoch belastet und hat das Gefühl, die Pflege nicht mehr bewältigen zu können (Wissenschaftliches Institut der AOK, 2023). Besonders betroffen: Kinder die berufstätig sind und gleichzeitig Eltern pflegen.' } },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitung="Etwa jede vierte pflegende Person fühlt sich hoch belastet und hat das Gefühl, die Pflege nicht mehr bewältigen zu können (Wissenschaftliches Institut der AOK, 2023). Burnout entwickelt sich schleichend — und wer ihn nicht rechtzeitig erkennt, gefährdet am Ende die eigene Gesundheit und die Pflege des Angehörigen. Die wichtigste Botschaft: Entlastung zu suchen ist keine Schwäche, sondern Verantwortung."
          aktualisiert={AKTUALISIERT.sichtbar}
          lesezeit="7 Min."
          blick={[
                'Etwa jede vierte pflegende Person fühlt sich hoch belastet (WIdO 2023)',
