  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-14">

          {/* Breadcrumb */}
          <nav className="text-sm text-pm-mute mb-8 flex items-center gap-2 flex-wrap" aria-label="Breadcrumb">
                ...
                <table className="w-full min-w-[560px]">
                  <thead>
                    <tr className="bg-pm-paper">
                      ...
                      <th className="px-4 py-3 text-left text-[12px] font-bold text-[#3D3D3D] border-b border-pm-line w-[35%]">Pflegehelden</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="px-4 py-3 text-[13px] font-semibold text-[#3D3D3D] border-b border-pm-line-soft">Preis ab</td>
                      <td className="px-4 py-3 text-[13px] font-semibold text-[#3D3D3D] border-b border-pm-line-soft bg-[#FBF9F5]">{PRIMUNDUS.preisAb}</td>
                      <td className="px-4 py-3 text-[13px] text-[#5A5A5A] border-b border-pm-line-soft">{PH.preisAb}</td>
                    </tr>
                    {KRITERIEN.map((k) => {
                      ...
                      return (
                        <tr key={k.key}>
                          <td className="px-4 py-3 text-[13px] font-semibold text-[#3D3D3D] border-b border-pm-line-soft">{k.label}</td>
                          <td className="px-4 py-3 text-[12.5px] leading-snug text-[#3D3D3D] border-b border-pm-line-soft bg-[#FBF9F5]">
                            <span className={`font-bold mr-1 ${ICON[p.wertung].cls}`}>{ICON[p.wertung].sym}</span>{p.kurz}
                          </td>
                          <td className="px-4 py-3 text-[12.5px] leading-snug text-[#5A5A5A] border-b border-pm-line-soft">
                ...
                <ol className="space-y-2.5">
                  {[
                    ...
                    <li key={s} className="flex gap-2.5 text-[13px] text-[#5A5A5A] leading-relaxed">
                      <span className="w-5 h-5 rounded-full bg-pm-line text-[#5A5A5A] text-[11px] font-bold flex items-center justify-center flex-shrink-0 mt-0.5">{i + 1}</span>
                      {s}
                    </li>
                  ))}
                </ol>
