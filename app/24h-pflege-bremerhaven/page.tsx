...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Bremerhaven 2026" },
  { id: 'polnische-betreuungskraefte-in-bremerhaven', title: "Polnische Betreuungskräfte in Bremerhaven" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Cuxhaven" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Bremerhaven ausmacht" },
  { id: 'einzugsgebiet-bremerhaven', title: "Einzugsgebiet Bremerhaven" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Bremerhaven" },
]
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Bremerhaven"
          titel="24-Stunden-Pflege und Betreuung in Bremerhaven"
          ...
          blickTitel="Bremerhaven auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Bremerhaven 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Bremerhaven"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-bremerhaven', text: 'Preis und Betreuungskräfte für Bremerhaven ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-bremerhaven" titel="Polnische Betreuungskräfte in Bremerhaven">
            <Text>Wer in Bremerhaven nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Bremerhaven und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Cuxhaven">
            <Text>Unsere Betreuungskräfte ziehen in Bremerhaven und im Landkreis Cuxhaven ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Bremerhaven ausmacht">
            <Text>Reihenhäuser sind in Bremerhaven mit 31,0 Prozent seltener als in Bremen (52,9 Prozent). 55,4 Prozent der Gebäude stehen frei, in Bremen 32,3 Prozent — mehr Haus, mehr Platz, mehr Möglichkeiten.</Text>
          ...
          <Abschnitt id="einzugsgebiet-bremerhaven" titel="Einzugsgebiet Bremerhaven">
            <Text>Bremerhaven und Cuxhaven: Cuxhaven, Geestland, Wurster Nordseeküste und alle Gemeinden im Landkreis Cuxhaven</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Bremerhaven">
