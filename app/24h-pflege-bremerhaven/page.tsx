    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wie in Bremerhaven gebaut wurde, merkt man spätestens auf der Treppe. Reihenhäuser sind in Bremerhaven mit 31,0 Prozent seltener als in Bremen (52,9 Prozent). 55,4 Prozent der Gebäude stehen frei, in Bremen 32,3 Prozent — mehr Haus, mehr Platz, mehr Möglichkeiten.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
