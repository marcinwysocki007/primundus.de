...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Hildesheim ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung in den eigenen vier Wänden statt Heimplatz: Eine Betreuungskraft zieht in Hildesheim ein und entlastet die Familie. Ab 2.150 €, täglich kündbar.',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <OrtWerkzeuge ort={'Hildesheim'} land={'Niedersachsen'} altbau={64.9} miete={6.34} />
