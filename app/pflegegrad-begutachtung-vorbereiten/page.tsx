      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Begutachtung vorbereiten</span>
          </nav>
          ...
          <div className="bg-white rounded-2xl border border-pm-line overflow-hidden mb-6 shadow-sm">
            <div className="px-5 py-3 bg-pm-paper border-b border-pm-line">
              <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-pm-mute">Was ins Pflegetagebuch gehört — täglich eintragen</p>
            </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={bereich} className={i % 2 === 0 ? 'bg-white' : 'bg-pm-paper'}>
                      <td className="px-4 py-3 text-[14px] font-semibold text-pm-ink border-b border-pm-line w-[35%]">{bereich}</td>
                      <td className="px-4 py-3 text-[13px] text-pm-body border-b border-pm-line">{fragen}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="space-y-4 mb-10">
            {[
              ...
              <div key={tip.n} className="flex gap-4 bg-white rounded-xl p-5 border border-pm-line">
                <span className="w-8 h-8 rounded-full bg-pm-taupe text-white font-bold text-[15px] flex items-center justify-center flex-shrink-0 mt-0.5">{tip.n}</span>
                <div>
                  <p className="text-[15px] font-bold text-pm-ink mb-1">{tip.title}</p>
                  <p className="text-[14px] text-pm-body leading-relaxed">{tip.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3 mb-6">
            {[
              ...
              <div key={item.bereich} className="bg-white rounded-xl p-5 border border-pm-line">
                <p className="text-[15px] font-bold text-pm-ink mb-1">{item.bereich}</p>
          ...
          <p className="text-[15px] text-pm-body mb-10">
            ...
            <a href="/pflegegrad-widerspruch-einlegen" className="text-pm-taupe underline hover:text-pm-taupe-deep">Pflegegrad Widerspruch — Muster & Tipps</a>
            {' · '}
            <a href="/pflegegrad-beantragen" className="text-pm-taupe underline hover:text-pm-taupe-deep">Pflegegrad beantragen — vollständige Anleitung</a>
          </p>
          ...
          <Weiterlesen aktuell="pflegegrad-begutachtung-vorbereiten" />
          <ArticleCTA />
        </div>
      </div>
    </>
