...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Magdeburg | Primundus',
  description: '24-Stunden-Pflege in Magdeburg: Eigenanteil ab ca. 1400 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
  alternates: { canonical: 'https://primundus.de/24h-pflege-magdeburg' },
  openGraph: {
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630 }],
    title: '24h-Pflege Magdeburg — Betreuungskraft zuhause | Primundus',
    description: 'Geprüfte 24h-Betreuungskraft in Magdeburg. Täglich kündbar, rechtssicher, startklar.',
...
const schemaMarkup = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Magdeburg', item: 'https://primundus.de/24h-pflege-magdeburg' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Magdeburg?',
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1400–2500 €/Monat — deutlich günstiger als ein Heimplatz in Sachsen-Anhalt (Eigenanteil rund 2.890 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Magdeburg starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Magdeburg rechtssicher?',
        acceptedAnswer: { '@type': 'Answer', text: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Magdeburg?',
        acceptedAnswer: { '@type': 'Answer', text: 'Das hängt am Grundriss, und die Ausgangslage in Magdeburg ist bekannt: Die durchschnittliche Wohnung misst 72,5 Quadratmeter, 42,1 Prozent liegen unter 60 Quadratmetern (Sachsen-Anhalt: 31,3 Prozent), und 18,4 Prozent der Haushalte wohnen im Eigentum (Sachsen-Anhalt: 43,0 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
      },
      {
        '@type': 'Question',
        name: 'Wie viele ältere Menschen leben in Magdeburg?',
        acceptedAnswer: { '@type': 'Answer', text: '31.630 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 13,1 Prozent — in Sachsen-Anhalt 13,8 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 26,4 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Sachsen-Anhalt: 29,4 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
      },
      {
        '@type': 'Question',
        name: 'Wie wohnt man in Magdeburg — Haus oder Geschosswohnung?',
        acceptedAnswer: { '@type': 'Answer', text: 'Auf ein Gebäude kommen in Magdeburg im Schnitt 4,1 Wohnungen, in Sachsen-Anhalt 2,1. 44,4 Prozent der Gebäude stehen frei, 36,7 Prozent sind Reihenhäuser. 54,5 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Magdeburg ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Magdeburg?',
      ...
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Magdeburg bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Magdeburg und Umland: Schönebeck, Halberstadt, Stendal und alle Gemeinden im Landkreis Börde und Jerichower Land' },
      },
    ],
  },
]

export default function MagdeburgPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Magdeburg</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Magdeburg · Aktualisiert August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Magdeburg
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Die Gründerzeitwohnung in Stadtfeld, das Haus in Cracau, der Garten an der Elbe: Magdeburger bleiben, wo sie verwurzelt sind — auch wenn die Kinder in Hannover oder Berlin arbeiten. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist rund um die Uhr da. Täglich kündbar, rechtssicher, meist startklar in 4–7 Tagen.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Magdeburg 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Magdeburg</p>
            </div>
            ...
            <div className="bg-pm-paper border-t border-pm-line px-5 py-3">
              <p className="text-[12px] text-pm-mute">Pflegeheim in Sachsen-Anhalt: Eigenanteil rund 2.890 €/Monat (vdek, 07/2026) — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-magdeburg" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Magdeburg ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Magdeburg</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Magdeburg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Magdeburg und im gesamten Umland im Einsatz.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            ...
            Entlastungsbudget in Sachsen-Anhalt meist rund 1400 bis 2500 Euro Eigenanteil —
            deutlich weniger als ein Heimplatz, der hier im Schnitt rund 2.890 Euro im Monat kostet.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Magdeburg</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Magdeburg und Umland: Schönebeck, Halberstadt, Stendal und alle Gemeinden im Landkreis Börde und Jerichower Land</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Magdeburg ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Ob jemand zur Miete oder im Eigentum wohnt, ändert in Magdeburg die Möglichkeiten. Nur 18,4 Prozent der Haushalte wohnen im Eigentum — in Sachsen-Anhalt sind es 43,0 Prozent. Der Umzug in etwas Größeres ist damit für die meisten keine realistische Option. Auf ein Gebäude kommen in Magdeburg im Schnitt 4,1 Wohnungen, in Sachsen-Anhalt sind es 2,1. Hier wird also dichter gebaut — mehr Geschosswohnungen, weniger Haus mit Garten.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            42,1 Prozent der Wohnungen in Magdeburg haben weniger als 60 Quadratmeter, in Sachsen-Anhalt sind es 31,3 Prozent. Ein eigenes Zimmer für die Betreuungskraft ist hier also die Frage, die vorab geklärt gehört. Die durchschnittliche Wohnung misst 72,5 Quadratmeter gegenüber 84,0 in Sachsen-Anhalt — rund 12 Quadratmeter weniger.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Der Wohnungsmarkt ist eng: 6,7 Prozent Leerstand gegenüber 8,9 Prozent in Sachsen-Anhalt. 36,7 Prozent der Gebäude in Magdeburg sind Reihenhäuser, in Sachsen-Anhalt 22,5 Prozent. Schmaler Grundriss, steile Treppe, Schlafzimmer und Bad oben — das ist der Alltag, um den es geht. 52,2 Prozent aller Haushalte in Magdeburg bestehen aus einer einzigen Person, in Sachsen-Anhalt sind es 44,7 Prozent. Alleinlebend heißt im Pflegefall: Es ist niemand da, der es mitbekommt.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 31.630 Menschen in Magdeburg sind 75 Jahre oder älter, und es gibt 145.934 Wohnungen in 35.911 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Magdeburg</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Magdeburg?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1400–2500 €/Monat — deutlich günstiger als ein Heimplatz in Sachsen-Anhalt (Eigenanteil rund 2.890 €/Monat, vdek 07/2026).' },
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Magdeburg starten?', a: 'In der Regel in 4–7 Tagen. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
              ...
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Magdeburg?', a: 'Das hängt am Grundriss, und die Ausgangslage in Magdeburg ist bekannt: Die durchschnittliche Wohnung misst 72,5 Quadratmeter, 42,1 Prozent liegen unter 60 Quadratmetern (Sachsen-Anhalt: 31,3 Prozent), und 18,4 Prozent der Haushalte wohnen im Eigentum (Sachsen-Anhalt: 43,0 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-magdeburg" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Magdeburg die richtige Lösung?"
