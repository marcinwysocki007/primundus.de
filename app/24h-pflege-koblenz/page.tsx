...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Koblenz bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Koblenz 2026" },
  { id: 'polnische-betreuungskraefte-in-koblenz', title: "Polnische Betreuungskräfte in Koblenz" },
  ...
  { id: 'stimmen-vor-ort', title: "Familien aus Koblenz über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Koblenz" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Koblenz: Preis und Kräfte sofort sehen',
  description: '24-Stunden-Pflege in Koblenz: Ihren Preis und die passenden Betreuungskräfte sehen Sie in 2 Minuten — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Koblenz?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Rheinland-Pfalz (Eigenanteil rund 3.220 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Koblenz Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Koblenz hat im Schnitt 88,0 m², 25,4 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 64,3 % der Wohnungen in Koblenz liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Koblenz"
          titel="24-Stunden-Pflege und Betreuung in Koblenz"
          einleitung={<>Metternich, die Karthause oder drüben unter Ehrenbreitstein: Wo Rhein und Mosel zusammenfließen, gibt man sein Zuhause nicht her. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Koblenz auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Koblenz bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Koblenz bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Koblenz 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Koblenz"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-koblenz" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-koblenz" titel="Polnische Betreuungskräfte in Koblenz">
            <Text>Wer in Koblenz nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Koblenz und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-am" titel="24-Stunden-Pflege am Mittelrhein">
            <Text>Unsere Betreuungskräfte ziehen in Koblenz und am Mittelrhein ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Koblenz ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-koblenz" titel="Einzugsgebiet Koblenz">
            <Text>Koblenz und Mittelrhein: Neuwied, Andernach, Lahnstein, Boppard und alle Gemeinden im Landkreis Mayen-Koblenz</Text>
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20251006-uwe'].includes(b.id))}

          />


          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Koblenz">
