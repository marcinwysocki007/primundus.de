      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Selbst pflegen oder 24h-Pflege</span>
          </nav>
          ...
          <div className="space-y-3 mb-10">
            {[
              ...
              <div key={item.frage} className="bg-white rounded-xl p-5 border border-pm-line">
                ...
                <p className="text-[14px] text-pm-body leading-relaxed">{item.bedeutung}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3 mb-10">
            {[
              ...
              <div key={item} className="flex items-start gap-3 bg-pm-mint rounded-xl p-4 border border-[rgba(61,122,92,0.15)]">
                <span className="text-pm-green flex-shrink-0 font-bold mt-0.5">✓</span>
                <p className="text-[14px] text-pm-green-deep">{item}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3 mb-10">
            {[
              ...
              <div key={item.signal} className="flex items-start gap-3 bg-pm-coral-tint rounded-xl p-5 border border-[rgba(231,111,99,0.15)]">
                <span className="text-pm-coral flex-shrink-0 font-bold mt-0.5">!</span>
                <div>
                  <p className="text-[14px] font-bold text-pm-coral-ink mb-0.5">{item.signal}</p>
                  <p className="text-[14px] text-pm-coral-ink leading-relaxed">{item.detail}</p>
                </div>
              </div>
            ))}
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-pm-paper">
                    <th className="px-5 py-3 text-[12px] font-semibold text-pm-mute text-left border-b border-pm-line">Aufgabe</th>
                    <th className="px-5 py-3 text-[12px] font-semibold text-pm-mute text-left border-b border-pm-line">Betreuungskraft</th>
                    <th className="px-5 py-3 text-[12px] font-semibold text-pm-taupe text-left border-b border-pm-line">Angehörige</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={aufg} className={i % 2 === 0 ? 'bg-white' : 'bg-pm-paper'}>
                      <td className="px-5 py-3 text-[14px] text-pm-body border-b border-pm-line">{aufg}</td>
                      <td className="px-5 py-3 text-[14px] text-center font-bold text-pm-green border-b border-pm-line">{kraft}</td>
                      <td className="px-5 py-3 text-[14px] text-center font-bold text-pm-taupe border-b border-pm-line">{ang}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <Weiterlesen aktuell="selbst-pflegen-oder-24h-pflege" />
          <ArticleCTA />
        </div>
      </div>
    </>
