...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Landsberg am Lech 2026" },
  { id: 'polnische-betreuungskraefte-in-landsberg', title: "Polnische Betreuungskräfte in Landsberg" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Landkreis Landsberg am Lech" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Landsberg ausmacht" },
  { id: 'einzugsgebiet-landsberg-am-lech', title: "Einzugsgebiet Landsberg am Lech" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Landsberg am Lech" },
]
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Landsberg am Lech"
          titel="24-Stunden-Pflege und Betreuung in Landsberg"
          einleitung={<>Die Altstadt am Lech, Erpfting oder das Umland Richtung Ammersee: Landsberger geben ihr Zuhause nicht her. Eine Betreuungskraft von Primundus zieht mit ein, wenn Mutter oder Vater Hilfe brauchen, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Landsberg am Lech auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Landsberg am Lech 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Landsberg am Lech"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-landsberg', text: 'Preis und Betreuungskräfte für Landsberg ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-landsberg" titel="Polnische Betreuungskräfte in Landsberg">
            <Text>Wer in Landsberg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Landsberg und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Landsberg am Lech">
            <Text>Unsere Betreuungskräfte ziehen in Landsberg und im Landkreis Landsberg am Lech ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Landsberg ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-landsberg-am-lech" titel="Einzugsgebiet Landsberg am Lech">
            <Text>Landsberg am Lech und Landkreis Landsberg am Lech: Kaufering, Dießen am Ammersee, Utting und alle Gemeinden im Landkreis Landsberg am Lech</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Landsberg am Lech">
