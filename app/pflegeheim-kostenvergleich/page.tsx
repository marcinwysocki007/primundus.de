...
export const metadata: Metadata = {
  ...
  description: 'Pflegeheim kostet 2026 im Schnitt 3.364 €/Monat Eigenanteil. 24h-Pflege zuhause oft günstiger — jetzt Kosten nach Pflegegrad und Bundesland vergleichen.',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Der durchschnittliche Eigenanteil im Pflegeheim liegt 2026 bei rund 3.364 €/Monat — bundesweit. In Bayern (≈ 3.389 €) und Baden-Württemberg (≈ 3.273 €) deutlich höher, in Sachsen-Anhalt und Thüringen (≈ 2.240 €) deutlich niedriger. Hinzu kommen pflegegradabhängige Pflegekosten zwischen 805 € (PG 2) und 2.096 € (PG 5).',
        },
      },
      {
        '@type': 'Question',
...
const faqs = [
  {
    ...
    a: 'Bundesweit im Schnitt 3.364 € Eigenanteil/Monat. In Bayern (≈ 3.389 €) und BW (≈ 3.273 €) deutlich höher, in Sachsen-Anhalt und Thüringen (≈ 2.240 €) deutlich niedriger. Hinzu kommen pflegegradabhängige Pflegekosten von 805–2.096 €.',
  },
  {
        ...
        <div className="max-w-[720px] mx-auto px-5 pb-16">
          ...
          <section className="mb-12">
            ...
            <div className="flex flex-col gap-3">
              {argumente.map((a) => (
                <div key={a.name} className="bg-white border border-pm-line rounded-xl px-5 py-4">
                  <p className="text-[14px] font-bold text-pm-ink mb-1">{a.name}</p>
                  <p className="text-[13px] text-pm-body leading-relaxed">{a.desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-[22px] font-bold text-pm-ink mb-6">Häufige Fragen zum Kostenvergleich</h2>
            <div className="flex flex-col gap-3">
              {faqs.map((faq) => (
                <details
                  key={faq.q}
          ...
          <section>
            <h2 className="text-[18px] font-bold text-pm-ink mb-4">Vertiefende Vergleiche</h2>
