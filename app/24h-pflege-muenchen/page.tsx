      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          blick={[
            ...
            'Ihr Eigenanteil bei Pflegegrad 3: ca. 1100–2275 €/Monat',
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse" titel="Kosten und Kassenzuschüsse in München 2026">
            <Tabelle
              ...
              zeilen={[
                ...
                [<strong key="e">Ihr Eigenanteil</strong>, <strong key="w">ca. 1100–2275 €/Monat</strong>],
              ]}
              betont={1}
          ...
          <Abschnitt id="polnische-betreuungskraefte" titel="Polnische Betreuungskräfte in München">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> zwischen 2.200 und 3.500 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbetrag und Entlastungsbudget in Bayern meist rund 1100 bis 2275 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der hier im Schnitt rund 3.200 Euro im Monat kostet.</Text>
