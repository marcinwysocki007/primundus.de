...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Unterschleißheim 2026" },
  { id: 'polnische-betreuungskraefte-in-unterschleissheim', title: "Polnische Betreuungskräfte in Unterschleissheim" },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          blickTitel="Unterschleißheim auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Unterschleißheim 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Unterschleißheim"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-unterschleissheim', text: 'Preis und Betreuungskräfte für Unterschleissheim ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-unterschleissheim" titel="Polnische Betreuungskräfte in Unterschleissheim">
            <Text>Wer in Unterschleissheim nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Unterschleissheim und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im nördlichen Landkreis München">
            <Text>Unsere Betreuungskräfte ziehen in Unterschleissheim und im nördlichen Landkreis München ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Unterschleissheim ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-unterschleissheim" titel="Einzugsgebiet Unterschleißheim">
            <Text>Unterschleißheim und nördlicher Landkreis München: Oberschleißheim, Garching, Ismaning, Feldkirchen und alle Gemeinden im nördlichen Landkreis München</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Unterschleißheim">
