...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Salzgitter 2026" },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Salzgitter"
          titel="24-Stunden-Pflege und Betreuung in Salzgitter"
          ...
          blickTitel="Salzgitter auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Salzgitter 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Salzgitter"
              zeilen={[
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=ort-salzgitter', text: 'Preis und Betreuungskräfte für Salzgitter ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-salzgitter" titel="Polnische Betreuungskräfte in Salzgitter">
            <Text>Wer in Salzgitter nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Salzgitter und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Salzgitter ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-salzgitter" titel="Einzugsgebiet Salzgitter">
            <Text>Salzgitter und Umland: Wolfenbüttel, Goslar, Peine und alle Gemeinden im Landkreis Wolfenbüttel und Peine</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Salzgitter">
