      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Ernährung pflegebedürftiger Senioren</span>
          </nav>
          ...
          <div className="space-y-3 mb-10">
            {[
              ...
              <div key={item.nährstoff} className="bg-white rounded-xl p-5 border border-pm-line">
                <p className="text-[15px] font-bold text-pm-ink mb-1">{item.nährstoff}</p>
          ...
          <Weiterlesen aktuell="ernaehrung-pflegebeduerftige-senioren" />
          <ArticleCTA />
        </div>
      </div>
    </>
