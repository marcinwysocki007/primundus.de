...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Darmstadt', item: 'https://primundus.de/24h-pflege-darmstadt' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Darmstadt"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Darmstadt" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Darmstadt" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <OrtWerkzeuge slug="darmstadt" ort={'Darmstadt'} land={'Hessen'} altbau={57.7} miete={9.56} />
