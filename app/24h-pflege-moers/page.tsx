...
export const metadata: Metadata = {
  ...
  description: 'In Moers zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Duisburg und Krefeld. Keine Vermittlungsgebühr, täglich kündbar.',
