...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Moers: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Moers: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Pflegeheim in Moers.' },
      },
      {
        '@type': 'Question',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Moers Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Moers hat im Schnitt 90,0 m², 19,0 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 78,8 % der Wohnungen in Moers liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-moers" titel="Polnische Betreuungskräfte in Moers">
            <Text>Wer in Moers nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Moers und im gesamten Umland im Einsatz.</Text>
          ...
          <OrtWerkzeuge ort={'Moers'} land={'Nordrhein-Westfalen'} />
