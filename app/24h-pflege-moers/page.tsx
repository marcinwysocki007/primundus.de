      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Moers · Aktualisiert August 2026
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wie in Moers gebaut wurde, merkt man spätestens auf der Treppe. Nur 33,6 Prozent der Gebäude stehen frei, in Nordrhein-Westfalen sind es 50,2 Prozent. In 27,6 Prozent der Haushalte leben ausschließlich Menschen ab 65 — in Nordrhein-Westfalen sind es 24,2 Prozent. Dort ist niemand im Haus, der nachts einspringen könnte.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 11.863 Menschen in Moers sind 75 Jahre oder älter, und der Ort zählt 52.191 Wohnungen in 24.242 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
