...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Ingolstadt: zu Hause bleiben statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-ingolstadt" titel="Polnische Betreuungskräfte in Ingolstadt">
            <Text>Wer in Ingolstadt nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Ingolstadt und im gesamten Umland im Einsatz.</Text>
