...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Ingolstadt bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Ingolstadt 2026" },
  ...
  { id: 'werkzeuge', title: "Was es in Ingolstadt kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Ingolstadt über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Ingolstadt" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Ingolstadt ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung in den eigenen vier Wänden statt Heimplatz: Eine Betreuungskraft zieht in Ingolstadt ein und entlastet die Familie. Ab 2.150 €, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Ingolstadt?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Ingolstadt Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Ingolstadt hat im Schnitt 87,3 m², 29,0 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 78,7 % der Wohnungen in Ingolstadt liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Ingolstadt"
          titel="24-Stunden-Pflege und Betreuung in Ingolstadt"
          ...
          blickTitel="Ingolstadt auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Ingolstadt bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Ingolstadt bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Ingolstadt 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Ingolstadt"
              zeilen={[
            ...
            <RechnerKasten src="ort-ingolstadt" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-ingolstadt" titel="Polnische Betreuungskräfte in Ingolstadt">
            <Text>Wer in Ingolstadt nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Ingolstadt und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Ingolstadt ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-ingolstadt" titel="Einzugsgebiet Ingolstadt">
            <Text>Ingolstadt und Umland: Neuburg, Schrobenhausen, Pfaffenhofen und alle Gemeinden im Landkreis Eichstätt und Pfaffenhofen</Text>
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20241217-felix'].includes(b.id))}

          />


          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Ingolstadt">
