      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          <nav className="h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-pm-ink">Kurzzeitpflege oder 24h-Pflege</span>
          </nav>
          ...
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">Kurzzeitpflege oder 24h-Pflege — was passt zu Ihrer Situation?</h1>

          <AuthorByline updated="30. April 2026" />
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">Nach dem Krankenhausaufenthalt, beim Ausfall des pflegenden Angehörigen, in einer Übergangssituation — welche Lösung ist die richtige? Kurzzeitpflege oder direkt 24h-Pflege zuhause? Dieser Ratgeber hilft bei der Entscheidung.</p>
          <h2 id="unterschied" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Der grundlegende Unterschied</h2>
          <p className="text-[16px] leading-relaxed text-pm-body mb-4">Kurzzeitpflege ist stationär und zeitlich begrenzt — die Person zieht vorübergehend in eine Einrichtung. 24h-Pflege ist dauerhaft häuslich — eine Kraft zieht ein und bleibt so lange wie nötig.</p>
          <div className="space-y-3 mb-8">
            <div className="bg-white rounded-xl p-5 border border-pm-line">
              <p className="text-[15px] font-bold text-pm-ink mb-1">Kurzzeitpflege sinnvoll wenn...</p>
              <p className="text-[14px] text-pm-body leading-relaxed">Überbrückung nach Krankenhausaufenthalt, Ausfall der Pflegeperson für wenige Wochen, Testphase vor dauerhafter Entscheidung.</p>
            </div>
            <div className="bg-white rounded-xl p-5 border border-pm-line">
              <p className="text-[15px] font-bold text-pm-ink mb-1">24h-Pflege sinnvoll wenn...</p>
              <p className="text-[14px] text-pm-body leading-relaxed">Dauerhafter Pflegebedarf, eigenes Zuhause soll erhalten bleiben, Demenz (Kontinuität wichtig), Familien die keine stationäre Lösung wollen.</p>
            </div>
          </div>          <h2 id="kosten" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Kostenvergleich</h2>
          <p className="text-[16px] leading-relaxed text-pm-body mb-4">Kurzzeitpflege kostet typisch 80–130 €/Tag in einer Einrichtung. Mit Entlastungsbudget (3.539 €/Jahr) sind ca. 30–40 Tage gedeckt. 24h-Pflege: 2.200–3.500 €/Monat, mit Kassenzuschüssen ab ca. 1.500 €/Monat Eigenanteil.</p>
          <p className="text-[16px] leading-relaxed text-pm-body mb-4">Für Übergangsphasen bis 4 Wochen: Kurzzeitpflege oft günstiger. Für dauerhaften Bedarf: 24h-Pflege typisch günstiger als stationär — und das Zuhause bleibt.</p>

          <h2 id="faq" className="text-[24px] md:text-[28px] font-bold text-pm-ink mb-6">Häufige Fragen</h2>
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-pm-ink pr-4">Was ist günstiger — Kurzzeitpflege oder 24h-Pflege?</h3>
                <span className="text-pm-taupe font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-pm-body leading-relaxed">Für kurze Übergänge (unter 4 Wochen): Kurzzeitpflege mit Entlastungsbudget oft günstiger. Bei dauerhaftem Bedarf: 24h-Pflege mit allen Zuschüssen meist günstiger als stationäre Lösung.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-pm-line group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
