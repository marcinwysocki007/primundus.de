...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bocholt: Preis und Kräfte sofort sehen',
  description: '24-Stunden-Pflege in Bocholt: Ihren Preis und die passenden Betreuungskräfte sehen Sie in 2 Minuten — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Bocholt Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Bocholt hat im Schnitt 102,9 m², 15,2 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 87,4 % der Wohnungen in Bocholt liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
