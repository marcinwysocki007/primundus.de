    ...
    <>
      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <h1 className="text-[32px] md:text-[42px] font-bold text-[#1C1C1C] leading-tight mb-6">Wunden verbinden zuhause — was erlaubt ist und was nicht</h1>

          <AuthorByline updated="30. April 2026" />
          <p className="text-[17px] md:text-[19px] leading-relaxed text-[#2E2E2E] mb-10 font-medium">Kleine Wunden, Schürfungen, Druckstellen — Betreuungskräfte können Erstversorgung leisten. Chronische Wunden, Ulcus cruris, tiefe Wunden: das ist Sache des Pflegedienstes.</p>
          <h2 id="darf-kraft" className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mt-10 mb-4 leading-snug">Was darf die Kraft?</h2>
          ...
          <h2 id="pflegedienst" className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mt-10 mb-4 leading-snug">Wann Pflegedienst?</h2>
          ...
          <h2 id="praxis" className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mt-10 mb-4 leading-snug">Praktisch vorgehen</h2>
          ...
          <div className="space-y-4 mb-12">
            <details className="bg-white rounded-xl border border-[#E5E3DF] group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-[#1C1C1C] pr-4">Was darf eine Betreuungskraft bei der Wundversorgung?</h3>
                <span className="text-[#8B7355] font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-[#2E2E2E] leading-relaxed">Kleine, oberflächliche Wunden reinigen und verbinden, Wundsalbe auftragen, auf Veränderungen beobachten. Keine komplexe Wundversorgung.</p></div>
            </details>
            <details className="bg-white rounded-xl border border-[#E5E3DF] group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                <h3 className="text-[15px] font-semibold text-[#1C1C1C] pr-4">Wann muss ein Pflegedienst die Wundversorgung übernehmen?</h3>
                <span className="text-[#8B7355] font-bold text-[20px] flex-shrink-0 group-open:rotate-45 transition-transform">+</span>
              </summary>
              <div className="px-5 pb-4"><p className="text-[15px] text-[#2E2E2E] leading-relaxed">Bei chronischen Wunden, tiefen Wunden, Infektionszeichen, Dekubitus, Wunden nach Operationen — immer professionelle Behandlungspflege.</p></div>
            </details>
          </div>
          <ArticleCTA />
        </div>
