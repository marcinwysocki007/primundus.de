...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Würzburg bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Würzburg 2026" },
  { id: 'polnische-betreuungskraefte-in-wuerzburg', title: "Polnische Betreuungskräfte in Würzburg" },
  ...
  { id: 'werkzeuge', title: "Was es in Würzburg kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Würzburg über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Würzburg" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Würzburg: zu Hause bleiben statt Heim',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Würzburg?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Würzburg"
          titel="24-Stunden-Pflege und Betreuung in Würzburg"
          einleitung={<>Frauenland, Zellerau oder Heidingsfeld: Mit Blick auf Festung und Weinberge wird man in Würzburg gern alt — im eigenen Zuhause, nicht im Heim. Eine Betreuungskraft von Primundus zieht mit ein und ist bei Bedarf auch nachts da, auch im Umland an Main und Fränkischem Weinland. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Würzburg auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Würzburg bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Würzburg bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Würzburg 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Würzburg"
              zeilen={[
            ...
            <RechnerKasten src="ort-wuerzburg" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-wuerzburg" titel="Polnische Betreuungskräfte in Würzburg">
            <Text>Wer in Würzburg nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Würzburg und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Würzburg">
            <Text>Unsere Betreuungskräfte ziehen in Würzburg und im Landkreis Würzburg ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Würzburg ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-wuerzburg" titel="Einzugsgebiet Würzburg">
            <Text>Würzburg und Landkreis Würzburg: Kitzingen, Ochsenfurt, Veitsshöchheim, Gerbrunn und alle Gemeinden im Landkreis Würzburg</Text>
          ...
          <OrtStimmen
            ...
            stimmen={DIREKT_ERHALTEN.filter((b) => ['k-20260226-bernd'].includes(b.id))}

          />


          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Würzburg">
