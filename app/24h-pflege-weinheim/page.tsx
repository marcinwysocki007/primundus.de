...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-weinheim#service',
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-meta font-bold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">
            24h-Pflege in Weinheim · Aktualisiert am 28. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Weinheim
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Unter den zwei Burgen an der Bergstraße — in Lützelsachsen, Hohensachsen oder der Altstadt — wird man gern alt. Eine Betreuungskraft von Primundus macht es im eigenen Zuhause möglich: Sie zieht mit ein und ist Tag und Nacht da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Weinheim ist älter als das Land: 13,1 Prozent der Einwohner sind 75 Jahre oder älter — das sind 5.983 Menschen, in Baden-Württemberg sind es 10,5 Prozent. Gut jeder vierte Haushalt in Weinheim besteht nur aus Menschen ab 65 — in Baden-Württemberg 23,6 Prozent. Wenn dort nachts etwas passiert, ist niemand da, der es mitbekommt. Das ist der Fall, für den eine Betreuungskraft im Haushalt gedacht ist.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <div className="space-y-3 mb-12">
            {[
              ...
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Weinheim starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
