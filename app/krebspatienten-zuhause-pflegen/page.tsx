    ...
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-pm-taupe-light mb-4">Krankheiten · 6 Min</p>
          ...
          <h2 id="beduerfnisse" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Besondere Bedürfnisse</h2>
          ...
          <h2 id="aufgaben" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Aufgaben der Kraft</h2>
          ...
          <h2 id="palliativ" className="text-[24px] md:text-[30px] font-bold text-pm-ink mt-10 mb-4 leading-snug">Übergang zur Palliativpflege</h2>
