...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege & Betreuung in Rostock | Primundus',
  description: '24-Stunden-Pflege in Rostock: Eigenanteil ab ca. 1400 €/Monat (PG 3). Betreuungskräfte vorher ansehen, keine Vermittlungsgebühr, täglich kündbar.',
  alternates: { canonical: 'https://primundus.de/24h-pflege-rostock' },
  openGraph: {
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630 }],
    title: '24h-Pflege Rostock — Betreuungskraft zuhause | Primundus',
    description: 'Geprüfte 24h-Betreuungskraft in Rostock. Täglich kündbar, rechtssicher, startklar.',
    url: 'https://primundus.de/24h-pflege-rostock',
    siteName: 'Primundus',
    locale: 'de_DE',
    type: 'website',
  },
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-rostock#service',
    name: 'Primundus — 24h-Pflege Rostock',
    serviceType: '24-Stunden-Betreuung zu Hause',
    description: '24h-Betreuungskräfte in Rostock. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-rostock',
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Rostock', item: 'https://primundus.de/24h-pflege-rostock' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Rostock?',
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1400–2500 €/Monat — deutlich günstiger als ein Heimplatz in Mecklenburg-Vorpommern (Eigenanteil rund 3.030 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Rostock starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Rostock rechtssicher?',
        acceptedAnswer: { '@type': 'Answer', text: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Rostock?',
        acceptedAnswer: { '@type': 'Answer', text: 'Das hängt am Grundriss, und die Ausgangslage in Rostock ist bekannt: Die durchschnittliche Wohnung misst 66,0 Quadratmeter, 47,8 Prozent liegen unter 60 Quadratmetern (Mecklenburg-Vorpommern: 33,3 Prozent), und 14,7 Prozent der Haushalte wohnen im Eigentum (Mecklenburg-Vorpommern: 39,5 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
      },
      {
        '@type': 'Question',
        name: 'Wie viele ältere Menschen leben in Rostock?',
        acceptedAnswer: { '@type': 'Answer', text: '27.965 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 13,7 Prozent — in Mecklenburg-Vorpommern 12,6 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 26,9 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Mecklenburg-Vorpommern: 28,5 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
      },
      {
        '@type': 'Question',
        name: 'Wie wohnt man in Rostock — Haus oder Geschosswohnung?',
        acceptedAnswer: { '@type': 'Answer', text: 'Auf ein Gebäude kommen in Rostock im Schnitt 5,5 Wohnungen, in Mecklenburg-Vorpommern 2,2. 33,0 Prozent der Gebäude stehen frei, 50,4 Prozent sind Reihenhäuser. 40,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Rostock ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
      },
      {
        '@type': 'Question',
        name: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Rostock?',
      ...
      {
        '@type': 'Question',
        name: 'Welches Einzugsgebiet wird in Rostock bedient?',
        acceptedAnswer: { '@type': 'Answer', text: 'Rostock und Umland: Schwerin, Güstrow, Bad Doberan und alle Gemeinden im Landkreis Rostock' },
      },
    ],
  },
]
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">24h-Pflege Rostock</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-pm-taupe-light mb-4">
            24h-Pflege in Rostock · Aktualisiert am 28. August 2026
          </p>
          <h1 className="text-h1 md:text-h1-lg font-bold text-pm-ink mb-6">
            24-Stunden-Pflege und Betreuung in Rostock
          </h1>
          <p className="text-[17px] md:text-[19px] leading-relaxed text-pm-body mb-10 font-medium">
            Warnemünde, Reutershagen oder Brinckmansdorf: Rostocker bleiben, wo die Ostsee nah ist — im vertrauten Zuhause mit Möwen überm Dach. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist rund um die Uhr da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.
          </p>
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Rostock 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Rostock</p>
            </div>
            ...
            <div className="bg-pm-paper border-t border-pm-line px-5 py-3">
              <p className="text-[12px] text-pm-mute">Pflegeheim in Mecklenburg-Vorpommern: Eigenanteil rund 3.030 €/Monat (vdek, 07/2026) — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=ort-rostock" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte für Rostock ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Rostock</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Rostock nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in Rostock und im gesamten Umland im Einsatz.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            ...
            Entlastungsbudget in Mecklenburg-Vorpommern meist rund 1400 bis 2500 Euro Eigenanteil —
            deutlich weniger als ein Heimplatz, der hier im Schnitt rund 3.030 Euro im Monat kostet.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Rostock</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Rostock und Umland: Schwerin, Güstrow, Bad Doberan und alle Gemeinden im Landkreis Rostock</p>
          </div>

          {/* ⑤c VOR ORT — aus Zensus-2022-Daten, je Ort verschieden */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Was die Pflege zu Hause in Rostock ausmacht</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Rostock ist städtischer gebaut, als der Landesschnitt vermuten lässt: Auf ein Gebäude kommen hier 5,5 Wohnungen, in Mecklenburg-Vorpommern 2,2. Mehr Geschosswohnung, weniger Haus mit Garten — und damit häufiger die Frage nach dem Stockwerk und der Treppe. In Rostock wohnen nur 14,7 Prozent der Haushalte im Eigentum, in Mecklenburg-Vorpommern 39,5 Prozent. In eine größere Wohnung zu ziehen ist für die meisten keine Option — es muss also in der vorhandenen gehen.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Jedes zweite Gebäude in Rostock ist ein Reihenhaus — in Mecklenburg-Vorpommern 17,6 Prozent. Schmaler Grundriss, steile Treppe, Schlafzimmer und Bad im Obergeschoss: Wenn das Treppensteigen zur täglichen Hürde wird, ist jemand im Haus oft die Alternative zum Umzug. Nur 33,0 Prozent der Gebäude stehen frei, in Mecklenburg-Vorpommern sind es 63,6 Prozent.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Eine Betreuungskraft braucht ein eigenes Zimmer, und genau daran hakt es in Rostock häufiger als anderswo. Knapp jede zweite Wohnung ist kleiner als 60 Quadratmeter — in Mecklenburg-Vorpommern sind es 33,3 Prozent. Deshalb klären wir vorab am Telefon, was Ihre Wohnung hergibt, statt es später herauszufinden. Die durchschnittliche Wohnung misst 66,0 Quadratmeter gegenüber 82,5 in Mecklenburg-Vorpommern — rund 16 Quadratmeter weniger. Der Wohnungsmarkt ist eng: 2,6 Prozent Leerstand gegenüber 5,5 Prozent in Mecklenburg-Vorpommern.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Zahlen: 27.965 Menschen in Rostock sind 75 Jahre oder älter, und es gibt 125.635 Wohnungen in 22.951 Gebäuden. Ob darunter eine ist, in der eine Betreuungskraft ein eigenes Zimmer bekommt, entscheidet sich nicht an der Statistik, sondern an Ihrem Grundriss — und das klären wir vorab.
          </p>
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Rostock</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Rostock?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1400–2500 €/Monat — deutlich günstiger als ein Heimplatz in Mecklenburg-Vorpommern (Eigenanteil rund 3.030 €/Monat, vdek 07/2026).' },
              { q: 'Wie schnell kann eine 24h-Pflegekraft in Rostock starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
              { q: 'Was ist der Unterschied zu einem ambulanten Pflegedienst?', a: 'Ein ambulanter Dienst kommt 1–3 Mal täglich und geht wieder. Eine 24h-Betreuungskraft lebt im Haushalt — ist nachts da, führt den gesamten Haushalt und bietet bei Demenz oder hohem Pflegebedarf die einzige wirklich durchgehende Lösung.' },
              { q: 'Ist 24h-Pflege über Primundus in Rostock rechtssicher?', a: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Rostock?', a: 'Das hängt am Grundriss, und die Ausgangslage in Rostock ist bekannt: Die durchschnittliche Wohnung misst 66,0 Quadratmeter, 47,8 Prozent liegen unter 60 Quadratmetern (Mecklenburg-Vorpommern: 33,3 Prozent), und 14,7 Prozent der Haushalte wohnen im Eigentum (Mecklenburg-Vorpommern: 39,5 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Rostock?', a: '27.965 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 13,7 Prozent — in Mecklenburg-Vorpommern 12,6 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 26,9 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Mecklenburg-Vorpommern: 28,5 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Rostock — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Rostock im Schnitt 5,5 Wohnungen, in Mecklenburg-Vorpommern 2,2. 33,0 Prozent der Gebäude stehen frei, 50,4 Prozent sind Reihenhäuser. 40,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Rostock ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Rostock?', a: 'Das hängt am Grundriss, und die Ausgangslage in Rostock ist bekannt: Die durchschnittliche Wohnung misst 66,0 Quadratmeter, 47,8 Prozent liegen unter 60 Quadratmetern (Mecklenburg-Vorpommern: 33,3 Prozent), und 14,7 Prozent der Haushalte wohnen im Eigentum (Mecklenburg-Vorpommern: 39,5 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Rostock?', a: '27.965 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 13,7 Prozent — in Mecklenburg-Vorpommern 12,6 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 26,9 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Mecklenburg-Vorpommern: 28,5 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Rostock — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Rostock im Schnitt 5,5 Wohnungen, in Mecklenburg-Vorpommern 2,2. 33,0 Prozent der Gebäude stehen frei, 50,4 Prozent sind Reihenhäuser. 40,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Rostock ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Passt eine Betreuungskraft überhaupt in eine Wohnung in Rostock?', a: 'Das hängt am Grundriss, und die Ausgangslage in Rostock ist bekannt: Die durchschnittliche Wohnung misst 66,0 Quadratmeter, 47,8 Prozent liegen unter 60 Quadratmetern (Mecklenburg-Vorpommern: 33,3 Prozent), und 14,7 Prozent der Haushalte wohnen im Eigentum (Mecklenburg-Vorpommern: 39,5 Prozent). Notwendig ist ein eigenes, abschließbares Zimmer für die Betreuungskraft. In den kleineren Wohnungen wird das eng — deshalb klären wir es vorab am Telefon, damit es hinterher keine Überraschung gibt.' },
              { q: 'Wie viele ältere Menschen leben in Rostock?', a: '27.965 Einwohnerinnen und Einwohner sind 75 Jahre oder älter, das sind 13,7 Prozent — in Mecklenburg-Vorpommern 12,6 Prozent. Wichtiger für die Frage nach Betreuung ist aber, wer mit wem zusammenlebt: In 26,9 Prozent der Haushalte leben ausschließlich Menschen ab 65 (Mecklenburg-Vorpommern: 28,5 Prozent). In diesen Haushalten ist nachts niemand da, der einspringen könnte — genau dafür ist eine Betreuungskraft gedacht, die mit einzieht.' },
              { q: 'Wie wohnt man in Rostock — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Rostock im Schnitt 5,5 Wohnungen, in Mecklenburg-Vorpommern 2,2. 33,0 Prozent der Gebäude stehen frei, 50,4 Prozent sind Reihenhäuser. 40,6 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Rostock ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
              { q: 'Welches Einzugsgebiet wird in Rostock bedient?', a: 'Rostock und Umland: Schwerin, Güstrow, Bad Doberan und alle Gemeinden im Landkreis Rostock' },
            ].map((item, i) => (
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-rostock" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
          ...
          <ArticleCTA
            headline="Ist 24h-Pflege in Rostock die richtige Lösung?"
