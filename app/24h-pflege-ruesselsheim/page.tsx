...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Was es für Ihre Eltern in Rüsselsheim kostet" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Rüsselsheim am Main" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Rüsselsheim: ab 2.150 € im Monat',
  description: '24-Stunden-Pflege in Rüsselsheim: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Rüsselsheim Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Rüsselsheim hat im Schnitt 84,6 m², 25,5 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 73,4 % der Wohnungen in Rüsselsheim liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <OrtWerkzeuge ort={'Rüsselsheim'} land={'Hessen'} />
