...
export const metadata: Metadata = {
  ...
  description: 'In Rheinland-Pfalz zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
