    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Heimplatz in Rheinland-Pfalz (Eigenanteil rund 3.220 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
...
export default function RheinlandPfalzPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          {/* ④ KOSTEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">
            Kosten & Kassenzuschüsse in Rheinland-Pfalz 2026
          </h2>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
            <div className="bg-pm-paper px-5 py-3 border-b border-pm-line">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-pm-mute">Kostenbeispiel — Pflegegrad 3 in Rheinland-Pfalz</p>
            </div>
            ...
            <div className="bg-pm-paper border-t border-pm-line px-5 py-3">
              <p className="text-[12px] text-pm-mute">Pflegeheim Rheinland-Pfalz: Eigenanteil Ø 2300–2800 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-pm-line rounded-2xl overflow-hidden mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-6 mb-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://kostenrechner.primundus.de/?start=1&amp;src=land-rheinland-pfalz" target="_blank" rel="noopener" className="text-[15px] text-pm-taupe font-semibold hover:underline">
                → Preis und Betreuungskräfte in Rheinland-Pfalz ansehen — in 2 Minuten
              </a>
            </div>
          </div>

          {/* ④b POLEN */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-4">Polnische Betreuungskräfte in Rheinland-Pfalz</h2>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            Wer in Rheinland-Pfalz nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe:
            ...
            und sie sind in ganz Rheinland-Pfalz im Einsatz, in der Großstadt wie im kleinsten Dorf.
          </p>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            ...
            als ein Heimplatz, der in Rheinland-Pfalz im ersten Jahr im Schnitt rund 3.220 Euro im Monat
            kostet.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          <div className="bg-pm-shell border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-pm-taupe-ink mb-1">Einzugsgebiet Rheinland-Pfalz</p>
            <p className="text-[13px] text-pm-taupe-ink leading-relaxed">Mainz, Ludwigshafen, Koblenz, Trier, Kaiserslautern, Worms, Neustadt, Bad Kreuznach, Landau und alle weiteren Städte und Gemeinden in Rheinland-Pfalz</p>
          </div>
          ...
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            In Rheinland-Pfalz sind 271.519 Menschen pflegebedürftig, das entspricht 6,50 Prozent der Bevölkerung. Bundesweit sind es 6,72 Prozent. Damit liegt Rheinland-Pfalz auf Platz 11 von 16. Diese Unterschiede sind groß — zwischen dem niedrigsten und dem höchsten Landeswert liegt fast das Doppelte —, weshalb ein Vergleich mit dem Bundesschnitt allein wenig aussagt.
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
            55,4 Prozent der Pflegebedürftigen werden allein von Angehörigen versorgt — bundesweit sind es 54,5 Prozent, hier also mehr. 150.402 Menschen sind das in Rheinland-Pfalz, ohne jeden Pflegedienst. Ambulante Dienste übernehmen 18,3 Prozent (Bund 19,3), im Heim leben 13,7 Prozent (Bund 14,1).
          </p>
          <p className="text-[15px] leading-relaxed text-pm-body mb-4">
          ...
          {/* ⑥ FAQ */}
          <h2 className="text-h2 md:text-h2-lg font-bold text-pm-ink mb-6">Häufige Fragen — 24h-Pflege in Rheinland-Pfalz</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Rheinland-Pfalz?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Heimplatz in Rheinland-Pfalz (Eigenanteil rund 3.220 €/Monat, vdek 07/2026).' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-rheinland-pfalz" className="inline-flex items-center gap-2 bg-pm-coral hover:bg-pm-coral-deep text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200">
