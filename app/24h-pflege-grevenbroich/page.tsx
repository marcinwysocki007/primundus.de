...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Grevenbroich bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Grevenbroich 2026" },
  { id: 'polnische-betreuungskraefte-in-grevenbroich', title: "Polnische Betreuungskräfte in Grevenbroich" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Rhein-Kreis Neuss" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Grevenbroich ausmacht" },
  { id: 'einzugsgebiet-grevenbroich', title: "Einzugsgebiet Grevenbroich" },
  { id: 'werkzeuge', title: "Was es für Ihre Eltern in Grevenbroich kostet" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Grevenbroich" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Grevenbroich: ab 2.150 € im Monat',
  description: '24-Stunden-Pflege in Grevenbroich: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Grevenbroich?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Nordrhein-Westfalen (Eigenanteil rund 3.580 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Grevenbroich Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Grevenbroich hat im Schnitt 99,5 m², 14,3 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 84,3 % der Wohnungen in Grevenbroich liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Grevenbroich"
          titel="24-Stunden-Pflege und Betreuung in Grevenbroich"
          ...
          blickTitel="Grevenbroich auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Grevenbroich bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Grevenbroich bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Grevenbroich 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Grevenbroich"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-grevenbroich" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-grevenbroich" titel="Polnische Betreuungskräfte in Grevenbroich">
            <Text>Wer in Grevenbroich nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Grevenbroich und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Rhein-Kreis Neuss">
            <Text>Unsere Betreuungskräfte ziehen in Grevenbroich und im Rhein-Kreis Neuss ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Grevenbroich ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-grevenbroich" titel="Einzugsgebiet Grevenbroich">
            <Text>Grevenbroich und Rhein-Kreis Neuss Mitte: Jüchen, Korschenbroich, Rommerskirchen und alle Gemeinden im mittleren Rhein-Kreis Neuss</Text>
            <NearbyCities current="grevenbroich" />
          </Abschnitt>

          <OrtWerkzeuge ort={'Grevenbroich'} land={'Nordrhein-Westfalen'} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Grevenbroich">
