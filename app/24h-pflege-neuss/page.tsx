...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Neuss ab 2.150 € – zu Hause statt Heim',
  description: 'Zu Hause bleiben statt ins Pflegeheim: In Neuss zieht eine Betreuungskraft ein, hilft im Alltag und ist bei Bedarf auch nachts da. Ab 2.150 € im Monat.',
