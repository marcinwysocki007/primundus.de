...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Neuss bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Neuss 2026" },
  { id: 'polnische-betreuungskraefte-in-neuss', title: "Polnische Betreuungskräfte in Neuss" },
  { id: '24-stunden-pflege-im', title: "24-Stunden-Pflege im Rhein-Kreis Neuss" },
  { id: 'was-die-pflege-zu', title: "Was die Pflege zu Hause in Neuss ausmacht" },
  { id: 'einzugsgebiet-neuss', title: "Einzugsgebiet Neuss" },
  { id: 'werkzeuge', title: "Was es in Neuss kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus der Region über uns" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Neuss" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Neuss: zu Hause bleiben statt Heim',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Neuss"
          titel="24-Stunden-Pflege und Betreuung in Neuss"
          ...
          blickTitel="Neuss auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Neuss bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Neuss bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Neuss 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Neuss"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-neuss" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-neuss" titel="Polnische Betreuungskräfte in Neuss">
            <Text>Wer in Neuss nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Neuss und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Rhein-Kreis Neuss">
            <Text>Unsere Betreuungskräfte ziehen in Neuss und im Rhein-Kreis Neuss ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Neuss ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-neuss" titel="Einzugsgebiet Neuss">
            <Text>Neuss und Rhein-Kreis Neuss: Dormagen, Grevenbroich, Kaarst, Meerbusch und alle Gemeinden im Rhein-Kreis Neuss</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Neuss">
