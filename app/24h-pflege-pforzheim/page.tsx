...
export const metadata: Metadata = {
  ...
  description: '1:1-Betreuung zu Hause statt Heim: Eine Betreuungskraft zieht in Pforzheim & Enzkreis ein und entlastet die Angehörigen. Ab 2.150 €, täglich kündbar.',
