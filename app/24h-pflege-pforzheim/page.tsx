...
export const metadata: Metadata = {
  ...
  description: 'Muss nicht das Heim sein: Eine Betreuungskraft zieht in Pforzheim & Enzkreis bei Ihnen ein. Foto, Erfahrung und Deutsch sehen Sie, bevor Sie sich entscheiden.',
