...
const SECTIONS = [
  ...
  { id: 'werkzeuge', title: "Was es in Pforzheim kostet, und was die Pflegekasse dazugibt" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'stimmen-vor-ort', title: "Familien aus Pforzheim über uns" },
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Pforzheim', item: 'https://primundus.de/24h-pflege-pforzheim' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Pforzheim"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Pforzheim" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Pforzheim" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-pforzheim" titel="Polnische Betreuungskräfte in Pforzheim">
            <Text>Wer in Pforzheim nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Pforzheim und im gesamten Umland im Einsatz.</Text>
