...
export const metadata: Metadata = {
  ...
  description: 'In Pforzheim & Enzkreis zieht die Betreuungskraft bei Ihnen ein: Haushalt, Körperpflege, nachts bei Bedarf. Keine Vermittlungsgebühr, täglich kündbar.',
