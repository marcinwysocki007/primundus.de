...
// Seit 23.09.2026 traegt diese Datei nur noch, was in Weilheim in Oberbayern anders ist; der feste Text steht
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Weilheim in Oberbayern starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung.' },
...
const ORT: OrtDaten = {
  ...
  einzugsgebiet: 'Weilheim und Landkreis Weilheim-Schongau: Schongau, Penzberg, Peißenberg, Polling und alle Gemeinden im Landkreis Weilheim-Schongau',
