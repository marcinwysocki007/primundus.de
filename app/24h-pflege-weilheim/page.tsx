...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Weilheim bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Weilheim in Oberbayern 2026" },
  { id: 'polnische-betreuungskraefte-in-weilheim', title: "Polnische Betreuungskräfte in Weilheim" },
  ...
  { id: 'werkzeuge', title: "Was es in Weilheim kostet, und was die Pflegekasse dazugibt" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Weilheim | 6× Testsieger | Primundus',
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Weilheim in Oberbayern in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Weilheim in Oberbayern starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller.' },
  ...
  { q: 'Wie wohnt man in Weilheim — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Weilheim im Schnitt 2,1 Wohnungen, in Bayern 2,1. 42,0 Prozent der Gebäude stehen frei, 31,4 Prozent stehen in geschlossener Reihe. 34,2 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Weilheim ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
  { q: 'Welches Einzugsgebiet wird in Weilheim in Oberbayern bedient?', a: 'Weilheim und Landkreis Weilheim-Schongau: Schongau, Penzberg, Peißenberg, Polling und alle Gemeinden im Landkreis Weilheim-Schongau' },
  { q: 'Ist in einer Wohnung in Weilheim Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Weilheim hat im Schnitt 94,9 m², 21,9 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 83,1 % der Gebäude in Weilheim sind Ein- oder Zweifamilienhäuser; dort bietet sich oft eine ganze Etage an.' },
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-weilheim#service',
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Weilheim in Oberbayern', item: 'https://primundus.de/24h-pflege-weilheim' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Weilheim in Oberbayern"
          titel="24-Stunden-Pflege und Betreuung in Weilheim"
          einleitungTitel="Zuhause bleiben in Weilheim in Oberbayern"
          einleitung={<>Im Pfaffenwinkel — in Weilheim, Polling oder Wielenbach an der Ammer — wohnt man mit Blick auf die Berge und bleibt. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          aktualisiert="28. August 2026"
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-weilheim', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Weilheim in Oberbayern" />}
          blick={[
          ...
          blickTitel="Weilheim in Oberbayern auf einen Blick"
          person={<AnsprechpartnerinGross ort="Weilheim" />}
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Weilheim bedeutet">
            <Text>
              ...
              Heim, wo der Umzug ansteht. Das Zuhause in Weilheim bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Weilheim in Oberbayern 2026">
            <Tabelle
            ...
            <RechnerKasten src="ort-weilheim" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-weilheim" titel="Polnische Betreuungskräfte in Weilheim">
            <Text>Wer in Weilheim nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Weilheim und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im Landkreis Weilheim-Schongau">
            <Text>Unsere Betreuungskräfte ziehen in Weilheim und im Landkreis Weilheim-Schongau ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Weilheim ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-weilheim-in-oberbayern" titel="Einzugsgebiet Weilheim in Oberbayern">
            <Text>Weilheim und Landkreis Weilheim-Schongau: Schongau, Penzberg, Peißenberg, Polling und alle Gemeinden im Landkreis Weilheim-Schongau</Text>
            <NearbyCities current="weilheim" />
          </Abschnitt>

          <OrtWerkzeuge slug="weilheim" ort={'Weilheim'} land={'Bayern'} altbau={34.2} miete={8.91} />
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Weilheim in Oberbayern">
