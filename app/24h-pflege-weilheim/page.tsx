...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Weilheim: Preis und Kräfte sofort sehen',
  description: '24-Stunden-Pflege in Weilheim: Ihren Preis und die passenden Betreuungskräfte sehen Sie in 2 Minuten — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
  ...
  openGraph: {
    ...
    description: 'Geprüfte 24h-Betreuungskraft in Weilheim in Oberbayern. Täglich kündbar, rechtssicher, startklar.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Weilheim in Oberbayern', item: 'https://primundus.de/24h-pflege-weilheim' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Weilheim in Oberbayern?',
      ...
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Weilheim in Oberbayern starten?',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Weilheim in Oberbayern rechtssicher?',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Weilheim Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Weilheim hat im Schnitt 94,9 m², 21,9 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 83,1 % der Wohnungen in Weilheim liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-weilheim" titel="Polnische Betreuungskräfte in Weilheim">
            <Text>Wer in Weilheim nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Weilheim und im gesamten Umland im Einsatz.</Text>
