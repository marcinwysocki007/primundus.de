      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="h-[24px] text-sm text-[#8B8B8B] mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-[#1C1C1C]">Die ehrliche Gesamtrechnung</span>
          </nav>
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6 mb-8">
            <div className="space-y-5">
              <div>
                <p className="text-[15px] font-bold text-[#1C1C1C] mb-1">1. Der Tagespreis-Anker</p>
              ...
              <div>
                <p className="text-[15px] font-bold text-[#1C1C1C] mb-1">2. Der „ab"-Preis</p>
                <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
              ...
              <div>
                <p className="text-[15px] font-bold text-[#1C1C1C] mb-1">3. Die unbezifferten Nebenkosten</p>
                <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6 mb-8 overflow-x-auto">
            <table className="w-full text-[14px] text-[#2E2E2E]">
              <tbody>
                ...
                <tr className="border-b-2 border-[#E5E3DF]">
                  <td className="py-2.5 pr-4 font-bold text-[#1C1C1C]">Ehrliche Gesamtkosten</td>
                  <td className="py-2.5 text-right font-bold text-[#1C1C1C] whitespace-nowrap">≈ 3.050 €</td>
                </tr>
                <tr className="border-b border-[#F0EDE8]">
                ...
                <tr>
                  <td className="py-3 pr-4 font-bold text-[16px] text-[#1C1C1C]">Effektiv selbst zu tragen</td>
                  <td className="py-3 text-right font-bold text-[16px] text-[#1C1C1C] whitespace-nowrap">≈ 1.450–1.700 €</td>
                </tr>
              </tbody>
            </table>
            <p className="text-[13px] text-[#8B8B8B] mt-4">
              ...
              <a href="https://kostenrechner.primundus.de/" className="text-[#8B7355] underline underline-offset-2">Kostenrechner in 2 Minuten</a>.
            </p>
          </div>
            ...
            <ol className="space-y-3">
              {FRAGEN.map((f, i) => (
                <li key={i} className="flex gap-3 items-start">
                  <span className="w-7 h-7 rounded-full bg-[#8B7355] text-white text-[13px] font-bold flex items-center justify-center flex-shrink-0">{i + 1}</span>
                  <span className="text-[15px] leading-relaxed text-[#2E2E2E] pt-0.5">{f}</span>
                </li>
              ))}
            </ol>
            <div className="bg-[#F2EDE6] rounded-xl p-5 mt-5">
              <p className="text-[13px] text-[#6B5A44] leading-relaxed">
                ...
                <a href="/testsieger-24-stunden-pflege" className="underline underline-offset-2 font-semibold text-[#8B7355]">mit dem Original-Dokument belegt</a>.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6">
              <p className="text-[16px] font-bold text-[#1C1C1C] mb-2">Warum wirken manche 24h-Pflege-Angebote so günstig?</p>
              <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
            ...
            <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6">
              <p className="text-[16px] font-bold text-[#1C1C1C] mb-2">Welche Nebenkosten kommen üblicherweise dazu?</p>
              <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
            ...
            <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6">
              <p className="text-[16px] font-bold text-[#1C1C1C] mb-2">Was kostet 24-Stunden-Pflege bei Pflegegrad 3 effektiv?</p>
              <p className="text-[15px] leading-relaxed text-[#2E2E2E]">
                ...
                <a href="/24-stunden-pflege-kostenuebernahme" className="text-[#8B7355] underline underline-offset-2">Wer übernimmt die Kosten?</a>
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl p-6 mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              <a href="/kosten" className="text-[13px] font-semibold text-[#8B7355] bg-[#F8F7F5] hover:bg-[#F2EDE6] rounded-full px-4 py-2 transition-colors">Kosten &amp; Finanzierung</a>
              ...
              <a href="/testsieger-24-stunden-pflege" className="text-[13px] font-semibold text-[#8B7355] bg-[#F8F7F5] hover:bg-[#F2EDE6] rounded-full px-4 py-2 transition-colors">Unsere Auszeichnung mit Beleg</a>
            </div>
          </div>
