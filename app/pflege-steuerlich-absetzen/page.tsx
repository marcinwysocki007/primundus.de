      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Pflege steuerlich absetzen</span>
          </nav>
          ...
          <div className="bg-white rounded-2xl border border-pm-line overflow-hidden mb-6 shadow-sm">
            <div className="px-5 py-3 bg-pm-paper border-b border-pm-line">
              <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-pm-mute">Was unter § 35a fällt — haushaltsnahe Pflegeleistungen</p>
            </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={leistung} className={i % 2 === 0 ? 'bg-white' : 'bg-pm-paper'}>
                      <td className="px-4 py-3 text-[14px] text-pm-body border-b border-pm-line">{leistung}</td>
                      <td className={`px-4 py-3 text-[14px] font-semibold border-b border-pm-line ${status.startsWith('✓') ? 'text-pm-green' : 'text-pm-mute'}`}>{status}</td>
          ...
          <div className="bg-white rounded-2xl border border-pm-line overflow-hidden mb-6 shadow-sm">
            <div className="px-5 py-3 bg-pm-paper border-b border-pm-line">
              <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-pm-mute">Steuerersparnis bei 24h-Pflege — Primundus 2026</p>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full">
                <tbody>
                  {[
                    ...
                    <tr key={pos} className={i === 4 ? 'bg-pm-mint' : i % 2 === 0 ? 'bg-white' : 'bg-pm-paper'}>
                      <td className="px-5 py-3 text-[14px] text-pm-body border-b border-pm-line">{pos}</td>
                      <td className={`px-5 py-3 text-[14px] font-bold border-b border-pm-line ${i === 4 || i === 5 ? 'text-pm-green' : 'text-pm-ink'}`}>{wert}</td>
          ...
          <Weiterlesen aktuell="pflege-steuerlich-absetzen" />
          <ArticleCTA />
        </div>
      </div>
    </>
