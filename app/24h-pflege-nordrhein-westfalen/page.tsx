    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Kassenzuschüssen sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Pflegeheim in Nordrhein-Westfalen (Ø 3.364 €/Monat Eigenanteil).'.replace(',', '.') },
      },
    ],
  },
]
      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Nordrhein-Westfalen?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Pflegeheim in Nordrhein-Westfalen (Ø 2600–3100 €/Monat Eigenanteil).' },
