        ...
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <div className="space-y-3 mb-12">
            {[
              ...
              { q: 'Wie schnell kann eine Pflegekraft in Nordrhein-Westfalen starten?', a: 'In 4–7 Tagen nach dem ersten Beratungsgespräch. Primundus vermittelt in ganz Nordrhein-Westfalen — auch in ländlichen Regionen.' },
