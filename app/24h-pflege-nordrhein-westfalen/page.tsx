...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Nordrhein-Westfalen in 3 Tagen möglich – mit Bestpreisgarantie.',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Nordrhein-Westfalen"
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Nordrhein-Westfalen" />}
          blick={[
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Nordrhein-Westfalen 2026">
            <Tabelle
              ...
              betont={1}
              fuss="Eine Person, Pflegegrad 3, Werte aus unserem Kostenrechner · Pflegeheim Nordrhein-Westfalen: Eigenanteil Ø 2600–3100 €/Monat — was bei Ihnen bleibt, zeigt der Kostenrechner in 2 Minuten"
            />
            <Tabelle
            ...
            />
            <RechnerKasten src="ort-nordrhein-westfalen" />
          </Abschnitt>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-nordrhein" titel="Polnische Betreuungskräfte in Nordrhein-Westfalen">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet,</strong> hängt von der Pflegesituation und den Deutschkenntnissen ab — Ihren Preis zeigt der Kostenrechner in 2 Minuten. Pflegegeld und Entlastungsbudget zahlen bei Pflegegrad 3 zusammen bis zu ca. 894 Euro im Monat, dazu kommen bis zu 333 Euro Steuerermäßigung; ein Heimplatz kostet in Nordrhein-Westfalen im ersten Jahr im Schnitt rund 3.580 Euro Eigenanteil.</Text>
          ...
          <OrtWerkzeuge slug="nordrhein-westfalen" ort={'Nordrhein-Westfalen'} land={'Deutschland insgesamt'} altbau={53.3} miete={6.82} />
