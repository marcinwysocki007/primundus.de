      ...
      <div className="min-h-screen bg-pm-paper">
        <div className="max-w-article mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="min-h-[24px] text-sm text-pm-mute mb-6 flex items-center gap-2 flex-wrap">
            ...
            <span>›</span>
            <span className="text-pm-ink">Scheinselbstständigkeit vermeiden</span>
          </nav>
          ...
          <div className="bg-pm-coral-tint border border-[rgba(231,111,99,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[14px] font-bold text-pm-coral-ink mb-2">Das Risiko ist real — und wächst</p>
          ...
          <div className="space-y-3 mb-10">
            {[
              ...
              <div key={item.kriterium} className="bg-white rounded-xl p-5 border border-pm-line">
                ...
                <p className="text-[14px] text-pm-body leading-relaxed">{item.risiko}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3 mb-10">
            {[
              ...
              <div key={item.folge} className="bg-pm-coral-tint rounded-xl p-5 border border-[rgba(231,111,99,0.15)]">
                <p className="text-[15px] font-bold text-pm-coral-ink mb-1">{item.folge}</p>
          ...
          <div className="space-y-4 mb-10">
            {[
              ...
              <div key={item.modell} className={`rounded-2xl p-5 border ${item.highlight ? 'bg-white border-pm-taupe border-2' : 'bg-white border-pm-line'}`}>
                <p className="text-[16px] font-bold text-pm-ink mb-2">{item.modell}</p>
          ...
          <Weiterlesen aktuell="scheinselbststaendigkeit-pflege-vermeiden" />
          <ArticleCTA />
        </div>
      </div>
    </>
