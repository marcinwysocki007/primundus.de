...
const SECTIONS = [
  ...
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Niedersachsen 2026" },
...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Niedersachsen ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung zu Hause statt Heimplatz: Eine Betreuungskraft zieht in Niedersachsen ein und entlastet die Angehörigen. Ab 2.150 € im Monat, täglich kündbar.',
...
const schemaMarkup = [
  {
    ...
    '@type': 'Service',
    '@id': 'https://primundus.de/24h-pflege-niedersachsen#service',
    name: 'Primundus — 24h-Pflege Niedersachsen',
    serviceType: '24-Stunden-Betreuung zu Hause',
    description: '24h-Betreuungskräfte in Niedersachsen. Rechtssicher, täglich kündbar, startklar.',
    url: 'https://primundus.de/24h-pflege-niedersachsen',
    provider: { '@id': 'https://primundus.de/#organization' },
    areaServed: { '@type': 'State', name: 'Niedersachsen' },
    },
  {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '24h-Pflege Niedersachsen', item: 'https://primundus.de/24h-pflege-niedersachsen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Was kostet eine 24h-Pflegekraft in Niedersachsen?',
        acceptedAnswer: { '@type': 'Answer', text: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — oft günstiger als ein Heimplatz in Niedersachsen (rund 3.010 €/Monat) oder Bremen (rund 3.760 €/Monat, vdek 07/2026).' },
      },
      {
        '@type': 'Question',
        name: 'Wie schnell kann eine 24h-Pflegekraft in Niedersachsen starten?',
        acceptedAnswer: { '@type': 'Answer', text: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller. Primundus ist mit eigenen Betreuungskräften in ganz Niedersachsen — auch in ländlichen Regionen.' },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: 'Ist 24h-Pflege über Primundus in Niedersachsen rechtssicher?',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Niedersachsen?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — oft günstiger als ein Heimplatz in Niedersachsen (rund 3.010 €/Monat) oder Bremen (rund 3.760 €/Monat, vdek 07/2026).' },
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Niedersachsen starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung. In dringenden Situationen geht es oft schneller. Primundus ist mit eigenen Betreuungskräften in ganz Niedersachsen — auch in ländlichen Regionen.' },
  { q: 'Was ist der Unterschied zu einem ambulanten Pflegedienst?', a: 'Ein ambulanter Dienst kommt 1–3 Mal täglich und geht wieder. Eine 24h-Betreuungskraft lebt im Haushalt — ist bei Bedarf auch nachts da, führt den gesamten Haushalt und bietet bei Demenz oder hohem Pflegebedarf die einzige wirklich durchgehende Lösung.' },
  { q: 'Ist 24h-Pflege über Primundus in Niedersachsen rechtssicher?', a: 'Vollständig. Entsendemodell mit A1-Bescheinigung aus EU-Heimatland — kein eigenes Arbeitsverhältnis, keine deutschen Sozialabgaben. Primundus arbeitet seit 20 Jahren ausschließlich in diesem Modell: null Rechtsprobleme für Kundenfamilien in 60.000+ Betreuungen.' },
  { q: 'Ist in einer Wohnung in Niedersachsen Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Niedersachsen hat im Schnitt 104,4 m², 17,1 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 87,3 % der Wohnungen in Niedersachsen liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Niedersachsen"
          titel="24h-Pflege Niedersachsen — Betreuungskraft zuhause"
          ...
          blick={[
            ...
            'Pflegeheim Niedersachsen: Eigenanteil Ø 2200–2800 €/Monat',
            'Täglich kündbar, keine Vermittlungsgebühr',
            'Anreise in 3 Tagen möglich',
          ]}
          blickTitel="Niedersachsen auf einen Blick"
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Niedersachsen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Niedersachsen"
              zeilen={[
              ...
              betont={1}
              fuss="Eine Person, Werte aus unserem Kostenrechner, zzgl. An- und Abreise 125 € je Strecke · Pflegeheim Niedersachsen: Eigenanteil Ø 2200–2800 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause"
            />
            <Tabelle
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-niedersachsen" titel="Polnische Betreuungskräfte in Niedersachsen">
            <Text>Wer in Niedersachsen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in ganz Niedersachsen im Einsatz, in der Großstadt wie im kleinsten Dorf.</Text>
            <Kasten titel="Angestellt statt vermittelt">
              <Text>Das ist der Unterschied, der im Alltag zählt: Bei Primundus sind die Betreuungskräfte fest angestellt. Wir reichen sie nicht an Sie weiter, und Sie werden nicht zum Arbeitgeber. Die Kraft arbeitet mit A1-Bescheinigung im Entsendemodell in Deutschland, Ihr Vertrag läuft mit uns. Für Sie heißt das: keine Lohnabrechnung, keine Sozialabgaben, keine Arbeitgeberhaftung. Und wenn eine Kraft ausfällt, organisieren wir den Ersatz — ohne Zusatzkosten, es fallen lediglich die An- und Abreisekosten an.</Text>
            </Kasten>
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> ab 2.150 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbudget und Steuerermäßigung ab ca. 923 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der in Niedersachsen im ersten Jahr im Schnitt rund 3.010 Euro im Monat kostet.</Text>
          ...
          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Niedersachsen ausmacht">
            <Text>In Niedersachsen sind 623.071 Menschen pflegebedürftig, das entspricht 7,63 Prozent der Bevölkerung. Bundesweit sind es 6,72 Prozent. Damit liegt Niedersachsen auf Platz 7 von 16. Diese Unterschiede sind groß — zwischen dem niedrigsten und dem höchsten Landeswert liegt fast das Doppelte —, weshalb ein Vergleich mit dem Bundesschnitt allein wenig aussagt.</Text>
            <Text>55,4 Prozent der Pflegebedürftigen werden allein von Angehörigen versorgt — bundesweit sind es 54,5 Prozent, hier also mehr. 344.914 Menschen sind das in Niedersachsen, ohne jeden Pflegedienst. Ambulante Dienste übernehmen 18,6 Prozent (Bund 19,3), im Heim leben 15,0 Prozent (Bund 14,1).</Text>
          ...
          <Abschnitt id="einzugsgebiet-niedersachsen" titel="Einzugsgebiet Niedersachsen">
            <Text>Hannover, Braunschweig, Osnabrück, Oldenburg, Göttingen, Wolfsburg, Salzgitter, Hildesheim, Lüneburg, Celle und alle weiteren Städte und Gemeinden in Niedersachsen</Text>
