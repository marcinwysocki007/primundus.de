...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Witten: Preis und Kräfte sofort sehen',
  description: 'In Witten zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Hattingen und Sprockhövel. Keine Vermittlungsgebühr, täglich kündbar.',
