      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="h-[24px] text-sm text-[#8B8B8B] mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-[#1C1C1C]">24h-Pflege Iserlohn</span>
          </nav>
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
            <div className="bg-[#F8F7F5] px-5 py-3 border-b border-[#E5E3DF]">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-[#8B8B8B]">Kostenbeispiel — Pflegegrad 3 in Iserlohn</p>
            </div>
          ...
          {/* ④b POLEN */}
          <h2 className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mb-4 leading-snug">Polnische Betreuungskräfte in Iserlohn</h2>
          ...
          {/* ⑤ EINZUGSGEBIET */}
          {/* ⑤ KREIS-H2 */}
          <h2 className="text-[24px] md:text-[30px] font-bold text-[#1C1C1C] mb-4 leading-snug">24-Stunden-Pflege im Märkischen Kreis</h2>
          <p className="text-[15px] leading-relaxed text-[#2E2E2E] mb-4">Unsere Betreuungskräfte ziehen in Iserlohn und im Märkischen Kreis ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</p>
          <div className="bg-[#F2EDE6] border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-[#6B5A44] mb-1">Einzugsgebiet Iserlohn</p>
            <p className="text-[13px] text-[#6B5A44] leading-relaxed">Iserlohn und Märkischer Kreis: Lüdenscheid, Hemer, Menden, Plettenberg und alle Gemeinden im Märkischen Kreis</p>
          </div>

          {/* ⑥ FAQ */}
          <h2 className="text-[24px] md:text-[28px] font-bold text-[#1C1C1C] mb-6">Häufige Fragen — 24h-Pflege in Iserlohn</h2>
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-iserlohn" className="inline-flex items-center gap-2 bg-[#E76F63] hover:bg-[#D45F53] text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
