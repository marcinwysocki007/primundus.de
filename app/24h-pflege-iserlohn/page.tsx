...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Iserlohn ab 2.150 €: 1:1 zu Hause',
  description: '1:1-Betreuung in den eigenen vier Wänden statt Heimplatz: Eine Betreuungskraft zieht in Iserlohn ein und entlastet die Familie. Ab 2.150 €, täglich kündbar.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Iserlohn Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Iserlohn hat im Schnitt 88,7 m², 23,5 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 72,0 % der Wohnungen in Iserlohn liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
