...
const SECTIONS = [
  { id: 'was-ist-24-stunden', title: "Was 24-Stunden-Betreuung in Gärtringen bedeutet" },
  { id: 'kosten-und-kassenzuschuesse-in', title: "Kosten & Kassenzuschüsse in Gärtringen 2026" },
  { id: 'polnische-betreuungskraefte-in-gaertringen', title: "Polnische Betreuungskräfte in Gärtringen" },
  ...
  { id: 'werkzeuge', title: "Rechnen Sie Ihren Fall für Gärtringen durch" },
  { id: 'so-arbeiten-wir', title: "So arbeiten wir" },
  { id: 'haeufige-fragen-24h-pflege', title: "Häufige Fragen — 24h-Pflege in Gärtringen" },
]

export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Gärtringen: ab 2.150 €, täglich kündbar',
  description: '24-Stunden-Pflege in Gärtringen: ab 2.150 € im Monat, Eigenanteil bei Pflegegrad 3 ab ca. 923 €. Kräfte vorher ansehen, keine Gebühr, täglich kündbar.',
...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft in Gärtringen?', a: 'Ab 2.150 €/Monat über Primundus, dazu An- und Abreise mit 125 € je Strecke. Nach Pflegegeld, Entlastungsbudget und Steuerermäßigung bleiben bei PG 3 ab ca. 923 €/Monat — deutlich günstiger als ein Heimplatz in Baden-Württemberg (Eigenanteil rund 3.660 €/Monat, vdek 07/2026).' },
  ...
  { q: 'Ist in einer Wohnung in Gärtringen Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Gärtringen hat im Schnitt 104,7 m², 12,2 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 84,0 % der Wohnungen in Gärtringen liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          augenbraue="24-Stunden-Pflege in Gärtringen"
          titel="24-Stunden-Pflege und Betreuung in Gärtringen"
          einleitung={<>Im Gäu zwischen Böblingen und Herrenberg — in Gärtringen oder Rohrau — hält man an Haus und Garten fest. Eine Betreuungskraft von Primundus sorgt dafür, dass das Alter daran nichts ändert: Sie zieht mit ein und ist bei Bedarf auch nachts da. Täglich kündbar, rechtssicher, Anreise in 3 Tagen möglich.</>}
          ...
          blickTitel="Gärtringen auf einen Blick"
        />

        <RatgeberRumpf abschnitte={SECTIONS}>
          <Abschnitt id="was-ist-24-stunden" titel="Was 24-Stunden-Betreuung in Gärtringen bedeutet">
            <Text>
              Eine Betreuungskraft zieht bei Ihnen ein, führt den Haushalt, hilft bei Körperpflege und Alltag und ist bei Bedarf
              auch nachts da. Anders als beim ambulanten Dienst, der zweimal am Tag kommt und wieder geht. Und anders als im
              Heim, wo der Umzug ansteht. Das Zuhause in Gärtringen bleibt, der gewohnte Tagesablauf auch.
            </Text>
            <MehrDazu
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Gärtringen 2026">
            <Tabelle
              titel="Kostenbeispiel — Pflegegrad 3 in Gärtringen"
              zeilen={[
            ...
            />
            <RechnerKasten src="ort-gaertringen" />
          </Abschnitt>

          <Abschnitt id="polnische-betreuungskraefte-in-gaertringen" titel="Polnische Betreuungskräfte in Gärtringen">
            <Text>Wer in Gärtringen nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Die meisten kommen aus Polen, einige aus Rumänien oder Bulgarien — und sie sind in Gärtringen und im gesamten Umland im Einsatz.</Text>
          ...
          <Abschnitt id="24-stunden-pflege-im" titel="24-Stunden-Pflege im südlichen Landkreis Böblingen">
            <Text>Unsere Betreuungskräfte ziehen in Gärtringen und im südlichen Landkreis Böblingen ein — auch in den kleineren Gemeinden, in denen sonst kaum jemand anbietet. Die Anreise dauert überall gleich lang, der Preis ist derselbe.</Text>
          </Abschnitt>

          <Abschnitt id="was-die-pflege-zu" titel="Was die Pflege zu Hause in Gärtringen ausmacht">
          ...
          <Abschnitt id="einzugsgebiet-gaertringen" titel="Einzugsgebiet Gärtringen">
            <Text>Gärtringen und südlicher Landkreis Böblingen: Herrenberg, Jettingen, Nufringen, Aidlingen und alle Gemeinden im südlichen Landkreis Böblingen</Text>
          ...
          <Abschnitt id="haeufige-fragen-24h-pflege" titel="Häufige Fragen — 24h-Pflege in Gärtringen">
