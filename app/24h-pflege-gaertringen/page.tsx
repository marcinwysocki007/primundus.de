...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Gärtringen', item: 'https://primundus.de/24h-pflege-gaertringen' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Gärtringen"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-gaertringen', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Gärtringen" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Gärtringen" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <OrtWerkzeuge slug="gaertringen" ort={'Gärtringen'} land={'Baden-Württemberg'} altbau={24.8} miete={9.15} />
