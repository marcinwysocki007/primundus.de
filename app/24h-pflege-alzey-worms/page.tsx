...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Kreis Alzey-Worms: Preis sofort sehen',
  description:
    '24-Stunden-Pflege in Kreis Alzey-Worms: Preis und passende Betreuungskräfte in 2 Minuten sehen — mit Foto, Erfahrung und Deutschniveau. Täglich kündbar.',
