...
const FRAGEN = [
  { q: 'Was kostet eine 24h-Pflegekraft im Kreis Alzey-Worms?', a: 'Meist zwischen 2.200 und 3.500 Euro im Monat, je nach Pflegesituation. Mit Pflegegeld und den weiteren Zuschüssen der Pflegekasse bleiben bei Pflegegrad 3 oft rund 1.500 bis 2.400 Euro selbst zu tragen — deutlich weniger als ein Heimplatz in Rheinhessen.' },
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="was-kostet-das-und" titel="Was kostet das — und was zahlt die Pflegekasse dazu?">
            <Text>Eine 24h-Betreuung kostet über Primundus meist <strong>2.200 bis 3.500 Euro im Monat</strong> — je nachdem, ob eine oder zwei Personen betreut werden, wie mobil Ihre Angehörigen sind und ob nachts Hilfe nötig ist. Die Pflegekasse zahlt kräftig mit: Mit Pflegegeld, Entlastungsbetrag und Verhinderungspflege bleiben bei Pflegegrad 3 oft nur <strong>rund 1.500 bis 2.400 Euro</strong>{' '} im Monat selbst zu tragen. Zum Vergleich: Ein Heimplatz in Rheinland-Pfalz kostet im Schnitt rund 3.364 Euro Eigenanteil — ohne dass jemand rund um die Uhr nur für Ihre Mutter da wäre.</Text>
            <MehrDazu
              label="Mehr dazu:"
              links={[
