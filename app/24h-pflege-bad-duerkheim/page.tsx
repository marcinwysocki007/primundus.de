...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare polnische Pflegekräfte für Bad Dürkheim und Preis direkt online sehen. Anreise in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Bad Dürkheim', item: 'https://primundus.de/24h-pflege-bad-duerkheim' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          person={<AnsprechpartnerinGross ort="Bad Dürkheim" />}
        />
