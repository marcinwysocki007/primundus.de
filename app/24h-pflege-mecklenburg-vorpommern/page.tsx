    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2.200–3.500 €/Monat über Primundus. Mit Kassenzuschüssen sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Pflegeheim in Mecklenburg-Vorpommern (Ø 3.364 €/Monat Eigenanteil).'.replace(',', '.') },
      },
    ],
  },
]
      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <nav className="h-[24px] text-sm text-[#8B8B8B] mb-6 flex items-center gap-2">
            ...
            <span>›</span>
            <span className="text-[#1C1C1C]">24h-Pflege Mecklenburg-Vorpommern</span>
          </nav>

          <p className="flex items-center gap-1.5 text-[11px] text-[#A89279] mb-4">
            24h-Pflege in Mecklenburg-Vorpommern · Aktualisiert April 2026
          </p>
          ...
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
            <div className="bg-[#F8F7F5] px-5 py-3 border-b border-[#E5E3DF]">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-[#8B8B8B]">Kostenbeispiel — Pflegegrad 3 in Mecklenburg-Vorpommern</p>
            </div>
            ...
            <div className="bg-[#F8F7F5] border-t border-[#E5E3DF] px-5 py-3">
              <p className="text-[12px] text-[#8B8B8B]">Pflegeheim Mecklenburg-Vorpommern: Eigenanteil Ø 2000–2400 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause</p>
            </div>
          </div>
          <div className="bg-white border border-[#E5E3DF] rounded-2xl overflow-hidden mb-4">
          ...
          <div className="bg-[#F2EDE6] border border-[rgba(139,115,85,0.2)] rounded-2xl p-5 mb-10">
            <p className="text-[13px] font-bold text-[#6B5A44] mb-1">Einzugsgebiet Mecklenburg-Vorpommern</p>
            <p className="text-[13px] text-[#6B5A44] leading-relaxed">Rostock, Schwerin, Neubrandenburg, Greifswald, Stralsund, Wismar, Güstrow und alle weiteren Städte und Gemeinden in Mecklenburg-Vorpommern</p>
          </div>

          {/* ⑥ FAQ */}
          <h2 className="text-[24px] md:text-[28px] font-bold text-[#1C1C1C] mb-6">Häufige Fragen — 24h-Pflege in Mecklenburg-Vorpommern</h2>
          <div className="space-y-3 mb-12">
            {[
              { q: 'Was kostet eine 24h-Pflegekraft in Mecklenburg-Vorpommern?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1000–2000 €/Monat — oft günstiger als ein Pflegeheim in Mecklenburg-Vorpommern (Ø 2000–2400 €/Monat Eigenanteil).' },
              { q: 'Wie schnell kann eine Pflegekraft in Mecklenburg-Vorpommern starten?', a: 'In 4–7 Tagen nach dem ersten Beratungsgespräch. Primundus ist mit eigenen Betreuungskräften in ganz Mecklenburg-Vorpommern — auch in ländlichen Regionen.' },
          ...
          <div className="text-center mb-12">
            <a href="https://kostenrechner.primundus.de/?start=1&src=apex-24h-pflege-mecklenburg-vorpommern" className="inline-flex items-center gap-2 bg-[#E76F63] hover:bg-[#D45F53] text-white font-bold text-[16px] py-4 px-10 rounded-full transition-all duration-200">
