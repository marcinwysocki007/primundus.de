...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Kiel & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Kiel: Eigenanteil ab ca. 1300 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <h1 className="text-[32px] md:text-[42px] font-bold text-[#1C1C1C] leading-tight mb-6">
            24h-Pflege Kiel — Betreuungskraft zuhause
          </h1>
          ...
          <div className="space-y-3 mb-12">
            {[
              ...
              { q: 'Wie schnell kann eine Pflegekraft in Kiel starten?', a: 'In 4–7 Tagen nach dem ersten Beratungsgespräch. In dringenden Situationen oft schneller möglich.' },
