...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Dachau: erst ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Dachau bei Ihnen ein. Foto, Erfahrung und Deutsch sehen Sie vorher.',
...
const FRAGEN = [
  ...
  { q: 'Ist in einer Wohnung in Dachau Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Dachau hat im Schnitt 85,0 m², 28,0 % sind kleiner als 60 m². Meist lässt sich ein Zimmer frei machen, häufig das ehemalige Kinder- oder Arbeitszimmer. 71,1 % der Wohnungen in Dachau liegen in Ein- oder Zweifamilienhäusern; dort bietet sich oft eine ganze Etage an.' },
