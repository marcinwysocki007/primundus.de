...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Dachau & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Dachau: Eigenanteil ab ca. 1100 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <h1 className="text-[32px] md:text-[42px] font-bold text-[#1C1C1C] leading-tight mb-6">
            24h-Pflege Dachau — Betreuungskraft zuhause
          </h1>
          ...
          <div className="space-y-3 mb-12">
              ...
              { q: 'Was kostet eine 24h-Pflegekraft in Dachau?', a: '2.200–3.500 €/Monat über Primundus. Mit Pflegegeld, Entlastungsbetrag und Entlastungsbudget sinkt der Eigenanteil bei PG 3 auf ca. 1100–2100 €/Monat — deutlich günstiger als ein Heimplatz in Bayern (Eigenanteil rund 3.200 €/Monat, vdek 07/2026).' },
            {
              ...
              { q: 'Wie schnell kann eine Pflegekraft in Dachau starten?', a: 'In 4–7 Tagen nach dem ersten Beratungsgespräch. In dringenden Situationen oft schneller möglich.' },
