...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Lüdenscheid: zu Hause statt Heim',
      ...
      <div className="bg-pm-paper">
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-luedenscheid" titel="Polnische Betreuungskräfte in Lüdenscheid">
            <Text>Wer in Lüdenscheid nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Lüdenscheid und im gesamten Umland im Einsatz.</Text>
