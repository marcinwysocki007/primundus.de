...
export const metadata: Metadata = {
  ...
  description: 'Zu Hause bleiben statt ins Pflegeheim: In Lüdenscheid zieht eine Betreuungskraft ein, hilft im Alltag und ist bei Bedarf auch nachts da. Ab 2.150 € im Monat.',
