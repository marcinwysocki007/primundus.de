...
export const metadata: Metadata = {
  ...
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Landkreis Wittmund in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Landkreis Wittmund', item: 'https://primundus.de/24h-pflege-wittmund' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          knopfOben
          unterzeile={<StandardUnterzeile ort="Landkreis Wittmund" />}
          blick={[
            'Täglich kündbar, keine Vermittlungsgebühr',
            'Anreise in 3 Tagen möglich',
          ]}
          blickTitel="Landkreis Wittmund auf einen Blick"
          person={<AnsprechpartnerinGross ort="Wittmund" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-wittmund" titel="Polnische Betreuungskräfte in Wittmund">
            ...
            <Text>Der Kostenvergleich fällt in Wittmund deutlich aus: Ein Heimplatz kostet in Niedersachsen im ersten Jahr im Schnitt rund 3.010 Euro Eigenanteil im Monat. Zu Hause zahlen Pflegegeld und Entlastungsbudget bei Pflegegrad 3 zusammen bis zu ca. 894 Euro im Monat, dazu kommen bis zu 333 Euro Steuerermäßigung — und die vertraute Wohnung bleibt.</Text>
