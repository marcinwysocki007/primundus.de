...
// Seit 23.09.2026 traegt diese Datei nur noch, was in Stralsund anders ist; der feste Text steht
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Stralsund starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung.' },
...
const ORT: OrtDaten = {
  ...
  lesezeit: '6 Min.',
  einleitung: <>Die Welterbe-Altstadt am Sund, Knieper oder Franken: Stralsunder bleiben mit Blick auf Rügen — im eigenen Zuhause, nicht im Heim. Eine Betreuungskraft von Primundus zieht mit ein, wenn allein leben nicht mehr geht, und ist bei Bedarf auch nachts da.</>,
  vorOrt: {
    inhalt: (
      <>
  ...
  einzugsgebiet: 'Stralsund und Rügen: Bergen auf Rügen, Sassnitz, Putbus und alle Gemeinden im Landkreis Vorpommern-Rügen',
