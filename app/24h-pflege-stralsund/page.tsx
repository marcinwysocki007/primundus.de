...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Stralsund & Umgebung | Primundus',
  description: '24-Stunden-Pflege in Stralsund: Eigenanteil ab ca. 1400 €/Monat (PG 3). Eigene Betreuungskräfte, keine Vermittlungsgebühr, täglich kündbar.',
      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        <div className="max-w-[860px] mx-auto px-5 py-10 md:py-16">
          ...
          <h1 className="text-[32px] md:text-[42px] font-bold text-[#1C1C1C] leading-tight mb-6">
            24h-Pflege Stralsund — Betreuungskraft zuhause
          </h1>
