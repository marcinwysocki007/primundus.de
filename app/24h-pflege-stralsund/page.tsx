...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Stralsund | 6× Testsieger | Primundus',
  description: 'Geprüfte, verfügbare Betreuungskräfte und Preis direkt online sehen. Anreise in Stralsund in 3 Tagen möglich – mit Bestpreisgarantie.',
...
const FRAGEN = [
  ...
  { q: 'Wie wohnt man in Stralsund — Haus oder Geschosswohnung?', a: 'Auf ein Gebäude kommen in Stralsund im Schnitt 3,9 Wohnungen, in Mecklenburg-Vorpommern 2,2. 40,8 Prozent der Gebäude stehen frei, 37,5 Prozent stehen in geschlossener Reihe. 49,1 Prozent aller Wohnungen stammen aus der Zeit vor 1970. Für die Pflege zu Hause heißt das vor allem eins: Treppen sind in Stralsund ein Thema, und wer sie nicht mehr schafft, braucht jemanden im Haus statt jemanden, der dreimal am Tag kommt.' },
  ...
  { q: 'Ist in einer Wohnung in Stralsund Platz für eine Betreuungskraft?', a: 'Sie braucht ein eigenes, abschließbares Zimmer — ein Bad teilen Sie sich in der Regel. Eine Wohnung in Stralsund hat im Schnitt 69,6 m², 42,6 % sind kleiner als 60 m². Das ist eng, deshalb klären wir vor der Zusage am Telefon, welches Zimmer frei wird — meist das ehemalige Kinder- oder Arbeitszimmer. 65,2 % der Gebäude in Stralsund sind Ein- oder Zweifamilienhäuser; dort bietet sich oft eine ganze Etage an.' },
...
const schemaMarkup = [
    ...
    },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Stralsund', item: 'https://primundus.de/24h-pflege-stralsund' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <div className="bg-pm-paper">
        <RatgeberKopf
          ...
          einleitungTitel="Zuhause bleiben in Stralsund"
          ...
          lesezeit="6 Min."
          knopf={{ href: 'https://kostenrechner.primundus.de/?start=1&src=ort-stralsund', text: 'Preis & Betreuungskräfte ansehen' }}
          knopfOben
          unterzeile={<StandardUnterzeile ort="Stralsund" />}
          blick={[
          ...
          person={<AnsprechpartnerinGross ort="Stralsund" />}
        />
        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-stralsund" titel="Polnische Betreuungskräfte in Stralsund">
            <Text>Wer in Stralsund nach einer polnischen Pflegekraft sucht, meint fast immer dasselbe: jemanden, der im Haushalt lebt und bei Bedarf auch nachts da ist. Genau das leisten unsere Betreuungskräfte. Sie kommen aus Polen und sind in Stralsund und im gesamten Umland im Einsatz.</Text>
