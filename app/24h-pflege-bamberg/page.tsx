...
// Seit 23.09.2026 traegt diese Datei nur noch, was in Bamberg anders ist; der feste Text steht
...
const FRAGEN = [
  ...
  { q: 'Wie schnell kann eine 24h-Pflegekraft in Bamberg starten?', a: 'Eine Anreise ist schon in 3 Tagen möglich. Preis und Betreuungskräfte sehen Sie sofort online — ein Beratungsgespräch ist möglich, aber keine Voraussetzung.' },
...
const ORT: OrtDaten = {
  ...
  lesezeit: '6 Min.',
  einleitung: <>Berggebiet, Gaustadt oder Bug: In der Welterbe-Stadt an der Regnitz gibt man seine Wohnung nicht auf — zu viel Leben steckt in diesen Mauern. Eine Betreuungskraft von Primundus zieht mit ein, wenn Hilfe nötig wird, und ist bei Bedarf auch nachts da.</>,
  ...
  einzugsgebiet: 'Bamberg und Landkreis Bamberg: Hirschaid, Hallstadt, Burgebrach und alle Gemeinden im Landkreis Bamberg und Forchheim',
