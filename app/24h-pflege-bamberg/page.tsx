...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Bamberg: Preis und Kräfte sofort sehen',
  description: 'In Bamberg zieht die Betreuungskraft bei Ihnen ein und führt den Haushalt. Im Einsatz in Hirschaid und Hallstadt. Keine Vermittlungsgebühr, täglich kündbar.',
