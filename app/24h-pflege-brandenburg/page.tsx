        ...
        <RatgeberRumpf abschnitte={SECTIONS}>
          ...
          <Abschnitt id="kosten-und-kassenzuschuesse-in" titel="Kosten & Kassenzuschüsse in Brandenburg 2026">
            <Tabelle
              ...
              betont={1}
              fuss="Pflegeheim Brandenburg: Eigenanteil Ø 2100–2600 €/Monat — 24h-Pflege zuhause ist oft günstiger und erhält das Zuhause"
            />
            <Tabelle
            ...
            <Kasten titel="Ihren eigenen Fall durchrechnen">
              ...
              <MehrDazu
                ...
                links={[
                  ...
                  { href: 'https://kostenrechner.primundus.de/?start=1&amp;src=land-brandenburg', text: 'Preis und Betreuungskräfte in Brandenburg ansehen — in 2 Minuten' },
                ]}
              />
            </Kasten>
          </Abschnitt>
          ...
          <Abschnitt id="polnische-betreuungskraefte-in-brandenburg" titel="Polnische Betreuungskräfte in Brandenburg">
            ...
            <Text><strong className="text-pm-ink font-semibold">Was eine polnische Betreuungskraft kostet:</strong> zwischen 2.200 und 3.500 Euro im Monat, je nach Pflegesituation und Deutschkenntnissen. Bei Pflegegrad 3 bleiben nach Pflegegeld, Entlastungsbetrag und Entlastungsbudget meist rund 1000 bis 2000 Euro Eigenanteil — deutlich weniger als ein Heimplatz, der in Brandenburg im ersten Jahr im Schnitt rund 3.020 Euro im Monat kostet.</Text>
