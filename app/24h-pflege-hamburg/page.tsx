...
export const metadata: Metadata = {
  title: '24-Stunden-Pflege in Hamburg: erst ansehen, dann entscheiden',
  description: 'Wenn es allein nicht mehr geht, muss es nicht das Heim sein: Eine Betreuungskraft zieht in Hamburg bei Ihnen ein. Sie wählen sie vorher selbst aus.',
