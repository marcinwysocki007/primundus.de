...
//
// variante="band": Schlussband der neuen Seitenvorlagen (Partnerseiten-Stil,
// volle Breite, Text links, Ansprechpartnerin rechts). Gleicher Wortlaut.
...
export function ArticleCTA({ variante = 'kasten' }: { variante?: 'kasten' | 'band' }) {
  if (variante === 'band') {
    return (
      <aside className="bg-white border-t border-pm-line" aria-labelledby="kontaktbereich-titel">
        <div className="max-w-[1200px] mx-auto px-5 py-16 md:py-20 grid gap-10 lg:grid-cols-[minmax(0,1fr)_440px] lg:gap-16 lg:items-center">
          <div className="min-w-0">
            <p id="kontaktbereich-titel" className="text-[clamp(28px,3.6vw,42px)] font-extrabold leading-[1.1] tracking-[-0.034em] text-pm-ink [text-wrap:balance] max-w-[20ch]">
              {TITEL}
            </p>
            ...
            <p className="mt-3 text-[15px] text-pm-taupe-ink">Ab 2.200 € im Monat · täglich kündbar · Bestpreisgarantie</p>
          </div>
