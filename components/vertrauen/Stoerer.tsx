...
export function CtaStoerer({ src, ort, titel }: { src: string; ort?: string; titel?: string }) {
  const kopf = titel ?? (ort ? `In 2 Minuten wissen Sie, was es in ${ort} kostet und wer zu Ihnen passt.` : AUFRUF_TITEL)
  return (
    <aside aria-label="Preis und Betreuungskräfte ansehen" className="my-12 overflow-hidden bg-pm-deep max-md:-mx-5 md:my-14 md:rounded-[28px]">
