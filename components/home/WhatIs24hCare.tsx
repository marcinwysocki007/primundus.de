...
export function WhatIs24hCare() {
  return (
    <section className="bg-gradient-to-b from-white to-pm-paper py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="bg-white rounded-2xl p-8 md:p-10 shadow-sm border border-pm-line">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="bg-pm-paper rounded-xl p-6">
              ...
              <div className="bg-pm-paper rounded-xl p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-10 h-10 rounded-full bg-pm-taupe flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
