  ...
  return (
    <section id="ablauf" className="scroll-mt-20 py-14 md:py-16 lg:py-20 px-5 bg-pm-paper">
      <div className="max-w-[640px] md:max-w-[900px] lg:max-w-wide mx-auto">
        ...
        <h2 className="text-[26px] md:text-[32px] lg:text-[38px] leading-[1.25] font-bold text-pm-ink mb-8 md:mb-10 lg:mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 lg:gap-10">
          <div className="flex md:flex-col gap-5">
            <div className="flex flex-col items-center flex-shrink-0">
              <div className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full bg-[#8B7355] text-white flex items-center justify-center font-bold text-lg md:text-xl lg:text-2xl">
                1
              </div>
              <div className="w-0.5 flex-1 md:hidden bg-[#F0EBE3] mt-1.5"></div>
            </div>
            <div className="pt-0.5 md:pt-5 flex-1">
              <h3 className="font-bold text-[17px] md:text-[18px] lg:text-[20px] mb-1.5 md:mb-2.5 text-pm-ink leading-snug md:text-center">
                Angebot online einholen
              </h3>
              <p className="text-[14px] md:text-[15px] lg:text-[16px] leading-[1.55] text-pm-body mb-2.5 md:text-center">
